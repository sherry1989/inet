# 1 "linux-2.6/net/sctp/tsnmap.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/sctp/tsnmap.c"
# 45 "linux-2.6/net/sctp/tsnmap.c"
...
# 46 "linux-2.6/net/sctp/tsnmap.c" 2
...
# 47 "linux-2.6/net/sctp/tsnmap.c" 2
...
# 48 "linux-2.6/net/sctp/tsnmap.c" 2
...
# 298 "linux-2.6/net/sctp/tsnmap.c"
static void sctp_tsnmap_update(struct sctp_tsnmap *map)
{
 __u32 ctsn;
...
{
 int i = off;
# 380 "linux-2.6/net/sctp/tsnmap.c"
 if (!(*started)) {
  for (; i < len; i++) {
   if (map[i]) {
    (*started)++;
...
__u16 sctp_tsnmap_num_gabs(struct sctp_tsnmap *map)
{
 ...
 if (sctp_tsnmap_has_gap(map)) {
  ...
  while (sctp_tsnmap_next_gap_ack(map, &iter,
   ...
   map->gabs[gabs].start = (( __be16)(__builtin_constant_p((__u16)((map->gabs[gabs].start))) ? ({ __u16 __x = (((map->gabs[gabs].start))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16(((map->gabs[gabs].start)))));
   map->gabs[gabs].end = (( __be16)(__builtin_constant_p((__u16)((map->gabs[gabs].end))) ? ({ __u16 __x = (((map->gabs[gabs].end))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16(((map->gabs[gabs].end)))));
   gabs++;
