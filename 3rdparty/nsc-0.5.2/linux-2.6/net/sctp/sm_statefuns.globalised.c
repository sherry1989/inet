# 1 "linux-2.6/net/sctp/sm_statefuns.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/sctp/sm_statefuns.c"
# 55 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 56 "linux-2.6/net/sctp/sm_statefuns.c" 2
...
# 57 "linux-2.6/net/sctp/sm_statefuns.c" 2
...
# 58 "linux-2.6/net/sctp/sm_statefuns.c" 2
...
# 59 "linux-2.6/net/sctp/sm_statefuns.c" 2

# 1 "linux-2.6/include/linux/inet.h" 1
# 48 "linux-2.6/include/linux/inet.h"
extern __u32 in_aton(const char *str);
# 61 "linux-2.6/net/sctp/sm_statefuns.c" 2
...
# 63 "linux-2.6/net/sctp/sm_statefuns.c" 2
...
typedef  struct list_head   _GLOBAL_216_T; extern  _GLOBAL_216_T  global_tty_drivers[NUM_STACKS];    
...
typedef  struct screen_info   _GLOBAL_217_T; extern  _GLOBAL_217_T  global_screen_info[NUM_STACKS];    
...
typedef  struct termios   _GLOBAL_218_T; extern  _GLOBAL_218_T  global_tty_std_termios[NUM_STACKS];    
typedef  int  _GLOBAL_219_T; extern  _GLOBAL_219_T  global_fg_console[NUM_STACKS]; extern  _GLOBAL_219_T  global_last_console[NUM_STACKS]; extern  _GLOBAL_219_T  global_want_console[NUM_STACKS];     

typedef  int  _GLOBAL_220_T; extern  _GLOBAL_220_T  global_kmsg_redirect[NUM_STACKS];   
...
struct semaphore;
typedef  struct semaphore   _GLOBAL_221_T; extern  _GLOBAL_221_T  global_tty_sem[NUM_STACKS];    


typedef  struct tty_ldisc   _GLOBAL_222_T; extern  _GLOBAL_222_T  global_tty_ldisc_N_TTY[NUM_STACKS];    
...
typedef  struct proc_dir_entry   _GLOBAL_223_T; extern  _GLOBAL_223_T  global_proc_root[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_224_T; extern  _GLOBAL_224_T  * global_proc_root_fs[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_225_T; extern  _GLOBAL_225_T  * global_proc_net[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_226_T; extern  _GLOBAL_226_T  * global_proc_net_stat[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_227_T; extern  _GLOBAL_227_T  * global_proc_bus[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_228_T; extern  _GLOBAL_228_T  * global_proc_root_driver[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_229_T; extern  _GLOBAL_229_T  * global_proc_root_kcore[NUM_STACKS];    
...
typedef  struct vfsmount   _GLOBAL_230_T; extern  _GLOBAL_230_T  * global_proc_mnt[NUM_STACKS];    
...
typedef  struct file_operations   _GLOBAL_231_T; extern  _GLOBAL_231_T  global_proc_kcore_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_232_T; extern  _GLOBAL_232_T  global_proc_kmsg_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_233_T; extern  _GLOBAL_233_T  global_ppc_htab_operations[NUM_STACKS];    
...
# 65 "linux-2.6/net/sctp/sm_statefuns.c" 2
...
# 66 "linux-2.6/net/sctp/sm_statefuns.c" 2
# 100 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 127 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 142 "linux-2.6/net/sctp/sm_statefuns.c"
 ...
 (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_SHUTDOWNS]++);
 (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_CURRESTAB]--);
...
# 184 "linux-2.6/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 if (ep == (&((struct sctp_sock *)(sctp_get_ctl_sock()))->sctp)->ep)
 ...
 if (!sctp_verify_init(asoc, chunk->chunk_hdr->type,
  ...
  if (err_chunk) {
   packet = sctp_abort_pkt_new(ep, asoc, arg,
     ...
     (__builtin_constant_p((__u16)(( __u16)(__be16)(err_chunk->chunk_hdr->length))) ? ({ __u16 __x = ((( __u16)(__be16)(err_chunk->chunk_hdr->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(err_chunk->chunk_hdr->length)))) -
     sizeof(sctp_chunkhdr_t));
   ...
   if (packet) {
    sctp_add_cmd_sf(commands, SCTP_CMD_SEND_PKT,
      SCTP_PACKET(packet));
    (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_OUTCTRLCHUNKS]++);
 ...
 new_asoc = sctp_make_temp_asoc(ep, chunk, (0x20));
 if (!new_asoc)
  goto nomem;
 ...
 len = 0;
 if (err_chunk)
  len = (__builtin_constant_p((__u16)(( __u16)(__be16)(err_chunk->chunk_hdr->length))) ? ({ __u16 __x = ((( __u16)(__be16)(err_chunk->chunk_hdr->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(err_chunk->chunk_hdr->length)))) -
   sizeof(sctp_chunkhdr_t);

 if (sctp_assoc_set_bind_addr_from_ep(new_asoc, (0x20)) < 0)
  goto nomem_ack;

 repl = sctp_make_init_ack(new_asoc, chunk, (0x20), len);
 if (!repl)
  goto nomem_ack;
...
# 366 "linux-2.6/net/sctp/sm_statefuns.c"
           ...
           sctp_cmd_seq_t *commands)
{
 ...
 init_tag = (__builtin_constant_p((__u32)(( __u32)(__be32)(chunk->subh.init_hdr->init_tag))) ? ({ __u32 __x = ((( __u32)(__be32)(chunk->subh.init_hdr->init_tag))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(chunk->subh.init_hdr->init_tag))));
 ...
 if (!init_tag) {
  ...
  sctp_add_cmd_sf(commands, SCTP_CMD_NEW_STATE,
    SCTP_STATE(SCTP_STATE_CLOSED));
  (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_ABORTEDS]++);
  sctp_add_cmd_sf(commands, SCTP_CMD_DELETE_TCB, SCTP_NULL());
  return SCTP_DISPOSITION_DELETE_TCB;
 }
...
# 526 "linux-2.6/net/sctp/sm_statefuns.c"
          ...
          sctp_cmd_seq_t *commands)
{
 ...
 skb_pull(chunk->skb,
   (__builtin_constant_p((__u16)(( __u16)(__be16)(chunk->chunk_hdr->length))) ? ({ __u16 __x = ((( __u16)(__be16)(chunk->chunk_hdr->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(chunk->chunk_hdr->length)))) - sizeof(sctp_chunkhdr_t));





 new_asoc = sctp_unpack_cookie(ep, asoc, chunk, (0x20), &error,
          &err_chk_p);
 ...
 (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_CURRESTAB]++);
 (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_PASSIVEESTABS]++);
...
# 679 "linux-2.6/net/sctp/sm_statefuns.c"
          ...
          sctp_cmd_seq_t *commands)
{
 ...
 sctp_add_cmd_sf(commands, SCTP_CMD_NEW_STATE,
   SCTP_STATE(SCTP_STATE_ESTABLISHED));
 (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_CURRESTAB]++);
 (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_ACTIVEESTABS]++);
 sctp_add_cmd_sf(commands, SCTP_CMD_HB_TIMERS_START, SCTP_NULL());
 if (asoc->autoclose)
  sctp_add_cmd_sf(commands, SCTP_CMD_TIMER_START,
    SCTP_TO(SCTP_EVENT_TIMEOUT_AUTOCLOSE));
 ...
 if (asoc->peer.adaption_ind) {
  ev = sctp_ulpevent_make_adaption_indication(asoc, (0x20));
  if (!ev)
   goto nomem;
         ...
         sctp_cmd_seq_t *commands)
{
 ...
 hbinfo.param_hdr.length = (( __be16)(__builtin_constant_p((__u16)((sizeof(sctp_sender_hb_info_t)))) ? ({ __u16 __x = (((sizeof(sctp_sender_hb_info_t)))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16(((sizeof(sctp_sender_hb_info_t))))));
...
# 808 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 849 "linux-2.6/net/sctp/sm_statefuns.c"
        ...
        sctp_cmd_seq_t *commands)
{
 ...
 paylen = (__builtin_constant_p((__u16)(( __u16)(__be16)(chunk->chunk_hdr->length))) ? ({ __u16 __x = ((( __u16)(__be16)(chunk->chunk_hdr->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(chunk->chunk_hdr->length)))) - sizeof(sctp_chunkhdr_t);
...
# 910 "linux-2.6/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 if (!link) {
  printk("<4>"
         ...
         (__func__), ((unsigned char *)&from_addr.v4.sin_addr)[0], ((unsigned char *)&from_addr.v4.sin_addr)[1], ((unsigned char *)&from_addr.v4.sin_addr)[2], ((unsigned char *)&from_addr.v4.sin_addr)[3]);
          ...
          sctp_cmd_seq_t *commands)
{
 ...
 errhdr->length = (( __be16)(__builtin_constant_p((__u16)((len))) ? ({ __u16 __x = (((len))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16(((len)))));


 ep = (&((struct sctp_sock *)(sctp_get_ctl_sock()))->sctp)->ep;
           ...
           sctp_cmd_seq_t *commands)
{
 ...
 int found;
# 1034 "linux-2.6/net/sctp/sm_statefuns.c"
 new_addr = ((void *)0);
 found = 0;

 for (pos = (&new_asoc->peer.transport_addr_list)->next, prefetch(pos->next); pos != (&new_asoc->peer.transport_addr_list); pos = pos->next, prefetch(pos->next)) {
  ...
  found = 0;
  for (pos2 = (&asoc->peer.transport_addr_list)->next, prefetch(pos2->next); pos2 != (&asoc->peer.transport_addr_list); pos2 = pos2->next, prefetch(pos2->next)) {
...
# 1114 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 1221 "linux-2.6/net/sctp/sm_statefuns.c"
 new_asoc = sctp_make_temp_asoc(ep, chunk, (0x20));
 if (!new_asoc)
  goto nomem;
...
# 1353 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 1406 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 1425 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 1517 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 1596 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 1617 "linux-2.6/net/sctp/sm_statefuns.c"
     ...
     struct sctp_association *new_asoc)
{
 ...
 struct sctp_chunk *repl;
# 1634 "linux-2.6/net/sctp/sm_statefuns.c"
 if (asoc->state < SCTP_STATE_ESTABLISHED) {
  ...
  sctp_add_cmd_sf(commands, SCTP_CMD_HB_TIMERS_START,
    SCTP_NULL());
# 1650 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 1708 "linux-2.6/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 skb_pull(chunk->skb, (__builtin_constant_p((__u16)(( __u16)(__be16)(chunk->chunk_hdr->length))) ? ({ __u16 __x = ((( __u16)(__be16)(chunk->chunk_hdr->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(chunk->chunk_hdr->length)))) -
   sizeof(sctp_chunkhdr_t));
...
# 1884 "linux-2.6/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 for ((err) = (sctp_errhdr_t *)((void *)(chunk->chunk_hdr) + sizeof(sctp_chunkhdr_t)); (void *)(err) <= (void *)(chunk->chunk_hdr) + (__builtin_constant_p((__u16)(( __u16)(__be16)((chunk->chunk_hdr)->length))) ? ({ __u16 __x = ((( __u16)(__be16)((chunk->chunk_hdr)->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)((chunk->chunk_hdr)->length)))) - sizeof(sctp_errhdr_t) && (void *)(err) <= (void *)(chunk->chunk_hdr) + (__builtin_constant_p((__u16)(( __u16)(__be16)((chunk->chunk_hdr)->length))) ? ({ __u16 __x = ((( __u16)(__be16)((chunk->chunk_hdr)->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)((chunk->chunk_hdr)->length)))) - ((((__builtin_constant_p((__u16)(( __u16)(__be16)((err)->length))) ? ({ __u16 __x = ((( __u16)(__be16)((err)->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)((err)->length)))))+3)&~3); (err) = (sctp_errhdr_t *)((void *)(err) + ((((__builtin_constant_p((__u16)(( __u16)(__be16)((err)->length))) ? ({ __u16 __x = ((( __u16)(__be16)((err)->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)((err)->length)))))+3)&~3))) {
...
# 1931 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 1969 "linux-2.6/net/sctp/sm_statefuns.c"
 stale = (__builtin_constant_p((__u32)(( __u32)(__be32)(*(suseconds_t *)((u8 *)err + sizeof(sctp_errhdr_t))))) ? ({ __u32 __x = ((( __u32)(__be32)(*(suseconds_t *)((u8 *)err + sizeof(sctp_errhdr_t))))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(*(suseconds_t *)((u8 *)err + sizeof(sctp_errhdr_t))))));
 stale = (stale * 2) / 1000;

 bht.param_hdr.type = SCTP_PARAM_COOKIE_PRESERVATIVE;
 bht.param_hdr.length = (( __be16)(__builtin_constant_p((__u16)((sizeof(bht)))) ? ({ __u16 __x = (((sizeof(bht)))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16(((sizeof(bht))))));
 bht.lifespan_increment = (( __be32)(__builtin_constant_p((__u32)((stale))) ? ({ __u32 __x = (((stale))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32(((stale)))));


 bp = (struct sctp_bind_addr *) &asoc->base.bind_addr;
 reply = sctp_make_init(asoc, bp, (0x20), sizeof(bht));
 if (!reply)
  goto nomem;
...
# 2054 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 2166 "linux-2.6/net/sctp/sm_statefuns.c"
        ...
        sctp_cmd_seq_t *commands)
{
 ...
 ev = sctp_ulpevent_make_shutdown_event(asoc, 0, (0x20));
 if (!ev) {
...
# 2232 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 2286 "linux-2.6/net/sctp/sm_statefuns.c"
          ...
          sctp_cmd_seq_t *commands)
{
 ...
 cwr->lowest_tsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(cwr->lowest_tsn))) ? ({ __u32 __x = ((( __u32)(__be32)(cwr->lowest_tsn))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(cwr->lowest_tsn))));
...
# 2336 "linux-2.6/net/sctp/sm_statefuns.c"
       ...
       sctp_cmd_seq_t *commands)
{
 ...
 sctp_add_cmd_sf(commands, SCTP_CMD_ECN_ECNE,
   SCTP_U32((__builtin_constant_p((__u32)(( __u32)(__be32)(ecne->lowest_tsn))) ? ({ __u32 __x = ((( __u32)(__be32)(ecne->lowest_tsn))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(ecne->lowest_tsn))))));

 return SCTP_DISPOSITION_CONSUME;
}
# 2388 "linux-2.6/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 case SCTP_IERROR_NO_DATA:
  goto consume;
 default:
  __asm__ __volatile__( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (2416), "i" ("linux-2.6/net/sctp/sm_statefuns.c"));
 }
...
# 2446 "linux-2.6/net/sctp/sm_statefuns.c"
...
discard_force:
# 2471 "linux-2.6/net/sctp/sm_statefuns.c"
 if (chunk->end_of_packet)
...
# 2505 "linux-2.6/net/sctp/sm_statefuns.c"
         ...
         sctp_cmd_seq_t *commands)
{
 ...
 case SCTP_IERROR_NO_DATA:
  goto consume;
 default:
  __asm__ __volatile__( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (2531), "i" ("linux-2.6/net/sctp/sm_statefuns.c"));
 }
# 2542 "linux-2.6/net/sctp/sm_statefuns.c"
 if (chunk->end_of_packet) {
...
# 2588 "linux-2.6/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 ctsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(sackh->cum_tsn_ack))) ? ({ __u32 __x = ((( __u32)(__be32)(sackh->cum_tsn_ack))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(sackh->cum_tsn_ack))));
...
# 2648 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 2694 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 2734 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 2805 "linux-2.6/net/sctp/sm_statefuns.c"
    ...
    sctp_cmd_seq_t *commands)
{
 ...
 (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_OUTOFBLUES]++);

 ch = (sctp_chunkhdr_t *) chunk->chunk_hdr;
 do {
  ch_end = ((__u8 *)ch) + ((((__builtin_constant_p((__u16)(( __u16)(__be16)(ch->length))) ? ({ __u16 __x = ((( __u16)(__be16)(ch->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(ch->length)))))+3)&~3);
...
# 2856 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 2905 "linux-2.6/net/sctp/sm_statefuns.c"
      ...
      sctp_cmd_seq_t *commands)
{
 ...
 rcvd_serial = (__builtin_constant_p((__u32)(( __u32)(__be32)(addip_hdr->serial))) ? ({ __u32 __x = ((( __u32)(__be32)(addip_hdr->serial))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(addip_hdr->serial))));

 if (last_asconf) {
  addip_hdr = (sctp_addiphdr_t *)last_asconf->subh.addip_hdr;
  sent_serial = (__builtin_constant_p((__u32)(( __u32)(__be32)(addip_hdr->serial))) ? ({ __u32 __x = ((( __u32)(__be32)(addip_hdr->serial))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(addip_hdr->serial))));
 } else {
...
# 3070 "linux-2.6/net/sctp/sm_statefuns.c"
           ...
           sctp_cmd_seq_t *commands)
{
 ...
 tsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(fwdtsn_hdr->new_cum_tsn))) ? ({ __u32 __x = ((( __u32)(__be32)(fwdtsn_hdr->new_cum_tsn))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(fwdtsn_hdr->new_cum_tsn))));
 ;
...
# 3204 "linux-2.6/net/sctp/sm_statefuns.c"
         ...
         sctp_cmd_seq_t *commands)
{
 ...
 case SCTP_CID_ACTION_DISCARD_ERR:
  ...
  err_chunk = sctp_make_op_error(asoc, unk_chunk,
            ...
            ((((__builtin_constant_p((__u16)(( __u16)(__be16)(hdr->length))) ? ({ __u16 __x = ((( __u16)(__be16)(hdr->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(hdr->length)))))+3)&~3));
  if (err_chunk) {
   sctp_add_cmd_sf(commands, SCTP_CMD_REPLY,
     SCTP_CHUNK(err_chunk));
  }
...
# 3277 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3306 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3332 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3401 "linux-2.6/net/sctp/sm_statefuns.c"
           ...
           sctp_cmd_seq_t *commands)
{
 ...
 sctp_add_cmd_sf(commands, SCTP_CMD_NEW_STATE,
   SCTP_STATE(SCTP_STATE_COOKIE_WAIT));
# 3424 "linux-2.6/net/sctp/sm_statefuns.c"
 repl = sctp_make_init(asoc, &asoc->base.bind_addr, (0x20), 0);
 if (!repl)
  goto nomem;
...
# 3507 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3545 "linux-2.6/net/sctp/sm_statefuns.c"
...
{
 int disposition;
# 3562 "linux-2.6/net/sctp/sm_statefuns.c"
 sctp_add_cmd_sf(commands, SCTP_CMD_NEW_STATE,
...
# 3607 "linux-2.6/net/sctp/sm_statefuns.c"
sctp_disposition_t sctp_sf_do_9_1_prm_abort(
 ...
 sctp_cmd_seq_t *commands)
{
# 3622 "linux-2.6/net/sctp/sm_statefuns.c"
 ...
 abort = sctp_make_abort_user(asoc, ((void *)0), msg);
 if (!abort)
  retval = SCTP_DISPOSITION_NOMEM;
 else
...
# 3688 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3722 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3748 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3801 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3826 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3852 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3882 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3917 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 3981 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 4043 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 4122 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 4167 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 4190 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 4225 "linux-2.6/net/sctp/sm_statefuns.c"
        ...
        sctp_cmd_seq_t *commands)
{
 ...
 if (attempts < asoc->max_init_attempts) {
  ...
  case SCTP_EVENT_TIMEOUT_T1_INIT:
   bp = (struct sctp_bind_addr *) &asoc->base.bind_addr;
   repl = sctp_make_init(asoc, bp, (0x20), 0);
   break;
  ...
  default:
   __asm__ __volatile__( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (4255), "i" ("linux-2.6/net/sctp/sm_statefuns.c"));
   break;
  };
...
# 4291 "linux-2.6/net/sctp/sm_statefuns.c"
        ...
        sctp_cmd_seq_t *commands)
{
 ...
 default:
  __asm__ __volatile__( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (4319), "i" ("linux-2.6/net/sctp/sm_statefuns.c"));
  break;
 };
...
# 4394 "linux-2.6/net/sctp/sm_statefuns.c"
...
{
 int disposition;
# 4459 "linux-2.6/net/sctp/sm_statefuns.c"
 sctp_add_cmd_sf(commands, SCTP_CMD_NEW_STATE,
   SCTP_STATE(SCTP_STATE_SHUTDOWN_PENDING));
...
# 4488 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 4505 "linux-2.6/net/sctp/sm_statefuns.c"
...
# 4525 "linux-2.6/net/sctp/sm_statefuns.c"
...
struct sctp_sackhdr *sctp_sm_pull_sack(struct sctp_chunk *chunk)
{
 ...
 num_blocks = (__builtin_constant_p((__u16)(( __u16)(__be16)(sack->num_gap_ack_blocks))) ? ({ __u16 __x = ((( __u16)(__be16)(sack->num_gap_ack_blocks))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(sack->num_gap_ack_blocks))));
 num_dup_tsns = (__builtin_constant_p((__u16)(( __u16)(__be16)(sack->num_dup_tsns))) ? ({ __u16 __x = ((( __u16)(__be16)(sack->num_dup_tsns))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(sack->num_dup_tsns))));
     ...
     const struct sctp_chunk *chunk)
{
 ...
 sport = (__builtin_constant_p((__u16)(( __u16)(__be16)(chunk->sctp_hdr->dest))) ? ({ __u16 __x = ((( __u16)(__be16)(chunk->sctp_hdr->dest))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(chunk->sctp_hdr->dest))));
 dport = (__builtin_constant_p((__u16)(( __u16)(__be16)(chunk->sctp_hdr->source))) ? ({ __u16 __x = ((( __u16)(__be16)(chunk->sctp_hdr->source))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(chunk->sctp_hdr->source))));
 ...
 if (asoc) {
  ...
  case SCTP_CID_INIT:
  {
   ...
   vtag = (__builtin_constant_p((__u32)(( __u32)(__be32)(init->init_hdr.init_tag))) ? ({ __u32 __x = ((( __u32)(__be32)(init->init_hdr.init_tag))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(init->init_hdr.init_tag))));
   break;
  }
  default:
   vtag = (__builtin_constant_p((__u32)(( __u32)(__be32)(chunk->sctp_hdr->vtag))) ? ({ __u32 __x = ((( __u32)(__be32)(chunk->sctp_hdr->vtag))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(chunk->sctp_hdr->vtag))));
   break;
  }
 }


 transport = sctp_transport_new(sctp_source(chunk), (0x20));
 if (!transport)
  goto nomem;
 ...
 sctp_transport_route(transport, (union sctp_addr *)&chunk->dest,
        (&((struct sctp_sock *)sctp_get_ctl_sock())->sctp));
    ...
    sctp_cmd_seq_t *commands)
{
 ...
 tsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(data_hdr->tsn))) ? ({ __u32 __x = ((( __u32)(__be32)(data_hdr->tsn))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(data_hdr->tsn))));
 ;
# 4726 "linux-2.6/net/sctp/sm_statefuns.c"
 ...
 datalen = (__builtin_constant_p((__u16)(( __u16)(__be16)(chunk->chunk_hdr->length))) ? ({ __u16 __x = ((( __u16)(__be16)(chunk->chunk_hdr->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(chunk->chunk_hdr->length))));
...
# 4805 "linux-2.6/net/sctp/sm_statefuns.c"
 ...
 if (chunk->chunk_hdr->flags & SCTP_DATA_UNORDERED)
  (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_INUNORDERCHUNKS]++);
 else
  (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_INORDERCHUNKS]++);
# 4844 "linux-2.6/net/sctp/sm_statefuns.c"
 if ((__builtin_constant_p((__u16)(( __u16)(__be16)(data_hdr->stream))) ? ({ __u16 __x = ((( __u16)(__be16)(data_hdr->stream))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(data_hdr->stream)))) >= asoc->c.sinit_max_instreams) {
