# 1 "linux-2.6/net/sctp/bind_addr.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/sctp/bind_addr.c"
# 45 "linux-2.6/net/sctp/bind_addr.c"
...
# 46 "linux-2.6/net/sctp/bind_addr.c" 2
...
# 47 "linux-2.6/net/sctp/bind_addr.c" 2
...
# 48 "linux-2.6/net/sctp/bind_addr.c" 2
...
# 49 "linux-2.6/net/sctp/bind_addr.c" 2
...
typedef  struct ipv6_devconf   _GLOBAL_214_T; extern  _GLOBAL_214_T  global_ipv6_devconf[NUM_STACKS];    
...
# 50 "linux-2.6/net/sctp/bind_addr.c" 2
...
typedef  struct list_head   _GLOBAL_231_T; extern  _GLOBAL_231_T  global_tty_drivers[NUM_STACKS];    
...
typedef  struct screen_info   _GLOBAL_232_T; extern  _GLOBAL_232_T  global_screen_info[NUM_STACKS];    
...
typedef  struct termios   _GLOBAL_233_T; extern  _GLOBAL_233_T  global_tty_std_termios[NUM_STACKS];    
typedef  int  _GLOBAL_234_T; extern  _GLOBAL_234_T  global_fg_console[NUM_STACKS]; extern  _GLOBAL_234_T  global_last_console[NUM_STACKS]; extern  _GLOBAL_234_T  global_want_console[NUM_STACKS];     

typedef  int  _GLOBAL_235_T; extern  _GLOBAL_235_T  global_kmsg_redirect[NUM_STACKS];   
...
struct semaphore;
typedef  struct semaphore   _GLOBAL_236_T; extern  _GLOBAL_236_T  global_tty_sem[NUM_STACKS];    


typedef  struct tty_ldisc   _GLOBAL_237_T; extern  _GLOBAL_237_T  global_tty_ldisc_N_TTY[NUM_STACKS];    
...
typedef  struct proc_dir_entry   _GLOBAL_238_T; extern  _GLOBAL_238_T  global_proc_root[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_239_T; extern  _GLOBAL_239_T  * global_proc_root_fs[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_240_T; extern  _GLOBAL_240_T  * global_proc_net[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_241_T; extern  _GLOBAL_241_T  * global_proc_net_stat[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_242_T; extern  _GLOBAL_242_T  * global_proc_bus[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_243_T; extern  _GLOBAL_243_T  * global_proc_root_driver[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_244_T; extern  _GLOBAL_244_T  * global_proc_root_kcore[NUM_STACKS];    
...
typedef  struct vfsmount   _GLOBAL_245_T; extern  _GLOBAL_245_T  * global_proc_mnt[NUM_STACKS];    
...
typedef  struct file_operations   _GLOBAL_246_T; extern  _GLOBAL_246_T  global_proc_kcore_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_247_T; extern  _GLOBAL_247_T  global_proc_kmsg_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_248_T; extern  _GLOBAL_248_T  global_ppc_htab_operations[NUM_STACKS];    
...
# 52 "linux-2.6/net/sctp/bind_addr.c" 2
...
# 53 "linux-2.6/net/sctp/bind_addr.c" 2
   ...
   sctp_scope_t scope, int gfp, int flags)
{
 ...
 for (pos = (&src->address_list)->next, prefetch(pos->next); pos != (&src->address_list); pos = pos->next, prefetch(pos->next)) {
...
struct sctp_bind_addr *sctp_bind_addr_new(int gfp)
{
 ...
 retval = (struct sctp_bind_addr *)kmalloc(sizeof(struct sctp_bind_addr), gfp);
 if (!retval)
  goto nomem;
...
void sctp_bind_addr_init(struct sctp_bind_addr *bp, __u16 port)
{
 ...
 do { (&bp->address_list)->next = (&bp->address_list); (&bp->address_list)->prev = (&bp->address_list); } while (0);
 bp->port = port;
}
         ...
         int gfp)
{
 ...
 do { (&addr->list)->next = (&addr->list); (&addr->list)->prev = (&addr->list); } while (0);
      ...
      int addrs_len, __u16 port, int gfp)
{
 ...
 while (addrs_len) {
  ...
  len = (__builtin_constant_p((__u16)(( __u16)(__be16)(param->length))) ? ({ __u16 __x = ((( __u16)(__be16)(param->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(param->length))));
  addrs_len -= len;
  raw_addr_list += len;
 }
