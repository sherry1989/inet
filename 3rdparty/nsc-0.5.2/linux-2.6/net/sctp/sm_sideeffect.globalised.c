# 1 "linux-2.6/net/sctp/sm_sideeffect.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/sctp/sm_sideeffect.c"
# 50 "linux-2.6/net/sctp/sm_sideeffect.c"
# 1 "linux-2.6/include/linux/skbuff.h" 1
# 17 "linux-2.6/include/linux/skbuff.h"
...
# 18 "linux-2.6/include/linux/skbuff.h" 2
...
# 19 "linux-2.6/include/linux/skbuff.h" 2
...
# 51 "linux-2.6/net/sctp/sm_sideeffect.c" 2
...
# 53 "linux-2.6/net/sctp/sm_sideeffect.c" 2
...
# 54 "linux-2.6/net/sctp/sm_sideeffect.c" 2
...
# 56 "linux-2.6/net/sctp/sm_sideeffect.c" 2
...
# 57 "linux-2.6/net/sctp/sm_sideeffect.c" 2
...
# 84 "linux-2.6/net/sctp/sm_sideeffect.c"
static struct sctp_chunk *sctp_do_ecn_ecne_work(struct sctp_association *asoc,
        __u32 lowest_tsn,
        struct sctp_chunk *chunk)
{
 struct sctp_chunk *repl;
# 100 "linux-2.6/net/sctp/sm_sideeffect.c"
...
# 160 "linux-2.6/net/sctp/sm_sideeffect.c"
        if (max_tsn_seen != ctsn)
  asoc->peer.sack_needed = 1;
# 171 "linux-2.6/net/sctp/sm_sideeffect.c"
...
void sctp_generate_t3_rtx_event(unsigned long peer)
{
 ...
 do { do { } while (0); do { (void)(&((asoc->base.sk)->sk_lock.slock)); } while(0); (void)0; } while(0);
...
out_unlock:
 do { do { (void)(&((asoc->base.sk)->sk_lock.slock)); } while(0); do { } while (0); (void)0; } while (0);
...
typedef  sctp_timer_event_t _GLOBAL_338_T;  _GLOBAL_338_T  * _GLOBAL_0_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_1_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_2_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_3_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_4_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_5_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_6_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_7_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_8_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_9_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_10_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_11_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_12_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_13_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_14_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_15_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_16_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_17_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_18_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_19_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_20_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_21_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_22_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_23_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_24_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_25_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_26_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_27_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_28_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_29_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_30_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_31_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_32_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_33_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_34_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_35_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_36_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_37_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_38_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_39_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_40_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_41_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_42_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_43_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_44_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_45_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_46_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_47_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_48_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ;  _GLOBAL_338_T  * _GLOBAL_49_sctp_timer_events_I [ ( SCTP_EVENT_TIMEOUT_AUTOCLOSE + 1  )  ]   = { ( ( void *  ) 0  )  , sctp_generate_t1_cookie_event  , sctp_generate_t1_init_event  , sctp_generate_t2_shutdown_event  , ( ( void *  ) 0  )   , sctp_generate_t4_rto_event  , sctp_generate_t5_shutdown_guard_event  , sctp_generate_heartbeat_event  , sctp_generate_sack_event  , sctp_generate_autoclose_event  , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_sctp_timer_events_I) *_GLOBAL_sctp_timer_events_37_A[NUM_STACKS] = { &_GLOBAL_0_sctp_timer_events_I, &_GLOBAL_1_sctp_timer_events_I, &_GLOBAL_2_sctp_timer_events_I, &_GLOBAL_3_sctp_timer_events_I, &_GLOBAL_4_sctp_timer_events_I, &_GLOBAL_5_sctp_timer_events_I, &_GLOBAL_6_sctp_timer_events_I, &_GLOBAL_7_sctp_timer_events_I, &_GLOBAL_8_sctp_timer_events_I, &_GLOBAL_9_sctp_timer_events_I, &_GLOBAL_10_sctp_timer_events_I, &_GLOBAL_11_sctp_timer_events_I, &_GLOBAL_12_sctp_timer_events_I, &_GLOBAL_13_sctp_timer_events_I, &_GLOBAL_14_sctp_timer_events_I, &_GLOBAL_15_sctp_timer_events_I, &_GLOBAL_16_sctp_timer_events_I, &_GLOBAL_17_sctp_timer_events_I, &_GLOBAL_18_sctp_timer_events_I, &_GLOBAL_19_sctp_timer_events_I, &_GLOBAL_20_sctp_timer_events_I, &_GLOBAL_21_sctp_timer_events_I, &_GLOBAL_22_sctp_timer_events_I, &_GLOBAL_23_sctp_timer_events_I, &_GLOBAL_24_sctp_timer_events_I, &_GLOBAL_25_sctp_timer_events_I, &_GLOBAL_26_sctp_timer_events_I, &_GLOBAL_27_sctp_timer_events_I, &_GLOBAL_28_sctp_timer_events_I, &_GLOBAL_29_sctp_timer_events_I, &_GLOBAL_30_sctp_timer_events_I, &_GLOBAL_31_sctp_timer_events_I, &_GLOBAL_32_sctp_timer_events_I, &_GLOBAL_33_sctp_timer_events_I, &_GLOBAL_34_sctp_timer_events_I, &_GLOBAL_35_sctp_timer_events_I, &_GLOBAL_36_sctp_timer_events_I, &_GLOBAL_37_sctp_timer_events_I, &_GLOBAL_38_sctp_timer_events_I, &_GLOBAL_39_sctp_timer_events_I, &_GLOBAL_40_sctp_timer_events_I, &_GLOBAL_41_sctp_timer_events_I, &_GLOBAL_42_sctp_timer_events_I, &_GLOBAL_43_sctp_timer_events_I, &_GLOBAL_44_sctp_timer_events_I, &_GLOBAL_45_sctp_timer_events_I, &_GLOBAL_46_sctp_timer_events_I, &_GLOBAL_47_sctp_timer_events_I, &_GLOBAL_48_sctp_timer_events_I, &_GLOBAL_49_sctp_timer_events_I, };     
...
# 391 "linux-2.6/net/sctp/sm_sideeffect.c"
      ...
      unsigned error)
{
 ...
 sctp_ulpq_abort_pd(&asoc->ulpq, (0x20));
 ...
 if (!__sctp_style((asoc->base.sk), (SCTP_SOCKET_UDP)))
  asoc->base.sk->sk_err = 104;
        ...
        struct sctp_chunk *chunk)
{
 ...
 for ((skip) = (chunk)->subh.fwdtsn_hdr->skip; (void *)(skip) <= (void *)(chunk)->subh.fwdtsn_hdr->skip + (__builtin_constant_p((__u16)(( __u16)(__be16)((chunk)->chunk_hdr->length))) ? ({ __u16 __x = ((( __u16)(__be16)((chunk)->chunk_hdr->length))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)((chunk)->chunk_hdr->length)))) - sizeof(struct sctp_fwdtsn_chunk) - sizeof(struct sctp_fwdtsn_skip); (skip)++) {
  sctp_ulpq_skip(ulpq, (__builtin_constant_p((__u16)(( __u16)(__be16)(skip->stream))) ? ({ __u16 __x = ((( __u16)(__be16)(skip->stream))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(skip->stream)))), (__builtin_constant_p((__u16)(( __u16)(__be16)(skip->ssn))) ? ({ __u16 __x = ((( __u16)(__be16)(skip->ssn))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(skip->ssn)))));
 }
...
# 817 "linux-2.6/net/sctp/sm_sideeffect.c"
int sctp_do_sm(sctp_event_t event_type, sctp_subtype_t subtype,
        sctp_state_t state,
        struct sctp_endpoint *ep,
        struct sctp_association *asoc,
        ...
        int gfp)
{
 ...
 typedef  printfn_t  _GLOBAL_339_T; static  _GLOBAL_339_T  * _GLOBAL_0_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_1_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_2_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_3_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_4_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_5_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_6_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_7_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_8_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_9_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_10_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_11_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_12_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_13_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_14_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_15_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_16_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_17_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_18_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_19_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_20_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_21_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_22_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_23_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_24_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_25_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_26_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_27_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_28_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_29_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_30_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_31_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_32_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_33_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_34_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_35_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_36_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_37_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_38_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_39_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_40_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_41_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_42_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_43_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_44_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_45_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_46_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_47_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_48_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static  _GLOBAL_339_T  * _GLOBAL_49_table_I [ ]   = { ( ( void *  ) 0  )  , sctp_cname  , sctp_tname  , sctp_oname  , sctp_pname  , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_table_I) *_GLOBAL_table_38_A[NUM_STACKS] = { &_GLOBAL_0_table_I, &_GLOBAL_1_table_I, &_GLOBAL_2_table_I, &_GLOBAL_3_table_I, &_GLOBAL_4_table_I, &_GLOBAL_5_table_I, &_GLOBAL_6_table_I, &_GLOBAL_7_table_I, &_GLOBAL_8_table_I, &_GLOBAL_9_table_I, &_GLOBAL_10_table_I, &_GLOBAL_11_table_I, &_GLOBAL_12_table_I, &_GLOBAL_13_table_I, &_GLOBAL_14_table_I, &_GLOBAL_15_table_I, &_GLOBAL_16_table_I, &_GLOBAL_17_table_I, &_GLOBAL_18_table_I, &_GLOBAL_19_table_I, &_GLOBAL_20_table_I, &_GLOBAL_21_table_I, &_GLOBAL_22_table_I, &_GLOBAL_23_table_I, &_GLOBAL_24_table_I, &_GLOBAL_25_table_I, &_GLOBAL_26_table_I, &_GLOBAL_27_table_I, &_GLOBAL_28_table_I, &_GLOBAL_29_table_I, &_GLOBAL_30_table_I, &_GLOBAL_31_table_I, &_GLOBAL_32_table_I, &_GLOBAL_33_table_I, &_GLOBAL_34_table_I, &_GLOBAL_35_table_I, &_GLOBAL_36_table_I, &_GLOBAL_37_table_I, &_GLOBAL_38_table_I, &_GLOBAL_39_table_I, &_GLOBAL_40_table_I, &_GLOBAL_41_table_I, &_GLOBAL_42_table_I, &_GLOBAL_43_table_I, &_GLOBAL_44_table_I, &_GLOBAL_45_table_I, &_GLOBAL_46_table_I, &_GLOBAL_47_table_I, &_GLOBAL_48_table_I, &_GLOBAL_49_table_I, };    
       
 
 printfn_t *debug_fn  __attribute__ ((unused)) = (*_GLOBAL_table_38_A[get_stack_id()])[event_type];
        ...
        int gfp)
{
 ...
 case SCTP_DISPOSITION_BUG:
  printk("<3>" "sctp bug in state %d, "
         "event_type %d, event_id %d\n",
         state, event_type, subtype.chunk);
  __asm__ __volatile__( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (927), "i" ("linux-2.6/net/sctp/sm_sideeffect.c"));
  break;
 ...
 default:
  ...
  __asm__ __volatile__( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (934), "i" ("linux-2.6/net/sctp/sm_sideeffect.c"));
  break;
 };
...
# 976 "linux-2.6/net/sctp/sm_sideeffect.c"
 while (((void *)0) != (cmd = sctp_next_cmd(commands))) {
  ...
  case SCTP_CMD_GEN_INIT_ACK:
   ...
   new_obj = sctp_make_init_ack(asoc, chunk, (0x20),
           0);
   if (!new_obj)
    goto nomem;
...
# 1101 "linux-2.6/net/sctp/sm_sideeffect.c"
  ...
  case SCTP_CMD_TIMER_START:
   ...
   if (!timeout)
    __asm__ __volatile__( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (1198), "i" ("linux-2.6/net/sctp/sm_sideeffect.c"));
