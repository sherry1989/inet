# 1 "linux-2.6/net/sctp/command.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/sctp/command.c"
# 41 "linux-2.6/net/sctp/command.c"
...
# 42 "linux-2.6/net/sctp/command.c" 2
...
# 43 "linux-2.6/net/sctp/command.c" 2
...
# 44 "linux-2.6/net/sctp/command.c" 2


sctp_cmd_seq_t *sctp_new_cmd_seq(int gfp)
{
 sctp_cmd_seq_t *retval = (sctp_cmd_seq_t *)kmalloc(sizeof(sctp_cmd_seq_t), gfp);
