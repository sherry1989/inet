# 1 "linux-2.6/net/sctp/chunk.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/sctp/chunk.c"
# 40 "linux-2.6/net/sctp/chunk.c"
...
# 41 "linux-2.6/net/sctp/chunk.c" 2
...
# 42 "linux-2.6/net/sctp/chunk.c" 2
# 1 "linux-2.6/include/linux/net.h" 1
# 22 "linux-2.6/include/linux/net.h"
...
# 23 "linux-2.6/include/linux/net.h" 2
...
# 45 "linux-2.6/net/sctp/chunk.c" 2
...
# 46 "linux-2.6/net/sctp/chunk.c" 2
# 1 "linux-2.6/include/net/sctp/sctp.h" 1
# 76 "linux-2.6/include/net/sctp/sctp.h"
...
typedef  struct list_head   _GLOBAL_214_T; extern  _GLOBAL_214_T  global_tty_drivers[NUM_STACKS];    
...
typedef  struct screen_info   _GLOBAL_215_T; extern  _GLOBAL_215_T  global_screen_info[NUM_STACKS];    
...
typedef  struct termios   _GLOBAL_216_T; extern  _GLOBAL_216_T  global_tty_std_termios[NUM_STACKS];    
typedef  int  _GLOBAL_217_T; extern  _GLOBAL_217_T  global_fg_console[NUM_STACKS]; extern  _GLOBAL_217_T  global_last_console[NUM_STACKS]; extern  _GLOBAL_217_T  global_want_console[NUM_STACKS];     

typedef  int  _GLOBAL_218_T; extern  _GLOBAL_218_T  global_kmsg_redirect[NUM_STACKS];   
...
struct semaphore;
typedef  struct semaphore   _GLOBAL_219_T; extern  _GLOBAL_219_T  global_tty_sem[NUM_STACKS];    


typedef  struct tty_ldisc   _GLOBAL_220_T; extern  _GLOBAL_220_T  global_tty_ldisc_N_TTY[NUM_STACKS];    
...
typedef  struct proc_dir_entry   _GLOBAL_221_T; extern  _GLOBAL_221_T  global_proc_root[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_222_T; extern  _GLOBAL_222_T  * global_proc_root_fs[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_223_T; extern  _GLOBAL_223_T  * global_proc_net[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_224_T; extern  _GLOBAL_224_T  * global_proc_net_stat[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_225_T; extern  _GLOBAL_225_T  * global_proc_bus[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_226_T; extern  _GLOBAL_226_T  * global_proc_root_driver[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_227_T; extern  _GLOBAL_227_T  * global_proc_root_kcore[NUM_STACKS];    
...
typedef  struct file_operations   _GLOBAL_229_T; extern  _GLOBAL_229_T  global_proc_kcore_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_230_T; extern  _GLOBAL_230_T  global_proc_kmsg_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_231_T; extern  _GLOBAL_231_T  global_ppc_htab_operations[NUM_STACKS];    
...
# 47 "linux-2.6/net/sctp/chunk.c" 2
...
# 48 "linux-2.6/net/sctp/chunk.c" 2
...
void sctp_datamsg_init(struct sctp_datamsg *msg)
{
 ...
 msg->can_abandon = 0;
 msg->expires_at = 0;
 do { (&msg->chunks)->next = (&msg->chunks); (&msg->chunks)->prev = (&msg->chunks); } while (0);
}
...
# 168 "linux-2.6/net/sctp/chunk.c"
         ...
         struct msghdr *msgh, int msg_len)
{
 ...
 msg = sctp_datamsg_new((0x10 | 0x40 | 0x80));
 if (!msg)
  return ((void *)0);
 ...
 if ((whole > 1) || (whole && over))
  (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[1])->mibs[SCTP_MIB_FRAGUSRMSGS]++);
