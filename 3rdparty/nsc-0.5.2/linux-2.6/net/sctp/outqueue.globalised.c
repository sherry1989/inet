# 1 "linux-2.6/net/sctp/outqueue.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/sctp/outqueue.c"
# 49 "linux-2.6/net/sctp/outqueue.c"
...
# 50 "linux-2.6/net/sctp/outqueue.c" 2
...
# 51 "linux-2.6/net/sctp/outqueue.c" 2
...
# 52 "linux-2.6/net/sctp/outqueue.c" 2
...
# 53 "linux-2.6/net/sctp/outqueue.c" 2
...
typedef  struct list_head   _GLOBAL_215_T; extern  _GLOBAL_215_T  global_tty_drivers[NUM_STACKS];    
...
typedef  struct screen_info   _GLOBAL_216_T; extern  _GLOBAL_216_T  global_screen_info[NUM_STACKS];    
...
typedef  struct termios   _GLOBAL_217_T; extern  _GLOBAL_217_T  global_tty_std_termios[NUM_STACKS];    
typedef  int  _GLOBAL_218_T; extern  _GLOBAL_218_T  global_fg_console[NUM_STACKS]; extern  _GLOBAL_218_T  global_last_console[NUM_STACKS]; extern  _GLOBAL_218_T  global_want_console[NUM_STACKS];     

typedef  int  _GLOBAL_219_T; extern  _GLOBAL_219_T  global_kmsg_redirect[NUM_STACKS];   
...
struct semaphore;
typedef  struct semaphore   _GLOBAL_220_T; extern  _GLOBAL_220_T  global_tty_sem[NUM_STACKS];    


typedef  struct tty_ldisc   _GLOBAL_221_T; extern  _GLOBAL_221_T  global_tty_ldisc_N_TTY[NUM_STACKS];    
...
typedef  struct proc_dir_entry   _GLOBAL_222_T; extern  _GLOBAL_222_T  global_proc_root[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_223_T; extern  _GLOBAL_223_T  * global_proc_root_fs[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_224_T; extern  _GLOBAL_224_T  * global_proc_net[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_225_T; extern  _GLOBAL_225_T  * global_proc_net_stat[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_226_T; extern  _GLOBAL_226_T  * global_proc_bus[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_227_T; extern  _GLOBAL_227_T  * global_proc_root_driver[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_228_T; extern  _GLOBAL_228_T  * global_proc_root_kcore[NUM_STACKS];    
...
typedef  struct vfsmount   _GLOBAL_229_T; extern  _GLOBAL_229_T  * global_proc_mnt[NUM_STACKS];    
...
typedef  struct file_operations   _GLOBAL_230_T; extern  _GLOBAL_230_T  global_proc_kcore_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_231_T; extern  _GLOBAL_231_T  global_proc_kmsg_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_232_T; extern  _GLOBAL_232_T  global_ppc_htab_operations[NUM_STACKS];    
...
typedef  struct ipv6_devconf   _GLOBAL_233_T; extern  _GLOBAL_233_T  global_ipv6_devconf[NUM_STACKS];    
...
# 56 "linux-2.6/net/sctp/outqueue.c" 2
...
# 57 "linux-2.6/net/sctp/outqueue.c" 2
...
# 123 "linux-2.6/net/sctp/outqueue.c"
...
# 138 "linux-2.6/net/sctp/outqueue.c"
...
# 159 "linux-2.6/net/sctp/outqueue.c"
...
# 181 "linux-2.6/net/sctp/outqueue.c"
...
struct sctp_outq *sctp_outq_new(struct sctp_association *asoc)
{
 ...
 q = (struct sctp_outq *)kmalloc(sizeof(struct sctp_outq), (0x10 | 0x40 | 0x80));
 if (q) {
...
void sctp_outq_init(struct sctp_association *asoc, struct sctp_outq *q)
{
 ...
 do { (&q->retransmit)->next = (&q->retransmit); (&q->retransmit)->prev = (&q->retransmit); } while (0);
 do { (&q->sacked)->next = (&q->sacked); (&q->sacked)->prev = (&q->sacked); } while (0);
 do { (&q->abandoned)->next = (&q->abandoned); (&q->abandoned)->prev = (&q->abandoned); } while (0);
...
void sctp_outq_teardown(struct sctp_outq *q)
{
 ...
 for (pos = (&q->asoc->peer.transport_addr_list)->next, prefetch(pos->next); pos != (&q->asoc->peer.transport_addr_list); pos = pos->next, prefetch(pos->next)) {
 ...
 while ((chunk = (struct sctp_chunk *) skb_dequeue(&q->control)) != ((void *)0))
  sctp_chunk_free(chunk);
}
...
# 323 "linux-2.6/net/sctp/outqueue.c"
  switch (q->asoc->state) {
  ...
  default:
   ...
   if (chunk->chunk_hdr->flags & SCTP_DATA_UNORDERED)
    (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_OUTUNORDERCHUNKS]++);
   else
    (((*_GLOBAL_sctp_statistics_32_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])->mibs[SCTP_MIB_OUTORDERCHUNKS]++);
   q->empty = 0;
   break;
  };
 } else {
...
void sctp_insert_list(struct list_head *head, struct list_head *new)
{
 ...
 ntsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(nchunk->subh.data_hdr->tsn))) ? ({ __u32 __x = ((( __u32)(__be32)(nchunk->subh.data_hdr->tsn))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(nchunk->subh.data_hdr->tsn))));
 ...
 for (pos = (head)->next, prefetch(pos->next); pos != (head); pos = pos->next, prefetch(pos->next)) {
  ...
  ltsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(lchunk->subh.data_hdr->tsn))) ? ({ __u32 __x = ((( __u32)(__be32)(lchunk->subh.data_hdr->tsn))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(lchunk->subh.data_hdr->tsn))));
  if (TSN_lt(ntsn, ltsn)) {
...
# 415 "linux-2.6/net/sctp/outqueue.c"
  if ((fast_retransmit && chunk->fast_retransmit) ||
     (!fast_retransmit && !chunk->tsn_gap_acked)) {
# 425 "linux-2.6/net/sctp/outqueue.c"
...
# 514 "linux-2.6/net/sctp/outqueue.c"
          ...
          int rtx_timeout, int *start_timer)
{
 ...
 asoc = q->asoc;
 lqueue = &q->retransmit;
# 544 "linux-2.6/net/sctp/outqueue.c"
 ...
 while (lchunk) {
  ...
  if (rtx_timeout && !lchunk) {
   for (lchunk1 = (lqueue)->next, prefetch(lchunk1->next); lchunk1 != (lqueue); lchunk1 = lchunk1->next, prefetch(lchunk1->next)) {
...
# 658 "linux-2.6/net/sctp/outqueue.c"
int sctp_outq_flush(struct sctp_outq *q, int rtx_timeout)
{
 ...
 do { (&transport_list)->next = (&transport_list); (&transport_list)->prev = (&transport_list); } while (0);
 packet = ((void *)0);
# 691 "linux-2.6/net/sctp/outqueue.c"
 queue = &q->control;
 while ((chunk = (struct sctp_chunk *)skb_dequeue(queue)) != ((void *)0)) {
...
# 710 "linux-2.6/net/sctp/outqueue.c"
  ...
  default:
   ...
   __asm__ __volatile__( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (766), "i" ("linux-2.6/net/sctp/outqueue.c"));
  };
 }
 ...
 case SCTP_STATE_SHUTDOWN_PENDING:
 case SCTP_STATE_SHUTDOWN_RECEIVED:
# 792 "linux-2.6/net/sctp/outqueue.c"
  ...
  while ((chunk = sctp_outq_dequeue_data(q)) != ((void *)0)) {
   ...
   default:
    __asm__ __volatile__( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (912), "i" ("linux-2.6/net/sctp/outqueue.c"));
   }
# 925 "linux-2.6/net/sctp/outqueue.c"
...
sctp_flush_out:
# 954 "linux-2.6/net/sctp/outqueue.c"
     ...
     struct sctp_sackhdr *sack)
{
 ...
 frags = sack->variable;
 for (i = 0; i < (__builtin_constant_p((__u16)(( __u16)(__be16)(sack->num_gap_ack_blocks))) ? ({ __u16 __x = ((( __u16)(__be16)(sack->num_gap_ack_blocks))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(sack->num_gap_ack_blocks)))); i++) {
  unack_data -= (((__builtin_constant_p((__u16)(( __u16)(__be16)(frags[i].gab.end))) ? ({ __u16 __x = ((( __u16)(__be16)(frags[i].gab.end))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(frags[i].gab.end)))) -
    (__builtin_constant_p((__u16)(( __u16)(__be16)(frags[i].gab.start))) ? ({ __u16 __x = ((( __u16)(__be16)(frags[i].gab.start))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(frags[i].gab.start)))) + 1));
 }
      ...
      struct sctp_association *asoc)
{
 ...
 highest_new_tsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(sack->cum_tsn_ack))) ? ({ __u32 __x = ((( __u32)(__be32)(sack->cum_tsn_ack))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(sack->cum_tsn_ack))));

 for (ltransport = (transport_list)->next, prefetch(ltransport->next); ltransport != (transport_list); ltransport = ltransport->next, prefetch(ltransport->next)) {
  transport = ({ const typeof( ((struct sctp_transport *)0)->transports ) *__mptr = (ltransport); (struct sctp_transport *)( (char *)__mptr - ((size_t) &((struct sctp_transport *)0)->transports) );})
                      ;
  for (lchunk = (&transport->transmitted)->next, prefetch(lchunk->next); lchunk != (&transport->transmitted); lchunk = lchunk->next, prefetch(lchunk->next)) {
   chunk = ({ const typeof( ((struct sctp_chunk *)0)->transmitted_list ) *__mptr = (lchunk); (struct sctp_chunk *)( (char *)__mptr - ((size_t) &((struct sctp_chunk *)0)->transmitted_list) );})
                         ;
   tsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(chunk->subh.data_hdr->tsn))) ? ({ __u32 __x = ((( __u32)(__be32)(chunk->subh.data_hdr->tsn))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(chunk->subh.data_hdr->tsn))));
...
int sctp_outq_sack(struct sctp_outq *q, struct sctp_sackhdr *sack)
{
 ...
 sack_ctsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(sack->cum_tsn_ack))) ? ({ __u32 __x = ((( __u32)(__be32)(sack->cum_tsn_ack))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(sack->cum_tsn_ack))));
# 1049 "linux-2.6/net/sctp/outqueue.c"
 if (TSN_lte(primary->cacc.next_tsn_at_change, sack_ctsn)) {
  primary->cacc.changeover_active = 0;
  for (pos = (transport_list)->next, prefetch(pos->next); pos != (transport_list); pos = pos->next, prefetch(pos->next)) {
   transport = ({ const typeof( ((struct sctp_transport *)0)->transports ) *__mptr = (pos); (struct sctp_transport *)( (char *)__mptr - ((size_t) &((struct sctp_transport *)0)->transports) );})
                ;
   transport->cacc.cycling_changeover = 0;
  }
 }
# 1066 "linux-2.6/net/sctp/outqueue.c"
 ...
 if (sack->num_gap_ack_blocks)
  highest_tsn +=
      (__builtin_constant_p((__u16)(( __u16)(__be16)(frags[(__builtin_constant_p((__u16)(( __u16)(__be16)(sack->num_gap_ack_blocks))) ? ({ __u16 __x = ((( __u16)(__be16)(sack->num_gap_ack_blocks))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(sack->num_gap_ack_blocks)))) - 1].gab.end))) ? ({ __u16 __x = ((( __u16)(__be16)(frags[(__builtin_constant_p((__u16)(( __u16)(__be16)(sack->num_gap_ack_blocks))) ? ({ __u16 __x = ((( __u16)(__be16)(sack->num_gap_ack_blocks))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(sack->num_gap_ack_blocks)))) - 1].gab.end))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(frags[(__builtin_constant_p((__u16)(( __u16)(__be16)(sack->num_gap_ack_blocks))) ? ({ __u16 __x = ((( __u16)(__be16)(sack->num_gap_ack_blocks))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(sack->num_gap_ack_blocks)))) - 1].gab.end))));
 ...
 for (lchunk = (&q->sacked)->next, temp = lchunk->next; lchunk != (&q->sacked); lchunk = temp, temp = lchunk->next) {
  tchunk = ({ const typeof( ((struct sctp_chunk *)0)->transmitted_list ) *__mptr = (lchunk); (struct sctp_chunk *)( (char *)__mptr - ((size_t) &((struct sctp_chunk *)0)->transmitted_list) );})
                         ;
  tsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(tchunk->subh.data_hdr->tsn))) ? ({ __u32 __x = ((( __u32)(__be32)(tchunk->subh.data_hdr->tsn))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(tchunk->subh.data_hdr->tsn))));
  if (TSN_lte(tsn, ctsn))
 ...
 sack_a_rwnd = (__builtin_constant_p((__u32)(( __u32)(__be32)(sack->a_rwnd))) ? ({ __u32 __x = ((( __u32)(__be32)(sack->a_rwnd))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(sack->a_rwnd))));
...
# 1202 "linux-2.6/net/sctp/outqueue.c"
static void sctp_check_transmitted(struct sctp_outq *q,
       struct list_head *transmitted_queue,
       struct sctp_transport *transport,
       struct sctp_sackhdr *sack,
       __u32 highest_new_tsn_in_sack)
{
 ...
 int bytes_acked = 0;
# 1232 "linux-2.6/net/sctp/outqueue.c"
 sack_ctsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(sack->cum_tsn_ack))) ? ({ __u32 __x = ((( __u32)(__be32)(sack->cum_tsn_ack))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(sack->cum_tsn_ack))));

 do { (&tlist)->next = (&tlist); (&tlist)->prev = (&tlist); } while (0);
 ...
 while (((void *)0) != (lchunk = sctp_list_dequeue(transmitted_queue))) {
  ...
  if (sctp_acked(sack, tsn)) {
   ...
   if (transport) {
# 1266 "linux-2.6/net/sctp/outqueue.c"
...
# 1284 "linux-2.6/net/sctp/outqueue.c"
    restart_timer = 1;

    if (!tchunk->tsn_gap_acked) {
     tchunk->tsn_gap_acked = 1;
     bytes_acked += sctp_data_size(tchunk);
# 1302 "linux-2.6/net/sctp/outqueue.c"
     if (transport &&
...
# 1328 "linux-2.6/net/sctp/outqueue.c"
    if (!tchunk->tsn_gap_acked) {
     tchunk->tsn_gap_acked = 1;
     bytes_acked += sctp_data_size(tchunk);
    }
...
# 1379 "linux-2.6/net/sctp/outqueue.c"
  } else {
   if (tchunk->tsn_gap_acked) {
    ...
    bytes_acked -= sctp_data_size(tchunk);
# 1398 "linux-2.6/net/sctp/outqueue.c"
    restart_timer = 1;
   }

   list_add_tail(lchunk, &tlist);
# 1433 "linux-2.6/net/sctp/outqueue.c"
  }
 }
# 1455 "linux-2.6/net/sctp/outqueue.c"
 if (transport) {
  if (bytes_acked) {
...
# 1494 "linux-2.6/net/sctp/outqueue.c"
   if (!q->asoc->peer.rwnd &&
       !list_empty(&tlist) &&
         ...
         int count_of_newacks)
{
 ...
 for (pos = (transmitted_queue)->next, prefetch(pos->next); pos != (transmitted_queue); pos = pos->next, prefetch(pos->next)) {
  ...
  tsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(chunk->subh.data_hdr->tsn))) ? ({ __u32 __x = ((( __u32)(__be32)(chunk->subh.data_hdr->tsn))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(chunk->subh.data_hdr->tsn))));
# 1551 "linux-2.6/net/sctp/outqueue.c"
...
static int sctp_acked(struct sctp_sackhdr *sack, __u32 tsn)
{
 ...
 sctp_sack_variable_t *frags;
 __u16 gap;
 __u32 ctsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(sack->cum_tsn_ack))) ? ({ __u32 __x = ((( __u32)(__be32)(sack->cum_tsn_ack))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(sack->cum_tsn_ack))));

        if (TSN_lte(tsn, ctsn))
  goto pass;
# 1616 "linux-2.6/net/sctp/outqueue.c"
 frags = sack->variable;
 gap = tsn - ctsn;
 for (i = 0; i < (__builtin_constant_p((__u16)(( __u16)(__be16)(sack->num_gap_ack_blocks))) ? ({ __u16 __x = ((( __u16)(__be16)(sack->num_gap_ack_blocks))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(sack->num_gap_ack_blocks)))); ++i) {
  if (TSN_lte((__builtin_constant_p((__u16)(( __u16)(__be16)(frags[i].gab.start))) ? ({ __u16 __x = ((( __u16)(__be16)(frags[i].gab.start))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(frags[i].gab.start)))), gap) &&
      TSN_lte(gap, (__builtin_constant_p((__u16)(( __u16)(__be16)(frags[i].gab.end))) ? ({ __u16 __x = ((( __u16)(__be16)(frags[i].gab.end))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(frags[i].gab.end))))))
   goto pass;
 }
...
# 1683 "linux-2.6/net/sctp/outqueue.c"
 for (lchunk = (&q->abandoned)->next, temp = lchunk->next; lchunk != (&q->abandoned); lchunk = temp, temp = lchunk->next) {
  chunk = ({ const typeof( ((struct sctp_chunk *)0)->transmitted_list ) *__mptr = (lchunk); (struct sctp_chunk *)( (char *)__mptr - ((size_t) &((struct sctp_chunk *)0)->transmitted_list) );})
                      ;
  tsn = (__builtin_constant_p((__u32)(( __u32)(__be32)(chunk->subh.data_hdr->tsn))) ? ({ __u32 __x = ((( __u32)(__be32)(chunk->subh.data_hdr->tsn))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(chunk->subh.data_hdr->tsn))));
...
# 1739 "linux-2.6/net/sctp/outqueue.c"
