# 1 "linux-2.6/net/packet/af_packet.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/packet/af_packet.c"
# 47 "linux-2.6/net/packet/af_packet.c"
...
# 48 "linux-2.6/net/packet/af_packet.c" 2
...
# 49 "linux-2.6/net/packet/af_packet.c" 2
...
# 50 "linux-2.6/net/packet/af_packet.c" 2
...
# 51 "linux-2.6/net/packet/af_packet.c" 2
...
# 53 "linux-2.6/net/packet/af_packet.c" 2
...
# 54 "linux-2.6/net/packet/af_packet.c" 2
# 1 "linux-2.6/include/linux/inet.h" 1
# 48 "linux-2.6/include/linux/inet.h"
extern __u32 in_aton(const char *str);
# 55 "linux-2.6/net/packet/af_packet.c" 2
...
# 56 "linux-2.6/net/packet/af_packet.c" 2

# 1 "linux-2.6/include/linux/wireless.h" 1
# 466 "linux-2.6/include/linux/wireless.h"
struct iw_param
{
  __s32 value;
  __u8 fixed;
...
# 493 "linux-2.6/include/linux/wireless.h"
struct iw_freq
{
 __s32 m;
 __s16 e;
...
# 520 "linux-2.6/include/linux/wireless.h"
struct iw_discarded
{
 __u32 nwid;
 __u32 code;
...
# 575 "linux-2.6/include/linux/wireless.h"
union iwreq_data
{
...
# 634 "linux-2.6/include/linux/wireless.h"
struct iw_range
{

 __u32 throughput;
# 646 "linux-2.6/include/linux/wireless.h"
 __u32 min_nwid;
 __u32 max_nwid;
...
# 674 "linux-2.6/include/linux/wireless.h"
...
# 752 "linux-2.6/include/linux/wireless.h"
struct iw_event
{
 __u16 len;
 __u16 cmd;
...
# 58 "linux-2.6/net/packet/af_packet.c" 2
...
int ipv4_doint_and_flush_strategy(ctl_table *table, int *name, int nlen,
      ...
      void *newval, size_t newlen,
      void **context);
# 60 "linux-2.6/net/packet/af_packet.c" 2
...
# 61 "linux-2.6/net/packet/af_packet.c" 2
...
# 68 "linux-2.6/net/packet/af_packet.c" 2
...
typedef  rwlock_t  _GLOBAL_238_T; extern  _GLOBAL_238_T  global_vmlist_lock[NUM_STACKS];   
typedef  struct vm_struct   _GLOBAL_239_T; extern  _GLOBAL_239_T  * global_vmlist[NUM_STACKS];    
...
# 70 "linux-2.6/net/packet/af_packet.c" 2
...
typedef  struct proc_dir_entry   _GLOBAL_240_T; extern  _GLOBAL_240_T  global_proc_root[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_241_T; extern  _GLOBAL_241_T  * global_proc_root_fs[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_242_T; extern  _GLOBAL_242_T  * global_proc_net[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_243_T; extern  _GLOBAL_243_T  * global_proc_net_stat[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_244_T; extern  _GLOBAL_244_T  * global_proc_bus[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_245_T; extern  _GLOBAL_245_T  * global_proc_root_driver[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_246_T; extern  _GLOBAL_246_T  * global_proc_root_kcore[NUM_STACKS];    
...
typedef  struct file_operations   _GLOBAL_248_T; extern  _GLOBAL_248_T  global_proc_kcore_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_249_T; extern  _GLOBAL_249_T  global_proc_kmsg_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_250_T; extern  _GLOBAL_250_T  global_ppc_htab_operations[NUM_STACKS];    
...
# 71 "linux-2.6/net/packet/af_packet.c" 2
...
typedef  struct proto_ops   _GLOBAL_251_T; extern  _GLOBAL_251_T  global_inet_stream_ops[NUM_STACKS];    
typedef  struct proto_ops   _GLOBAL_252_T; extern  _GLOBAL_252_T  global_inet_dgram_ops[NUM_STACKS];    
...
typedef  atomic_t  _GLOBAL_253_T; extern  _GLOBAL_253_T  global_inet_sock_nr[NUM_STACKS];   
...
# 78 "linux-2.6/net/packet/af_packet.c" 2
# 148 "linux-2.6/net/packet/af_packet.c"
typedef  struct hlist_head  _GLOBAL_254_T;  _GLOBAL_254_T  global_packet_sklist[NUM_STACKS] = {  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  { . first  = ( ( void *  ) 0  )   } ,  };          
typedef  rwlock_t  _GLOBAL_255_T; static  _GLOBAL_255_T  global_packet_sklist_lock[NUM_STACKS] = {  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  };       

typedef  atomic_t _GLOBAL_256_T;  _GLOBAL_256_T  global_packet_socks_nr[NUM_STACKS];  
...
# 184 "linux-2.6/net/packet/af_packet.c"
...
void packet_sock_destruct(struct sock *sk)
{
 ...
 if (((struct packet_opt *)(sk)->sk_protinfo))
  kfree(((struct packet_opt *)(sk)->sk_protinfo));
...
typedef  struct proto_ops   _GLOBAL_257_T; extern  _GLOBAL_257_T  global_packet_ops[NUM_STACKS];    


typedef  struct proto_ops   _GLOBAL_258_T; extern  _GLOBAL_258_T  global_packet_ops_spkt[NUM_STACKS];    
...
# 265 "linux-2.6/net/packet/af_packet.c"
 if (skb->pkt_type == 5)
  goto out;
          ...
          struct msghdr *msg, size_t len)
{
 ...
 err = -105;
 skb = sock_wmalloc(sk, len + (((dev)->hard_header_len&~(16 - 1)) + 16), 0, (0x10 | 0x40 | 0x80));
 ...
 if (skb == ((void *)0))
  goto out_unlock;
# 370 "linux-2.6/net/packet/af_packet.c"
...
# 439 "linux-2.6/net/packet/af_packet.c"
static int packet_rcv(struct sk_buff *skb, struct net_device *dev, struct packet_type *pt)
{
 ...
 sk = pt->af_packet_priv;
 po = ((struct packet_opt *)(sk)->sk_protinfo);
 ...
 if (skb_shared(skb)) {
  struct sk_buff *nskb = skb_clone(skb, (0x20));
  if (nskb == ((void *)0))
   goto drop_n_acct;
...
# 686 "linux-2.6/net/packet/af_packet.c"
     ...
     struct msghdr *msg, size_t len)
{
 ...
 if (saddr == ((void *)0)) {
  struct packet_opt *po = ((struct packet_opt *)(sk)->sk_protinfo);
 ...
 if (dev->hard_header) {
  int res;
  err = -22;
  res = dev->hard_header(skb, dev, (__builtin_constant_p((__u16)(( __u16)(__be16)(proto))) ? ({ __u16 __x = ((( __u16)(__be16)(proto))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(proto)))), addr, ((void *)0), len);
...
static int packet_release(struct socket *sock)
{
 ...
 do { do { (current_thread_info()->preempt_count) += (1UL << (0 + 8)); __asm__ __volatile__("": : :"memory"); } while (0); do { } while (0); do { (void)(&global_packet_sklist_lock[get_stack_id()]); } while(0); (void)0; } while (0);
 sk_del_node_init(sk);
 do { do { (void)(&global_packet_sklist_lock[get_stack_id()]); } while(0); do { } while (0); local_bh_enable(); (void)0; } while (0);
...
# 830 "linux-2.6/net/packet/af_packet.c"
 sock_orphan(sk);
 sock->sk = ((void *)0);
...
static int packet_do_bind(struct sock *sk, struct net_device *dev, int protocol)
{
 ...
 do { do { } while (0); do { (void)(&po->bind_lock); } while(0); (void)0; } while(0);
 if (po->running) {
  __sock_put(sk);
  po->running = 0;
  po->num = 0;
  do { do { (void)(&po->bind_lock); } while(0); do { } while (0); (void)0; } while (0);
  dev_remove_pack(&po->prot_hook);
  do { do { } while (0); do { (void)(&po->bind_lock); } while(0); (void)0; } while(0);
 }
...
static int packet_bind_spkt(struct socket *sock, struct sockaddr *uaddr, int addr_len)
{
 ...
 if (dev) {
  err = packet_do_bind(sk, dev, ((struct packet_opt *)(sk)->sk_protinfo)->num);
  dev_put(dev);
 }
 return err;
}
...
static int packet_bind(struct socket *sock, struct sockaddr *uaddr, int addr_len)
{
 ...
 err = packet_do_bind(sk, dev, sll->sll_protocol ? : ((struct packet_opt *)(sk)->sk_protinfo)->num);
 if (dev)
  dev_put(dev);
...
static int packet_create(struct socket *sock, int protocol)
{
 ...
 err = -105;
 sk = sk_alloc(17, (0x10 | 0x40 | 0x80), 1, ((void *)0));
 if (sk == ((void *)0))
  goto out;
 ...
 po = sk->sk_protinfo = kmalloc(sizeof(*po), (0x10 | 0x40 | 0x80));
 if (!po)
  goto out_free;
 (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(*po))) ? __constant_c_and_count_memset(((po)),((0x01010101UL*(unsigned char)(0))),((sizeof(*po)))) : __constant_c_memset(((po)),((0x01010101UL*(unsigned char)(0))),((sizeof(*po))))) : (__builtin_constant_p((sizeof(*po))) ? __memset_generic((((po))),(((0))),(((sizeof(*po))))) : __memset_generic(((po)),((0)),((sizeof(*po))))));
     ...
     struct msghdr *msg, size_t len, int flags)
{
 ...
 if (flags & ~(2|0x40|0x20|0))
  goto out;
# 1058 "linux-2.6/net/packet/af_packet.c"
 if (sock->type == SOCK_PACKET)
  msg->msg_namelen = sizeof(struct sockaddr_pkt);
 else
  msg->msg_namelen = sizeof(struct sockaddr_ll);
# 1072 "linux-2.6/net/packet/af_packet.c"
          ...
          int *uaddr_len, int peer)
{
 ...
 uaddr->sa_family = 17;
 dev = dev_get_by_index(((struct packet_opt *)(sk)->sk_protinfo)->ifindex);
 if (dev) {
...
static int packet_mc_add(struct sock *sk, struct packet_mreq *mreq)
{
 ...
 err = -105;
 i = (struct packet_mclist *)kmalloc(sizeof(*i), (0x10 | 0x40 | 0x80));
 if (i == ((void *)0))
  goto done;
...
static int packet_mc_drop(struct sock *sk, struct packet_mreq *mreq)
{
 ...
 for (mlp = &((struct packet_opt *)(sk)->sk_protinfo)->mclist; (ml = *mlp) != ((void *)0); mlp = &ml->next) {
  if (ml->ifindex == mreq->mr_ifindex &&
      ml->type == mreq->mr_type &&
      ml->alen == mreq->mr_alen &&
      __builtin_memcmp(ml->addr, mreq->mr_address, ml->alen) == 0) {
...
# 1348 "linux-2.6/net/packet/af_packet.c"
 default:
  return -92;
 }
}
        ...
        char *optval, int *optlen)
{
 ...
 case 6:
 {
  ...
  do { do { (current_thread_info()->preempt_count) += (1UL << (0 + 8)); __asm__ __volatile__("": : :"memory"); } while (0); do { } while (0); do { (void)(&sk->sk_receive_queue.lock); } while(0); (void)0; } while (0);
  st = po->stats;
  ...
  do { do { (void)(&sk->sk_receive_queue.lock); } while(0); do { } while (0); local_bh_enable(); (void)0; } while (0);
...
static int packet_notifier(struct notifier_block *this, unsigned long msg, void *data)
{
 ...
 do { do { } while (0); do { (void)(&global_packet_sklist_lock[get_stack_id()]); } while(0); (void)0; } while(0);
 ...
 do { do { (void)(&global_packet_sklist_lock[get_stack_id()]); } while(0); do { } while (0); (void)0; } while(0);
 return 0x0000;
}
...
# 1750 "linux-2.6/net/packet/af_packet.c"
typedef  struct proto_ops  _GLOBAL_259_T;  _GLOBAL_259_T  global_packet_ops_spkt[NUM_STACKS] = {  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  };     
...
typedef  struct net_proto_family   _GLOBAL_261_T; static  _GLOBAL_261_T  global_packet_family_ops[NUM_STACKS] = {  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };      
   
   
     


typedef  struct notifier_block   _GLOBAL_262_T; static  _GLOBAL_262_T  global_packet_netdev_notifier[NUM_STACKS] = {  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  };      
...
static int packet_seq_show(struct seq_file *seq, void *v)
{
 if (v == ((void *)1))
  ...
  struct sock *s = v;
  const struct packet_opt *po = ((struct packet_opt *)(s)->sk_protinfo);
  ...
  seq_printf(seq,
      ...
      s->sk_type,
      (__builtin_constant_p((__u16)(( __u16)(__be16)(po->num))) ? ({ __u16 __x = ((( __u16)(__be16)(po->num))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(po->num)))),
      po->ifindex,
      po->running,
...
typedef  struct seq_operations   _GLOBAL_263_T; static  _GLOBAL_263_T  global_packet_seq_ops[NUM_STACKS] = {  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  { . start  = packet_seq_start  , . next  = packet_seq_next   , . stop  = packet_seq_stop   , . show  = packet_seq_show   , } ,  };      
...
typedef  struct file_operations   _GLOBAL_264_T; static  _GLOBAL_264_T  global_packet_seq_fops[NUM_STACKS] = {  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = packet_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  };      
