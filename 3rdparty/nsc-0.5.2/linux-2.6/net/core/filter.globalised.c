# 1 "linux-2.6/net/core/filter.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/core/filter.c"
# 18 "linux-2.6/net/core/filter.c"
...
# 19 "linux-2.6/net/core/filter.c" 2
...
# 22 "linux-2.6/net/core/filter.c" 2
...
# 24 "linux-2.6/net/core/filter.c" 2
...
# 27 "linux-2.6/net/core/filter.c" 2
...
int ipv4_doint_and_flush_strategy(ctl_table *table, int *name, int nlen,
      ...
      void *newval, size_t newlen,
      void **context);
# 29 "linux-2.6/net/core/filter.c" 2
...
# 30 "linux-2.6/net/core/filter.c" 2
# 39 "linux-2.6/net/core/filter.c"
...
# 65 "linux-2.6/net/core/filter.c"
int sk_run_filter(struct sk_buff *skb, struct sock_filter *filter, int flen)
{
 ...
 load_w:
   if (k >= 0 && (unsigned int)(k+sizeof(u32)) <= len) {
    A = (__builtin_constant_p((__u32)(( __u32)(__be32)(*(u32*)&data[k]))) ? ({ __u32 __x = ((( __u32)(__be32)(*(u32*)&data[k]))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(*(u32*)&data[k]))));
    continue;
   }
   if (k < 0) {
    u8 *ptr;
    ...
    if (ptr) {
     A = (__builtin_constant_p((__u32)(( __u32)(__be32)(*(u32*)ptr))) ? ({ __u32 __x = ((( __u32)(__be32)(*(u32*)ptr))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(*(u32*)ptr))));
     continue;
    }
   } else {
    u32 _tmp, *p;
    ...
    if (p != ((void *)0)) {
     A = (__builtin_constant_p((__u32)(( __u32)(__be32)(*p))) ? ({ __u32 __x = ((( __u32)(__be32)(*p))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((( __u32)(__be32)(*p))));
     continue;
    }
   }
   return 0;
 ...
 load_h:
   if (k >= 0 && (unsigned int)(k + sizeof(u16)) <= len) {
    A = (__builtin_constant_p((__u16)(( __u16)(__be16)(*(u16*)&data[k]))) ? ({ __u16 __x = ((( __u16)(__be16)(*(u16*)&data[k]))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(*(u16*)&data[k]))));
    continue;
   }
   if (k < 0) {
    u8 *ptr;
    ...
    ptr = load_pointer(skb, k);
    if (ptr) {
     A = (__builtin_constant_p((__u16)(( __u16)(__be16)(*(u16*)ptr))) ? ({ __u16 __x = ((( __u16)(__be16)(*(u16*)ptr))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(*(u16*)ptr))));
     continue;
    }
   } else {
    u16 _tmp, *p;
    ...
    if (p != ((void *)0)) {
     A = (__builtin_constant_p((__u16)(( __u16)(__be16)(*p))) ? ({ __u16 __x = ((( __u16)(__be16)(*p))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16((( __u16)(__be16)(*p))));
     continue;
    }
   }
   return 0;
...
load_b:
  ...
  switch (k-(-0x1000)) {
  case 0:
   A = (( __be16)(__builtin_constant_p((__u16)((skb->protocol))) ? ({ __u16 __x = (((skb->protocol))); ((__u16)( (((__u16)(__x) & (__u16)0x00ffU) << 8) | (((__u16)(__x) & (__u16)0xff00U) >> 8) )); }) : __fswab16(((skb->protocol)))));
   continue;
  case 4:
   A = skb->pkt_type;
   continue;
...
# 333 "linux-2.6/net/core/filter.c"
int sk_chk_filter(struct sock_filter *filter, int flen)
{
 ...
 for (pc = 0; pc < flen; pc++) {
  ...
  ftest = &filter[pc];
  if (((ftest->code) & 0x07) == 0x05) {

   if (((ftest->code) & 0xf0) == 0x00) {
...
# 394 "linux-2.6/net/core/filter.c"
int sk_attach_filter(struct sock_fprog *fprog, struct sock *sk)
{
 ...
 int err;
        ...
        if (fprog->filter == ((void *)0) || fprog->len > 4096)
                return -22;

 fp = sock_kmalloc(sk, fsize+sizeof(*fp), (0x10 | 0x40 | 0x80));
 if (!fp)
  return -12;
 ...
 if (!err) {
  ...
  do { do { (current_thread_info()->preempt_count) += (1UL << (0 + 8)); __asm__ __volatile__("": : :"memory"); } while (0); do { } while (0); do { (void)(&sk->sk_lock.slock); } while(0); (void)0; } while (0);
  old_fp = sk->sk_filter;
  sk->sk_filter = fp;
  do { do { (void)(&sk->sk_lock.slock); } while(0); do { } while (0); local_bh_enable(); (void)0; } while (0);
  fp = old_fp;
 }
 ...
 typedef  const char   _GLOBAL_238_T; static  _GLOBAL_238_T  _GLOBAL_0___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_1___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_2___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_3___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_4___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_5___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_6___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_7___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_8___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_9___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_10___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_11___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_12___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_13___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_14___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_15___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_16___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_17___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_18___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_19___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_20___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_21___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_22___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_23___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_24___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_25___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_26___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_27___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_28___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_29___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_30___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_31___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_32___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_33___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_34___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_35___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_36___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_37___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_38___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_39___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_40___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_41___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_42___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_43___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_44___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_45___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_46___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_47___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_48___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static  _GLOBAL_238_T  _GLOBAL_49___kstrtab_sk_chk_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_chk_filter"  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0___kstrtab_sk_chk_filter_I) *_GLOBAL___kstrtab_sk_chk_filter_31_A[NUM_STACKS] = { &_GLOBAL_0___kstrtab_sk_chk_filter_I, &_GLOBAL_1___kstrtab_sk_chk_filter_I, &_GLOBAL_2___kstrtab_sk_chk_filter_I, &_GLOBAL_3___kstrtab_sk_chk_filter_I, &_GLOBAL_4___kstrtab_sk_chk_filter_I, &_GLOBAL_5___kstrtab_sk_chk_filter_I, &_GLOBAL_6___kstrtab_sk_chk_filter_I, &_GLOBAL_7___kstrtab_sk_chk_filter_I, &_GLOBAL_8___kstrtab_sk_chk_filter_I, &_GLOBAL_9___kstrtab_sk_chk_filter_I, &_GLOBAL_10___kstrtab_sk_chk_filter_I, &_GLOBAL_11___kstrtab_sk_chk_filter_I, &_GLOBAL_12___kstrtab_sk_chk_filter_I, &_GLOBAL_13___kstrtab_sk_chk_filter_I, &_GLOBAL_14___kstrtab_sk_chk_filter_I, &_GLOBAL_15___kstrtab_sk_chk_filter_I, &_GLOBAL_16___kstrtab_sk_chk_filter_I, &_GLOBAL_17___kstrtab_sk_chk_filter_I, &_GLOBAL_18___kstrtab_sk_chk_filter_I, &_GLOBAL_19___kstrtab_sk_chk_filter_I, &_GLOBAL_20___kstrtab_sk_chk_filter_I, &_GLOBAL_21___kstrtab_sk_chk_filter_I, &_GLOBAL_22___kstrtab_sk_chk_filter_I, &_GLOBAL_23___kstrtab_sk_chk_filter_I, &_GLOBAL_24___kstrtab_sk_chk_filter_I, &_GLOBAL_25___kstrtab_sk_chk_filter_I, &_GLOBAL_26___kstrtab_sk_chk_filter_I, &_GLOBAL_27___kstrtab_sk_chk_filter_I, &_GLOBAL_28___kstrtab_sk_chk_filter_I, &_GLOBAL_29___kstrtab_sk_chk_filter_I, &_GLOBAL_30___kstrtab_sk_chk_filter_I, &_GLOBAL_31___kstrtab_sk_chk_filter_I, &_GLOBAL_32___kstrtab_sk_chk_filter_I, &_GLOBAL_33___kstrtab_sk_chk_filter_I, &_GLOBAL_34___kstrtab_sk_chk_filter_I, &_GLOBAL_35___kstrtab_sk_chk_filter_I, &_GLOBAL_36___kstrtab_sk_chk_filter_I, &_GLOBAL_37___kstrtab_sk_chk_filter_I, &_GLOBAL_38___kstrtab_sk_chk_filter_I, &_GLOBAL_39___kstrtab_sk_chk_filter_I, &_GLOBAL_40___kstrtab_sk_chk_filter_I, &_GLOBAL_41___kstrtab_sk_chk_filter_I, &_GLOBAL_42___kstrtab_sk_chk_filter_I, &_GLOBAL_43___kstrtab_sk_chk_filter_I, &_GLOBAL_44___kstrtab_sk_chk_filter_I, &_GLOBAL_45___kstrtab_sk_chk_filter_I, &_GLOBAL_46___kstrtab_sk_chk_filter_I, &_GLOBAL_47___kstrtab_sk_chk_filter_I, &_GLOBAL_48___kstrtab_sk_chk_filter_I, &_GLOBAL_49___kstrtab_sk_chk_filter_I, };        typedef  const struct kernel_symbol    _GLOBAL_239_T; static  _GLOBAL_239_T  global___ksymtab_sk_chk_filter[NUM_STACKS] __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused))   = {  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_0___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_1___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_2___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_3___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_4___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_5___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_6___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_7___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_8___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_9___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_10___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_11___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_12___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_13___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_14___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_15___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_16___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_17___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_18___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_19___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_20___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_21___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_22___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_23___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_24___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_25___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_26___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_27___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_28___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_29___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_30___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_31___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_32___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_33___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_34___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_35___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_36___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_37___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_38___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_39___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_40___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_41___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_42___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_43___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_44___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_45___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_46___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_47___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_48___kstrtab_sk_chk_filter_I  } ,  { ( unsigned long  ) & sk_chk_filter   , _GLOBAL_49___kstrtab_sk_chk_filter_I  } ,  };             
 typedef  const char   _GLOBAL_240_T; static  _GLOBAL_240_T  _GLOBAL_0___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_1___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_2___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_3___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_4___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_5___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_6___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_7___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_8___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_9___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_10___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_11___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_12___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_13___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_14___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_15___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_16___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_17___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_18___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_19___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_20___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_21___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_22___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_23___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_24___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_25___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_26___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_27___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_28___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_29___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_30___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_31___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_32___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_33___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_34___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_35___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_36___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_37___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_38___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_39___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_40___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_41___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_42___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_43___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_44___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_45___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_46___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_47___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_48___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static  _GLOBAL_240_T  _GLOBAL_49___kstrtab_sk_run_filter_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "sk_run_filter"  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0___kstrtab_sk_run_filter_I) *_GLOBAL___kstrtab_sk_run_filter_32_A[NUM_STACKS] = { &_GLOBAL_0___kstrtab_sk_run_filter_I, &_GLOBAL_1___kstrtab_sk_run_filter_I, &_GLOBAL_2___kstrtab_sk_run_filter_I, &_GLOBAL_3___kstrtab_sk_run_filter_I, &_GLOBAL_4___kstrtab_sk_run_filter_I, &_GLOBAL_5___kstrtab_sk_run_filter_I, &_GLOBAL_6___kstrtab_sk_run_filter_I, &_GLOBAL_7___kstrtab_sk_run_filter_I, &_GLOBAL_8___kstrtab_sk_run_filter_I, &_GLOBAL_9___kstrtab_sk_run_filter_I, &_GLOBAL_10___kstrtab_sk_run_filter_I, &_GLOBAL_11___kstrtab_sk_run_filter_I, &_GLOBAL_12___kstrtab_sk_run_filter_I, &_GLOBAL_13___kstrtab_sk_run_filter_I, &_GLOBAL_14___kstrtab_sk_run_filter_I, &_GLOBAL_15___kstrtab_sk_run_filter_I, &_GLOBAL_16___kstrtab_sk_run_filter_I, &_GLOBAL_17___kstrtab_sk_run_filter_I, &_GLOBAL_18___kstrtab_sk_run_filter_I, &_GLOBAL_19___kstrtab_sk_run_filter_I, &_GLOBAL_20___kstrtab_sk_run_filter_I, &_GLOBAL_21___kstrtab_sk_run_filter_I, &_GLOBAL_22___kstrtab_sk_run_filter_I, &_GLOBAL_23___kstrtab_sk_run_filter_I, &_GLOBAL_24___kstrtab_sk_run_filter_I, &_GLOBAL_25___kstrtab_sk_run_filter_I, &_GLOBAL_26___kstrtab_sk_run_filter_I, &_GLOBAL_27___kstrtab_sk_run_filter_I, &_GLOBAL_28___kstrtab_sk_run_filter_I, &_GLOBAL_29___kstrtab_sk_run_filter_I, &_GLOBAL_30___kstrtab_sk_run_filter_I, &_GLOBAL_31___kstrtab_sk_run_filter_I, &_GLOBAL_32___kstrtab_sk_run_filter_I, &_GLOBAL_33___kstrtab_sk_run_filter_I, &_GLOBAL_34___kstrtab_sk_run_filter_I, &_GLOBAL_35___kstrtab_sk_run_filter_I, &_GLOBAL_36___kstrtab_sk_run_filter_I, &_GLOBAL_37___kstrtab_sk_run_filter_I, &_GLOBAL_38___kstrtab_sk_run_filter_I, &_GLOBAL_39___kstrtab_sk_run_filter_I, &_GLOBAL_40___kstrtab_sk_run_filter_I, &_GLOBAL_41___kstrtab_sk_run_filter_I, &_GLOBAL_42___kstrtab_sk_run_filter_I, &_GLOBAL_43___kstrtab_sk_run_filter_I, &_GLOBAL_44___kstrtab_sk_run_filter_I, &_GLOBAL_45___kstrtab_sk_run_filter_I, &_GLOBAL_46___kstrtab_sk_run_filter_I, &_GLOBAL_47___kstrtab_sk_run_filter_I, &_GLOBAL_48___kstrtab_sk_run_filter_I, &_GLOBAL_49___kstrtab_sk_run_filter_I, };        typedef  const struct kernel_symbol    _GLOBAL_241_T; static  _GLOBAL_241_T  global___ksymtab_sk_run_filter[NUM_STACKS] __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused))   = {  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_0___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_1___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_2___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_3___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_4___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_5___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_6___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_7___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_8___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_9___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_10___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_11___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_12___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_13___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_14___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_15___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_16___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_17___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_18___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_19___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_20___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_21___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_22___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_23___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_24___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_25___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_26___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_27___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_28___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_29___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_30___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_31___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_32___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_33___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_34___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_35___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_36___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_37___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_38___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_39___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_40___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_41___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_42___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_43___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_44___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_45___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_46___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_47___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_48___kstrtab_sk_run_filter_I  } ,  { ( unsigned long  ) & sk_run_filter   , _GLOBAL_49___kstrtab_sk_run_filter_I  } ,  };             
