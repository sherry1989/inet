# 1 "linux-2.6/net/core/link_watch.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/core/link_watch.c"
# 14 "linux-2.6/net/core/link_watch.c"
...
# 15 "linux-2.6/net/core/link_watch.c" 2
...
# 16 "linux-2.6/net/core/link_watch.c" 2
...
# 17 "linux-2.6/net/core/link_watch.c" 2
...
# 19 "linux-2.6/net/core/link_watch.c" 2
# 29 "linux-2.6/net/core/link_watch.c"
enum lw_bits {
 LW_RUNNING = 0,
 LW_SE_USED
};

typedef  unsigned long   _GLOBAL_214_T; static  _GLOBAL_214_T  global_linkwatch_flags[NUM_STACKS];    
typedef  unsigned long   _GLOBAL_215_T; static  _GLOBAL_215_T  global_linkwatch_nextevent[NUM_STACKS];    

static void linkwatch_event(void *dummy);
typedef  struct work_struct   _GLOBAL_216_T; static  _GLOBAL_216_T  global_linkwatch_work[NUM_STACKS] = {  { . entry  = { & ( global_linkwatch_work[0] )  . entry   , & ( global_linkwatch_work[0] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[1] )  . entry   , & ( global_linkwatch_work[1] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[2] )  . entry   , & ( global_linkwatch_work[2] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[3] )  . entry   , & ( global_linkwatch_work[3] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[4] )  . entry   , & ( global_linkwatch_work[4] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[5] )  . entry   , & ( global_linkwatch_work[5] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[6] )  . entry   , & ( global_linkwatch_work[6] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[7] )  . entry   , & ( global_linkwatch_work[7] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[8] )  . entry   , & ( global_linkwatch_work[8] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[9] )  . entry   , & ( global_linkwatch_work[9] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[10] )  . entry   , & ( global_linkwatch_work[10] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[11] )  . entry   , & ( global_linkwatch_work[11] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[12] )  . entry   , & ( global_linkwatch_work[12] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[13] )  . entry   , & ( global_linkwatch_work[13] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[14] )  . entry   , & ( global_linkwatch_work[14] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[15] )  . entry   , & ( global_linkwatch_work[15] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[16] )  . entry   , & ( global_linkwatch_work[16] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[17] )  . entry   , & ( global_linkwatch_work[17] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[18] )  . entry   , & ( global_linkwatch_work[18] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[19] )  . entry   , & ( global_linkwatch_work[19] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[20] )  . entry   , & ( global_linkwatch_work[20] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[21] )  . entry   , & ( global_linkwatch_work[21] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[22] )  . entry   , & ( global_linkwatch_work[22] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[23] )  . entry   , & ( global_linkwatch_work[23] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[24] )  . entry   , & ( global_linkwatch_work[24] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[25] )  . entry   , & ( global_linkwatch_work[25] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[26] )  . entry   , & ( global_linkwatch_work[26] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[27] )  . entry   , & ( global_linkwatch_work[27] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[28] )  . entry   , & ( global_linkwatch_work[28] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[29] )  . entry   , & ( global_linkwatch_work[29] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[30] )  . entry   , & ( global_linkwatch_work[30] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[31] )  . entry   , & ( global_linkwatch_work[31] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[32] )  . entry   , & ( global_linkwatch_work[32] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[33] )  . entry   , & ( global_linkwatch_work[33] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[34] )  . entry   , & ( global_linkwatch_work[34] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[35] )  . entry   , & ( global_linkwatch_work[35] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[36] )  . entry   , & ( global_linkwatch_work[36] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[37] )  . entry   , & ( global_linkwatch_work[37] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[38] )  . entry   , & ( global_linkwatch_work[38] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[39] )  . entry   , & ( global_linkwatch_work[39] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[40] )  . entry   , & ( global_linkwatch_work[40] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[41] )  . entry   , & ( global_linkwatch_work[41] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[42] )  . entry   , & ( global_linkwatch_work[42] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[43] )  . entry   , & ( global_linkwatch_work[43] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[44] )  . entry   , & ( global_linkwatch_work[44] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[45] )  . entry   , & ( global_linkwatch_work[45] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[46] )  . entry   , & ( global_linkwatch_work[46] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[47] )  . entry   , & ( global_linkwatch_work[47] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[48] )  . entry   , & ( global_linkwatch_work[48] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  { . entry  = { & ( global_linkwatch_work[49] )  . entry   , & ( global_linkwatch_work[49] )  . entry    }   , . func  = ( linkwatch_event )    , . data  = ( ( ( void *  ) 0  )  )    , . timer  = { . function  = ( ( ( void *  ) 0  )  )   , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = ( ( void *  ) 0  )    , . magic  = 0x4b87ad6e   , . lock  = ( spinlock_t ) { }    , }    , } ,  };                                              

typedef  struct list_head   _GLOBAL_217_T; static  _GLOBAL_217_T  global_lweventlist[NUM_STACKS] = {  { & ( global_lweventlist[0] )   , & ( global_lweventlist[0] )    } ,  { & ( global_lweventlist[1] )   , & ( global_lweventlist[1] )    } ,  { & ( global_lweventlist[2] )   , & ( global_lweventlist[2] )    } ,  { & ( global_lweventlist[3] )   , & ( global_lweventlist[3] )    } ,  { & ( global_lweventlist[4] )   , & ( global_lweventlist[4] )    } ,  { & ( global_lweventlist[5] )   , & ( global_lweventlist[5] )    } ,  { & ( global_lweventlist[6] )   , & ( global_lweventlist[6] )    } ,  { & ( global_lweventlist[7] )   , & ( global_lweventlist[7] )    } ,  { & ( global_lweventlist[8] )   , & ( global_lweventlist[8] )    } ,  { & ( global_lweventlist[9] )   , & ( global_lweventlist[9] )    } ,  { & ( global_lweventlist[10] )   , & ( global_lweventlist[10] )    } ,  { & ( global_lweventlist[11] )   , & ( global_lweventlist[11] )    } ,  { & ( global_lweventlist[12] )   , & ( global_lweventlist[12] )    } ,  { & ( global_lweventlist[13] )   , & ( global_lweventlist[13] )    } ,  { & ( global_lweventlist[14] )   , & ( global_lweventlist[14] )    } ,  { & ( global_lweventlist[15] )   , & ( global_lweventlist[15] )    } ,  { & ( global_lweventlist[16] )   , & ( global_lweventlist[16] )    } ,  { & ( global_lweventlist[17] )   , & ( global_lweventlist[17] )    } ,  { & ( global_lweventlist[18] )   , & ( global_lweventlist[18] )    } ,  { & ( global_lweventlist[19] )   , & ( global_lweventlist[19] )    } ,  { & ( global_lweventlist[20] )   , & ( global_lweventlist[20] )    } ,  { & ( global_lweventlist[21] )   , & ( global_lweventlist[21] )    } ,  { & ( global_lweventlist[22] )   , & ( global_lweventlist[22] )    } ,  { & ( global_lweventlist[23] )   , & ( global_lweventlist[23] )    } ,  { & ( global_lweventlist[24] )   , & ( global_lweventlist[24] )    } ,  { & ( global_lweventlist[25] )   , & ( global_lweventlist[25] )    } ,  { & ( global_lweventlist[26] )   , & ( global_lweventlist[26] )    } ,  { & ( global_lweventlist[27] )   , & ( global_lweventlist[27] )    } ,  { & ( global_lweventlist[28] )   , & ( global_lweventlist[28] )    } ,  { & ( global_lweventlist[29] )   , & ( global_lweventlist[29] )    } ,  { & ( global_lweventlist[30] )   , & ( global_lweventlist[30] )    } ,  { & ( global_lweventlist[31] )   , & ( global_lweventlist[31] )    } ,  { & ( global_lweventlist[32] )   , & ( global_lweventlist[32] )    } ,  { & ( global_lweventlist[33] )   , & ( global_lweventlist[33] )    } ,  { & ( global_lweventlist[34] )   , & ( global_lweventlist[34] )    } ,  { & ( global_lweventlist[35] )   , & ( global_lweventlist[35] )    } ,  { & ( global_lweventlist[36] )   , & ( global_lweventlist[36] )    } ,  { & ( global_lweventlist[37] )   , & ( global_lweventlist[37] )    } ,  { & ( global_lweventlist[38] )   , & ( global_lweventlist[38] )    } ,  { & ( global_lweventlist[39] )   , & ( global_lweventlist[39] )    } ,  { & ( global_lweventlist[40] )   , & ( global_lweventlist[40] )    } ,  { & ( global_lweventlist[41] )   , & ( global_lweventlist[41] )    } ,  { & ( global_lweventlist[42] )   , & ( global_lweventlist[42] )    } ,  { & ( global_lweventlist[43] )   , & ( global_lweventlist[43] )    } ,  { & ( global_lweventlist[44] )   , & ( global_lweventlist[44] )    } ,  { & ( global_lweventlist[45] )   , & ( global_lweventlist[45] )    } ,  { & ( global_lweventlist[46] )   , & ( global_lweventlist[46] )    } ,  { & ( global_lweventlist[47] )   , & ( global_lweventlist[47] )    } ,  { & ( global_lweventlist[48] )   , & ( global_lweventlist[48] )    } ,  { & ( global_lweventlist[49] )   , & ( global_lweventlist[49] )    } ,  };         
typedef  spinlock_t  _GLOBAL_218_T; static  _GLOBAL_218_T  global_lweventlist_lock[NUM_STACKS] = {  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  ( spinlock_t ) { } ,  };       
...
typedef  struct lw_event   _GLOBAL_219_T; static  _GLOBAL_219_T  global_singleevent[NUM_STACKS];    
...
void linkwatch_run_queue(void)
{
 ...
 do { ; do { } while (0); do { (void)(&global_lweventlist_lock[get_stack_id()]); } while(0); (void)0; } while (0);
 list_splice_init(&global_lweventlist[get_stack_id()], &head);
 do { do { (void)(&global_lweventlist_lock[get_stack_id()]); } while(0); ; do { } while (0); (void)0; } while (0);
...
void linkwatch_fire_event(struct net_device *dev)
{
 if (!test_and_set_bit(__LINK_STATE_LINKWATCH_PENDING, &dev->state)) {
  ...
  if (test_and_set_bit(LW_SE_USED, &global_linkwatch_flags[get_stack_id()])) {
   event = kmalloc(sizeof(struct lw_event), (0x20));
  ...
  do { (void)flags; do { } while (0); do { (void)(&global_lweventlist_lock[get_stack_id()]); } while(0); (void)0; } while (0);
  list_add_tail(&event->list, &global_lweventlist[get_stack_id()]);
  do { do { (void)(&global_lweventlist_lock[get_stack_id()]); } while(0); (void)flags; do { } while (0); (void)0; } while (0);

  if (!test_and_set_bit(LW_RUNNING, &global_linkwatch_flags[get_stack_id()])) {
   unsigned long thisevent = global_jiffies[get_stack_id()];

   if (thisevent >= global_linkwatch_nextevent[get_stack_id()]) {
    schedule_work(&global_linkwatch_work[get_stack_id()]);
   } else {
    schedule_delayed_work(&global_linkwatch_work[get_stack_id()], global_linkwatch_nextevent[get_stack_id()] - thisevent);
   }
  }
 }
}

 typedef  const char   _GLOBAL_220_T; static  _GLOBAL_220_T  _GLOBAL_0___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_1___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_2___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_3___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_4___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_5___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_6___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_7___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_8___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_9___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_10___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_11___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_12___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_13___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_14___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_15___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_16___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_17___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_18___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_19___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_20___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_21___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_22___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_23___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_24___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_25___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_26___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_27___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_28___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_29___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_30___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_31___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_32___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_33___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_34___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_35___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_36___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_37___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_38___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_39___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_40___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_41___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_42___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_43___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_44___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_45___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_46___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_47___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_48___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static  _GLOBAL_220_T  _GLOBAL_49___kstrtab_linkwatch_fire_event_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "linkwatch_fire_event"  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0___kstrtab_linkwatch_fire_event_I) *_GLOBAL___kstrtab_linkwatch_fire_event_25_A[NUM_STACKS] = { &_GLOBAL_0___kstrtab_linkwatch_fire_event_I, &_GLOBAL_1___kstrtab_linkwatch_fire_event_I, &_GLOBAL_2___kstrtab_linkwatch_fire_event_I, &_GLOBAL_3___kstrtab_linkwatch_fire_event_I, &_GLOBAL_4___kstrtab_linkwatch_fire_event_I, &_GLOBAL_5___kstrtab_linkwatch_fire_event_I, &_GLOBAL_6___kstrtab_linkwatch_fire_event_I, &_GLOBAL_7___kstrtab_linkwatch_fire_event_I, &_GLOBAL_8___kstrtab_linkwatch_fire_event_I, &_GLOBAL_9___kstrtab_linkwatch_fire_event_I, &_GLOBAL_10___kstrtab_linkwatch_fire_event_I, &_GLOBAL_11___kstrtab_linkwatch_fire_event_I, &_GLOBAL_12___kstrtab_linkwatch_fire_event_I, &_GLOBAL_13___kstrtab_linkwatch_fire_event_I, &_GLOBAL_14___kstrtab_linkwatch_fire_event_I, &_GLOBAL_15___kstrtab_linkwatch_fire_event_I, &_GLOBAL_16___kstrtab_linkwatch_fire_event_I, &_GLOBAL_17___kstrtab_linkwatch_fire_event_I, &_GLOBAL_18___kstrtab_linkwatch_fire_event_I, &_GLOBAL_19___kstrtab_linkwatch_fire_event_I, &_GLOBAL_20___kstrtab_linkwatch_fire_event_I, &_GLOBAL_21___kstrtab_linkwatch_fire_event_I, &_GLOBAL_22___kstrtab_linkwatch_fire_event_I, &_GLOBAL_23___kstrtab_linkwatch_fire_event_I, &_GLOBAL_24___kstrtab_linkwatch_fire_event_I, &_GLOBAL_25___kstrtab_linkwatch_fire_event_I, &_GLOBAL_26___kstrtab_linkwatch_fire_event_I, &_GLOBAL_27___kstrtab_linkwatch_fire_event_I, &_GLOBAL_28___kstrtab_linkwatch_fire_event_I, &_GLOBAL_29___kstrtab_linkwatch_fire_event_I, &_GLOBAL_30___kstrtab_linkwatch_fire_event_I, &_GLOBAL_31___kstrtab_linkwatch_fire_event_I, &_GLOBAL_32___kstrtab_linkwatch_fire_event_I, &_GLOBAL_33___kstrtab_linkwatch_fire_event_I, &_GLOBAL_34___kstrtab_linkwatch_fire_event_I, &_GLOBAL_35___kstrtab_linkwatch_fire_event_I, &_GLOBAL_36___kstrtab_linkwatch_fire_event_I, &_GLOBAL_37___kstrtab_linkwatch_fire_event_I, &_GLOBAL_38___kstrtab_linkwatch_fire_event_I, &_GLOBAL_39___kstrtab_linkwatch_fire_event_I, &_GLOBAL_40___kstrtab_linkwatch_fire_event_I, &_GLOBAL_41___kstrtab_linkwatch_fire_event_I, &_GLOBAL_42___kstrtab_linkwatch_fire_event_I, &_GLOBAL_43___kstrtab_linkwatch_fire_event_I, &_GLOBAL_44___kstrtab_linkwatch_fire_event_I, &_GLOBAL_45___kstrtab_linkwatch_fire_event_I, &_GLOBAL_46___kstrtab_linkwatch_fire_event_I, &_GLOBAL_47___kstrtab_linkwatch_fire_event_I, &_GLOBAL_48___kstrtab_linkwatch_fire_event_I, &_GLOBAL_49___kstrtab_linkwatch_fire_event_I, };        typedef  const struct kernel_symbol    _GLOBAL_221_T; static  _GLOBAL_221_T  global___ksymtab_linkwatch_fire_event[NUM_STACKS] __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused))   = {  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_0___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_1___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_2___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_3___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_4___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_5___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_6___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_7___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_8___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_9___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_10___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_11___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_12___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_13___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_14___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_15___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_16___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_17___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_18___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_19___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_20___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_21___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_22___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_23___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_24___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_25___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_26___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_27___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_28___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_29___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_30___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_31___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_32___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_33___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_34___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_35___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_36___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_37___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_38___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_39___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_40___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_41___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_42___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_43___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_44___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_45___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_46___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_47___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_48___kstrtab_linkwatch_fire_event_I  } ,  { ( unsigned long  ) & linkwatch_fire_event   , _GLOBAL_49___kstrtab_linkwatch_fire_event_I  } ,  };             
