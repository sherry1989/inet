# 1 "linux-2.6/net/core/scm.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/core/scm.c"
# 12 "linux-2.6/net/core/scm.c"
...
# 17 "linux-2.6/net/core/scm.c" 2

# 1 "linux-2.6/include/linux/major.h" 1
# 19 "linux-2.6/net/core/scm.c" 2
...
# 32 "linux-2.6/net/core/scm.c" 2


# 1 "linux-2.6/include/net/compat.h" 1
# 30 "linux-2.6/include/net/compat.h"
...
{
 if ((creds->pid == get_current()->tgid || capable(21)) &&
     ((creds->uid == get_current()->uid || creds->uid == get_current()->euid ||
       creds->uid == get_current()->suid) || capable(7)) &&
     ((creds->gid == get_current()->gid || creds->gid == get_current()->egid ||
       creds->gid == get_current()->sgid) || capable(6))) {
        return 0;
 }
 return -1;
}
...
static int scm_fp_copy(struct cmsghdr *cmsg, struct scm_fp_list **fplp)
{
 ...
 if (!fpl)
 {
  fpl = kmalloc(sizeof(struct scm_fp_list), (0x10 | 0x40 | 0x80));
  if (!fpl)
   return -12;
  *fplp = fpl;
  fpl->count = 0;
...
void scm_detach_fds(struct msghdr *msg, struct scm_cookie *scm)
{
 ...
 for (i=0, cmfptr=(int *)((void *)((char *)(cm) + ( ((sizeof(struct cmsghdr))+sizeof(long)-1) & ~(sizeof(long)-1) ))); i<fdmax; i++, cmfptr++)
 {
  ...
  if (err < 0)
   break;
  new_fd = err;
  err = ({ long __pu_err = -14; __typeof__(*((cmfptr))) *__pu_addr = ((cmfptr)); do {} while(0); if ((__builtin_expect(!!(({ unsigned long flag,sum; (void)0; asm("addl %3,%1 ; sbbl %0,%0; cmpl %1,%4; sbbl $0,%0" :"=&r" (flag), "=r" (sum) :"1" (__pu_addr),"g" ((int)(sizeof(*(cmfptr)))),"g" (current_thread_info()->addr_limit.seg)); flag; }) == 0), 1))) do { __typeof__(*(__pu_addr)) __pus_tmp = ((__typeof__(*(cmfptr)))(new_fd)); __pu_err = 0; if(__builtin_expect(!!(__copy_to_user_ll(__pu_addr, &__pus_tmp, (sizeof(*(cmfptr)))) != 0), 0)) __pu_err = -14; } while (0); __pu_err; });
  if (err) {
 ...
 if (i > 0)
 {
  ...
  if (!err)
   err = ({ long __pu_err = -14; __typeof__(*((&cm->cmsg_level))) *__pu_addr = ((&cm->cmsg_level)); do {} while(0); if ((__builtin_expect(!!(({ unsigned long flag,sum; (void)0; asm("addl %3,%1 ; sbbl %0,%0; cmpl %1,%4; sbbl $0,%0" :"=&r" (flag), "=r" (sum) :"1" (__pu_addr),"g" ((int)(sizeof(*(&cm->cmsg_level)))),"g" (current_thread_info()->addr_limit.seg)); flag; }) == 0), 1))) do { __typeof__(*(__pu_addr)) __pus_tmp = ((__typeof__(*(&cm->cmsg_level)))(1)); __pu_err = 0; if(__builtin_expect(!!(__copy_to_user_ll(__pu_addr, &__pus_tmp, (sizeof(*(&cm->cmsg_level)))) != 0), 0)) __pu_err = -14; } while (0); __pu_err; });
  if (!err)
   err = ({ long __pu_err = -14; __typeof__(*((&cm->cmsg_type))) *__pu_addr = ((&cm->cmsg_type)); do {} while(0); if ((__builtin_expect(!!(({ unsigned long flag,sum; (void)0; asm("addl %3,%1 ; sbbl %0,%0; cmpl %1,%4; sbbl $0,%0" :"=&r" (flag), "=r" (sum) :"1" (__pu_addr),"g" ((int)(sizeof(*(&cm->cmsg_type)))),"g" (current_thread_info()->addr_limit.seg)); flag; }) == 0), 1))) do { __typeof__(*(__pu_addr)) __pus_tmp = ((__typeof__(*(&cm->cmsg_type)))(0x01)); __pu_err = 0; if(__builtin_expect(!!(__copy_to_user_ll(__pu_addr, &__pus_tmp, (sizeof(*(&cm->cmsg_type)))) != 0), 0)) __pu_err = -14; } while (0); __pu_err; });
  if (!err)
   err = ({ long __pu_err = -14; __typeof__(*((&cm->cmsg_len))) *__pu_addr = ((&cm->cmsg_len)); do {} while(0); if ((__builtin_expect(!!(({ unsigned long flag,sum; (void)0; asm("addl %3,%1 ; sbbl %0,%0; cmpl %1,%4; sbbl $0,%0" :"=&r" (flag), "=r" (sum) :"1" (__pu_addr),"g" ((int)(sizeof(*(&cm->cmsg_len)))),"g" (current_thread_info()->addr_limit.seg)); flag; }) == 0), 1))) do { __typeof__(*(__pu_addr)) __pus_tmp = ((__typeof__(*(&cm->cmsg_len)))(cmlen)); __pu_err = 0; if(__builtin_expect(!!(__copy_to_user_ll(__pu_addr, &__pus_tmp, (sizeof(*(&cm->cmsg_len)))) != 0), 0)) __pu_err = -14; } while (0); __pu_err; });
  if (!err) {
...
struct scm_fp_list *scm_fp_dup(struct scm_fp_list *fpl)
{
 ...
 new_fpl = kmalloc(sizeof(*fpl), (0x10 | 0x40 | 0x80));
 if (new_fpl) {
  for (i=fpl->count-1; i>=0; i--)
 ...
 typedef  const char   _GLOBAL_219_T; static  _GLOBAL_219_T  _GLOBAL_0___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_1___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_2___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_3___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_4___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_5___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_6___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_7___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_8___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_9___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_10___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_11___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_12___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_13___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_14___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_15___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_16___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_17___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_18___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_19___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_20___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_21___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_22___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_23___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_24___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_25___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_26___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_27___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_28___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_29___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_30___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_31___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_32___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_33___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_34___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_35___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_36___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_37___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_38___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_39___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_40___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_41___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_42___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_43___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_44___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_45___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_46___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_47___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_48___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static  _GLOBAL_219_T  _GLOBAL_49___kstrtab___scm_destroy_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_destroy"  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0___kstrtab___scm_destroy_I) *_GLOBAL___kstrtab___scm_destroy_27_A[NUM_STACKS] = { &_GLOBAL_0___kstrtab___scm_destroy_I, &_GLOBAL_1___kstrtab___scm_destroy_I, &_GLOBAL_2___kstrtab___scm_destroy_I, &_GLOBAL_3___kstrtab___scm_destroy_I, &_GLOBAL_4___kstrtab___scm_destroy_I, &_GLOBAL_5___kstrtab___scm_destroy_I, &_GLOBAL_6___kstrtab___scm_destroy_I, &_GLOBAL_7___kstrtab___scm_destroy_I, &_GLOBAL_8___kstrtab___scm_destroy_I, &_GLOBAL_9___kstrtab___scm_destroy_I, &_GLOBAL_10___kstrtab___scm_destroy_I, &_GLOBAL_11___kstrtab___scm_destroy_I, &_GLOBAL_12___kstrtab___scm_destroy_I, &_GLOBAL_13___kstrtab___scm_destroy_I, &_GLOBAL_14___kstrtab___scm_destroy_I, &_GLOBAL_15___kstrtab___scm_destroy_I, &_GLOBAL_16___kstrtab___scm_destroy_I, &_GLOBAL_17___kstrtab___scm_destroy_I, &_GLOBAL_18___kstrtab___scm_destroy_I, &_GLOBAL_19___kstrtab___scm_destroy_I, &_GLOBAL_20___kstrtab___scm_destroy_I, &_GLOBAL_21___kstrtab___scm_destroy_I, &_GLOBAL_22___kstrtab___scm_destroy_I, &_GLOBAL_23___kstrtab___scm_destroy_I, &_GLOBAL_24___kstrtab___scm_destroy_I, &_GLOBAL_25___kstrtab___scm_destroy_I, &_GLOBAL_26___kstrtab___scm_destroy_I, &_GLOBAL_27___kstrtab___scm_destroy_I, &_GLOBAL_28___kstrtab___scm_destroy_I, &_GLOBAL_29___kstrtab___scm_destroy_I, &_GLOBAL_30___kstrtab___scm_destroy_I, &_GLOBAL_31___kstrtab___scm_destroy_I, &_GLOBAL_32___kstrtab___scm_destroy_I, &_GLOBAL_33___kstrtab___scm_destroy_I, &_GLOBAL_34___kstrtab___scm_destroy_I, &_GLOBAL_35___kstrtab___scm_destroy_I, &_GLOBAL_36___kstrtab___scm_destroy_I, &_GLOBAL_37___kstrtab___scm_destroy_I, &_GLOBAL_38___kstrtab___scm_destroy_I, &_GLOBAL_39___kstrtab___scm_destroy_I, &_GLOBAL_40___kstrtab___scm_destroy_I, &_GLOBAL_41___kstrtab___scm_destroy_I, &_GLOBAL_42___kstrtab___scm_destroy_I, &_GLOBAL_43___kstrtab___scm_destroy_I, &_GLOBAL_44___kstrtab___scm_destroy_I, &_GLOBAL_45___kstrtab___scm_destroy_I, &_GLOBAL_46___kstrtab___scm_destroy_I, &_GLOBAL_47___kstrtab___scm_destroy_I, &_GLOBAL_48___kstrtab___scm_destroy_I, &_GLOBAL_49___kstrtab___scm_destroy_I, };        typedef  const struct kernel_symbol    _GLOBAL_220_T; static  _GLOBAL_220_T  global___ksymtab___scm_destroy[NUM_STACKS] __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused))   = {  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_0___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_1___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_2___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_3___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_4___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_5___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_6___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_7___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_8___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_9___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_10___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_11___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_12___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_13___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_14___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_15___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_16___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_17___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_18___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_19___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_20___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_21___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_22___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_23___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_24___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_25___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_26___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_27___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_28___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_29___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_30___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_31___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_32___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_33___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_34___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_35___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_36___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_37___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_38___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_39___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_40___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_41___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_42___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_43___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_44___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_45___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_46___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_47___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_48___kstrtab___scm_destroy_I  } ,  { ( unsigned long  ) & __scm_destroy   , _GLOBAL_49___kstrtab___scm_destroy_I  } ,  };             
 typedef  const char   _GLOBAL_221_T; static  _GLOBAL_221_T  _GLOBAL_0___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_1___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_2___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_3___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_4___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_5___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_6___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_7___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_8___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_9___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_10___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_11___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_12___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_13___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_14___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_15___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_16___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_17___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_18___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_19___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_20___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_21___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_22___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_23___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_24___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_25___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_26___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_27___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_28___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_29___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_30___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_31___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_32___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_33___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_34___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_35___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_36___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_37___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_38___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_39___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_40___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_41___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_42___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_43___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_44___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_45___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_46___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_47___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_48___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static  _GLOBAL_221_T  _GLOBAL_49___kstrtab___scm_send_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "__scm_send"  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0___kstrtab___scm_send_I) *_GLOBAL___kstrtab___scm_send_28_A[NUM_STACKS] = { &_GLOBAL_0___kstrtab___scm_send_I, &_GLOBAL_1___kstrtab___scm_send_I, &_GLOBAL_2___kstrtab___scm_send_I, &_GLOBAL_3___kstrtab___scm_send_I, &_GLOBAL_4___kstrtab___scm_send_I, &_GLOBAL_5___kstrtab___scm_send_I, &_GLOBAL_6___kstrtab___scm_send_I, &_GLOBAL_7___kstrtab___scm_send_I, &_GLOBAL_8___kstrtab___scm_send_I, &_GLOBAL_9___kstrtab___scm_send_I, &_GLOBAL_10___kstrtab___scm_send_I, &_GLOBAL_11___kstrtab___scm_send_I, &_GLOBAL_12___kstrtab___scm_send_I, &_GLOBAL_13___kstrtab___scm_send_I, &_GLOBAL_14___kstrtab___scm_send_I, &_GLOBAL_15___kstrtab___scm_send_I, &_GLOBAL_16___kstrtab___scm_send_I, &_GLOBAL_17___kstrtab___scm_send_I, &_GLOBAL_18___kstrtab___scm_send_I, &_GLOBAL_19___kstrtab___scm_send_I, &_GLOBAL_20___kstrtab___scm_send_I, &_GLOBAL_21___kstrtab___scm_send_I, &_GLOBAL_22___kstrtab___scm_send_I, &_GLOBAL_23___kstrtab___scm_send_I, &_GLOBAL_24___kstrtab___scm_send_I, &_GLOBAL_25___kstrtab___scm_send_I, &_GLOBAL_26___kstrtab___scm_send_I, &_GLOBAL_27___kstrtab___scm_send_I, &_GLOBAL_28___kstrtab___scm_send_I, &_GLOBAL_29___kstrtab___scm_send_I, &_GLOBAL_30___kstrtab___scm_send_I, &_GLOBAL_31___kstrtab___scm_send_I, &_GLOBAL_32___kstrtab___scm_send_I, &_GLOBAL_33___kstrtab___scm_send_I, &_GLOBAL_34___kstrtab___scm_send_I, &_GLOBAL_35___kstrtab___scm_send_I, &_GLOBAL_36___kstrtab___scm_send_I, &_GLOBAL_37___kstrtab___scm_send_I, &_GLOBAL_38___kstrtab___scm_send_I, &_GLOBAL_39___kstrtab___scm_send_I, &_GLOBAL_40___kstrtab___scm_send_I, &_GLOBAL_41___kstrtab___scm_send_I, &_GLOBAL_42___kstrtab___scm_send_I, &_GLOBAL_43___kstrtab___scm_send_I, &_GLOBAL_44___kstrtab___scm_send_I, &_GLOBAL_45___kstrtab___scm_send_I, &_GLOBAL_46___kstrtab___scm_send_I, &_GLOBAL_47___kstrtab___scm_send_I, &_GLOBAL_48___kstrtab___scm_send_I, &_GLOBAL_49___kstrtab___scm_send_I, };        typedef  const struct kernel_symbol    _GLOBAL_222_T; static  _GLOBAL_222_T  global___ksymtab___scm_send[NUM_STACKS] __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused))   = {  { ( unsigned long  ) & __scm_send   , _GLOBAL_0___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_1___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_2___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_3___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_4___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_5___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_6___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_7___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_8___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_9___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_10___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_11___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_12___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_13___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_14___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_15___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_16___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_17___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_18___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_19___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_20___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_21___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_22___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_23___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_24___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_25___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_26___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_27___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_28___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_29___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_30___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_31___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_32___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_33___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_34___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_35___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_36___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_37___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_38___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_39___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_40___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_41___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_42___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_43___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_44___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_45___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_46___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_47___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_48___kstrtab___scm_send_I  } ,  { ( unsigned long  ) & __scm_send   , _GLOBAL_49___kstrtab___scm_send_I  } ,  };             
 typedef  const char   _GLOBAL_223_T; static  _GLOBAL_223_T  _GLOBAL_0___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_1___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_2___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_3___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_4___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_5___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_6___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_7___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_8___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_9___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_10___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_11___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_12___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_13___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_14___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_15___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_16___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_17___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_18___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_19___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_20___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_21___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_22___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_23___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_24___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_25___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_26___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_27___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_28___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_29___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_30___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_31___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_32___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_33___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_34___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_35___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_36___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_37___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_38___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_39___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_40___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_41___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_42___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_43___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_44___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_45___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_46___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_47___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_48___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static  _GLOBAL_223_T  _GLOBAL_49___kstrtab_put_cmsg_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "put_cmsg"  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0___kstrtab_put_cmsg_I) *_GLOBAL___kstrtab_put_cmsg_29_A[NUM_STACKS] = { &_GLOBAL_0___kstrtab_put_cmsg_I, &_GLOBAL_1___kstrtab_put_cmsg_I, &_GLOBAL_2___kstrtab_put_cmsg_I, &_GLOBAL_3___kstrtab_put_cmsg_I, &_GLOBAL_4___kstrtab_put_cmsg_I, &_GLOBAL_5___kstrtab_put_cmsg_I, &_GLOBAL_6___kstrtab_put_cmsg_I, &_GLOBAL_7___kstrtab_put_cmsg_I, &_GLOBAL_8___kstrtab_put_cmsg_I, &_GLOBAL_9___kstrtab_put_cmsg_I, &_GLOBAL_10___kstrtab_put_cmsg_I, &_GLOBAL_11___kstrtab_put_cmsg_I, &_GLOBAL_12___kstrtab_put_cmsg_I, &_GLOBAL_13___kstrtab_put_cmsg_I, &_GLOBAL_14___kstrtab_put_cmsg_I, &_GLOBAL_15___kstrtab_put_cmsg_I, &_GLOBAL_16___kstrtab_put_cmsg_I, &_GLOBAL_17___kstrtab_put_cmsg_I, &_GLOBAL_18___kstrtab_put_cmsg_I, &_GLOBAL_19___kstrtab_put_cmsg_I, &_GLOBAL_20___kstrtab_put_cmsg_I, &_GLOBAL_21___kstrtab_put_cmsg_I, &_GLOBAL_22___kstrtab_put_cmsg_I, &_GLOBAL_23___kstrtab_put_cmsg_I, &_GLOBAL_24___kstrtab_put_cmsg_I, &_GLOBAL_25___kstrtab_put_cmsg_I, &_GLOBAL_26___kstrtab_put_cmsg_I, &_GLOBAL_27___kstrtab_put_cmsg_I, &_GLOBAL_28___kstrtab_put_cmsg_I, &_GLOBAL_29___kstrtab_put_cmsg_I, &_GLOBAL_30___kstrtab_put_cmsg_I, &_GLOBAL_31___kstrtab_put_cmsg_I, &_GLOBAL_32___kstrtab_put_cmsg_I, &_GLOBAL_33___kstrtab_put_cmsg_I, &_GLOBAL_34___kstrtab_put_cmsg_I, &_GLOBAL_35___kstrtab_put_cmsg_I, &_GLOBAL_36___kstrtab_put_cmsg_I, &_GLOBAL_37___kstrtab_put_cmsg_I, &_GLOBAL_38___kstrtab_put_cmsg_I, &_GLOBAL_39___kstrtab_put_cmsg_I, &_GLOBAL_40___kstrtab_put_cmsg_I, &_GLOBAL_41___kstrtab_put_cmsg_I, &_GLOBAL_42___kstrtab_put_cmsg_I, &_GLOBAL_43___kstrtab_put_cmsg_I, &_GLOBAL_44___kstrtab_put_cmsg_I, &_GLOBAL_45___kstrtab_put_cmsg_I, &_GLOBAL_46___kstrtab_put_cmsg_I, &_GLOBAL_47___kstrtab_put_cmsg_I, &_GLOBAL_48___kstrtab_put_cmsg_I, &_GLOBAL_49___kstrtab_put_cmsg_I, };        typedef  const struct kernel_symbol    _GLOBAL_224_T; static  _GLOBAL_224_T  global___ksymtab_put_cmsg[NUM_STACKS] __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused))   = {  { ( unsigned long  ) & put_cmsg   , _GLOBAL_0___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_1___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_2___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_3___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_4___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_5___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_6___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_7___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_8___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_9___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_10___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_11___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_12___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_13___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_14___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_15___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_16___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_17___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_18___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_19___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_20___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_21___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_22___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_23___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_24___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_25___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_26___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_27___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_28___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_29___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_30___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_31___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_32___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_33___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_34___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_35___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_36___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_37___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_38___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_39___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_40___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_41___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_42___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_43___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_44___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_45___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_46___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_47___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_48___kstrtab_put_cmsg_I  } ,  { ( unsigned long  ) & put_cmsg   , _GLOBAL_49___kstrtab_put_cmsg_I  } ,  };             
 typedef  const char   _GLOBAL_225_T; static  _GLOBAL_225_T  _GLOBAL_0___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_1___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_2___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_3___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_4___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_5___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_6___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_7___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_8___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_9___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_10___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_11___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_12___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_13___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_14___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_15___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_16___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_17___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_18___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_19___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_20___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_21___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_22___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_23___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_24___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_25___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_26___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_27___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_28___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_29___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_30___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_31___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_32___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_33___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_34___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_35___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_36___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_37___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_38___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_39___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_40___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_41___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_42___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_43___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_44___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_45___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_46___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_47___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_48___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static  _GLOBAL_225_T  _GLOBAL_49___kstrtab_scm_detach_fds_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_detach_fds"  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0___kstrtab_scm_detach_fds_I) *_GLOBAL___kstrtab_scm_detach_fds_30_A[NUM_STACKS] = { &_GLOBAL_0___kstrtab_scm_detach_fds_I, &_GLOBAL_1___kstrtab_scm_detach_fds_I, &_GLOBAL_2___kstrtab_scm_detach_fds_I, &_GLOBAL_3___kstrtab_scm_detach_fds_I, &_GLOBAL_4___kstrtab_scm_detach_fds_I, &_GLOBAL_5___kstrtab_scm_detach_fds_I, &_GLOBAL_6___kstrtab_scm_detach_fds_I, &_GLOBAL_7___kstrtab_scm_detach_fds_I, &_GLOBAL_8___kstrtab_scm_detach_fds_I, &_GLOBAL_9___kstrtab_scm_detach_fds_I, &_GLOBAL_10___kstrtab_scm_detach_fds_I, &_GLOBAL_11___kstrtab_scm_detach_fds_I, &_GLOBAL_12___kstrtab_scm_detach_fds_I, &_GLOBAL_13___kstrtab_scm_detach_fds_I, &_GLOBAL_14___kstrtab_scm_detach_fds_I, &_GLOBAL_15___kstrtab_scm_detach_fds_I, &_GLOBAL_16___kstrtab_scm_detach_fds_I, &_GLOBAL_17___kstrtab_scm_detach_fds_I, &_GLOBAL_18___kstrtab_scm_detach_fds_I, &_GLOBAL_19___kstrtab_scm_detach_fds_I, &_GLOBAL_20___kstrtab_scm_detach_fds_I, &_GLOBAL_21___kstrtab_scm_detach_fds_I, &_GLOBAL_22___kstrtab_scm_detach_fds_I, &_GLOBAL_23___kstrtab_scm_detach_fds_I, &_GLOBAL_24___kstrtab_scm_detach_fds_I, &_GLOBAL_25___kstrtab_scm_detach_fds_I, &_GLOBAL_26___kstrtab_scm_detach_fds_I, &_GLOBAL_27___kstrtab_scm_detach_fds_I, &_GLOBAL_28___kstrtab_scm_detach_fds_I, &_GLOBAL_29___kstrtab_scm_detach_fds_I, &_GLOBAL_30___kstrtab_scm_detach_fds_I, &_GLOBAL_31___kstrtab_scm_detach_fds_I, &_GLOBAL_32___kstrtab_scm_detach_fds_I, &_GLOBAL_33___kstrtab_scm_detach_fds_I, &_GLOBAL_34___kstrtab_scm_detach_fds_I, &_GLOBAL_35___kstrtab_scm_detach_fds_I, &_GLOBAL_36___kstrtab_scm_detach_fds_I, &_GLOBAL_37___kstrtab_scm_detach_fds_I, &_GLOBAL_38___kstrtab_scm_detach_fds_I, &_GLOBAL_39___kstrtab_scm_detach_fds_I, &_GLOBAL_40___kstrtab_scm_detach_fds_I, &_GLOBAL_41___kstrtab_scm_detach_fds_I, &_GLOBAL_42___kstrtab_scm_detach_fds_I, &_GLOBAL_43___kstrtab_scm_detach_fds_I, &_GLOBAL_44___kstrtab_scm_detach_fds_I, &_GLOBAL_45___kstrtab_scm_detach_fds_I, &_GLOBAL_46___kstrtab_scm_detach_fds_I, &_GLOBAL_47___kstrtab_scm_detach_fds_I, &_GLOBAL_48___kstrtab_scm_detach_fds_I, &_GLOBAL_49___kstrtab_scm_detach_fds_I, };        typedef  const struct kernel_symbol    _GLOBAL_226_T; static  _GLOBAL_226_T  global___ksymtab_scm_detach_fds[NUM_STACKS] __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused))   = {  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_0___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_1___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_2___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_3___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_4___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_5___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_6___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_7___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_8___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_9___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_10___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_11___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_12___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_13___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_14___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_15___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_16___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_17___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_18___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_19___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_20___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_21___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_22___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_23___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_24___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_25___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_26___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_27___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_28___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_29___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_30___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_31___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_32___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_33___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_34___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_35___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_36___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_37___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_38___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_39___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_40___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_41___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_42___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_43___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_44___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_45___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_46___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_47___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_48___kstrtab_scm_detach_fds_I  } ,  { ( unsigned long  ) & scm_detach_fds   , _GLOBAL_49___kstrtab_scm_detach_fds_I  } ,  };             
 typedef  const char   _GLOBAL_227_T; static  _GLOBAL_227_T  _GLOBAL_0___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_1___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_2___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_3___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_4___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_5___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_6___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_7___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_8___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_9___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_10___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_11___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_12___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_13___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_14___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_15___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_16___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_17___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_18___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_19___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_20___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_21___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_22___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_23___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_24___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_25___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_26___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_27___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_28___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_29___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_30___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_31___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_32___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_33___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_34___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_35___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_36___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_37___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_38___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_39___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_40___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_41___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_42___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_43___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_44___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_45___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_46___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_47___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_48___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static  _GLOBAL_227_T  _GLOBAL_49___kstrtab_scm_fp_dup_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "scm_fp_dup"  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0___kstrtab_scm_fp_dup_I) *_GLOBAL___kstrtab_scm_fp_dup_31_A[NUM_STACKS] = { &_GLOBAL_0___kstrtab_scm_fp_dup_I, &_GLOBAL_1___kstrtab_scm_fp_dup_I, &_GLOBAL_2___kstrtab_scm_fp_dup_I, &_GLOBAL_3___kstrtab_scm_fp_dup_I, &_GLOBAL_4___kstrtab_scm_fp_dup_I, &_GLOBAL_5___kstrtab_scm_fp_dup_I, &_GLOBAL_6___kstrtab_scm_fp_dup_I, &_GLOBAL_7___kstrtab_scm_fp_dup_I, &_GLOBAL_8___kstrtab_scm_fp_dup_I, &_GLOBAL_9___kstrtab_scm_fp_dup_I, &_GLOBAL_10___kstrtab_scm_fp_dup_I, &_GLOBAL_11___kstrtab_scm_fp_dup_I, &_GLOBAL_12___kstrtab_scm_fp_dup_I, &_GLOBAL_13___kstrtab_scm_fp_dup_I, &_GLOBAL_14___kstrtab_scm_fp_dup_I, &_GLOBAL_15___kstrtab_scm_fp_dup_I, &_GLOBAL_16___kstrtab_scm_fp_dup_I, &_GLOBAL_17___kstrtab_scm_fp_dup_I, &_GLOBAL_18___kstrtab_scm_fp_dup_I, &_GLOBAL_19___kstrtab_scm_fp_dup_I, &_GLOBAL_20___kstrtab_scm_fp_dup_I, &_GLOBAL_21___kstrtab_scm_fp_dup_I, &_GLOBAL_22___kstrtab_scm_fp_dup_I, &_GLOBAL_23___kstrtab_scm_fp_dup_I, &_GLOBAL_24___kstrtab_scm_fp_dup_I, &_GLOBAL_25___kstrtab_scm_fp_dup_I, &_GLOBAL_26___kstrtab_scm_fp_dup_I, &_GLOBAL_27___kstrtab_scm_fp_dup_I, &_GLOBAL_28___kstrtab_scm_fp_dup_I, &_GLOBAL_29___kstrtab_scm_fp_dup_I, &_GLOBAL_30___kstrtab_scm_fp_dup_I, &_GLOBAL_31___kstrtab_scm_fp_dup_I, &_GLOBAL_32___kstrtab_scm_fp_dup_I, &_GLOBAL_33___kstrtab_scm_fp_dup_I, &_GLOBAL_34___kstrtab_scm_fp_dup_I, &_GLOBAL_35___kstrtab_scm_fp_dup_I, &_GLOBAL_36___kstrtab_scm_fp_dup_I, &_GLOBAL_37___kstrtab_scm_fp_dup_I, &_GLOBAL_38___kstrtab_scm_fp_dup_I, &_GLOBAL_39___kstrtab_scm_fp_dup_I, &_GLOBAL_40___kstrtab_scm_fp_dup_I, &_GLOBAL_41___kstrtab_scm_fp_dup_I, &_GLOBAL_42___kstrtab_scm_fp_dup_I, &_GLOBAL_43___kstrtab_scm_fp_dup_I, &_GLOBAL_44___kstrtab_scm_fp_dup_I, &_GLOBAL_45___kstrtab_scm_fp_dup_I, &_GLOBAL_46___kstrtab_scm_fp_dup_I, &_GLOBAL_47___kstrtab_scm_fp_dup_I, &_GLOBAL_48___kstrtab_scm_fp_dup_I, &_GLOBAL_49___kstrtab_scm_fp_dup_I, };        typedef  const struct kernel_symbol    _GLOBAL_228_T; static  _GLOBAL_228_T  global___ksymtab_scm_fp_dup[NUM_STACKS] __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused))   = {  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_0___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_1___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_2___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_3___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_4___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_5___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_6___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_7___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_8___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_9___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_10___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_11___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_12___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_13___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_14___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_15___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_16___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_17___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_18___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_19___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_20___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_21___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_22___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_23___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_24___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_25___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_26___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_27___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_28___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_29___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_30___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_31___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_32___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_33___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_34___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_35___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_36___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_37___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_38___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_39___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_40___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_41___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_42___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_43___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_44___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_45___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_46___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_47___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_48___kstrtab_scm_fp_dup_I  } ,  { ( unsigned long  ) & scm_fp_dup   , _GLOBAL_49___kstrtab_scm_fp_dup_I  } ,  };             
