# 1 "linux-2.6/net/ipv4/ip_options.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/ipv4/ip_options.c"
# 14 "linux-2.6/net/ipv4/ip_options.c"
...
# 15 "linux-2.6/net/ipv4/ip_options.c" 2
...
# 17 "linux-2.6/net/ipv4/ip_options.c" 2
...
# 18 "linux-2.6/net/ipv4/ip_options.c" 2
...
# 19 "linux-2.6/net/ipv4/ip_options.c" 2
...
# 20 "linux-2.6/net/ipv4/ip_options.c" 2
...
int ipv4_doint_and_flush_strategy(ctl_table *table, int *name, int nlen,
      ...
      void *newval, size_t newlen,
      void **context);
# 24 "linux-2.6/net/ipv4/ip_options.c" 2
...
# 25 "linux-2.6/net/ipv4/ip_options.c" 2
# 37 "linux-2.6/net/ipv4/ip_options.c"
       ...
       u32 daddr, struct rtable *rt, int is_frag)
{
 ...
 if (!is_frag) {
  ...
  if (opt->ts_needtime) {
   ...
   __u32 midtime;
   do_gettimeofday(&tv);
   midtime = (( __be32)(__builtin_constant_p((__u32)(((tv.tv_sec % 86400) * 1000 + tv.tv_usec / 1000))) ? ({ __u32 __x = ((((tv.tv_sec % 86400) * 1000 + tv.tv_usec / 1000))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((((tv.tv_sec % 86400) * 1000 + tv.tv_usec / 1000)))));
...
# 85 "linux-2.6/net/ipv4/ip_options.c"
...
int ip_options_compile(struct ip_options * opt, struct sk_buff * skb)
{
 ...
 if (!opt) {
  opt = &(((struct inet_skb_parm*)((skb)->cb))->opt);
  (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(struct ip_options))) ? __constant_c_and_count_memset(((opt)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct ip_options)))) : __constant_c_memset(((opt)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct ip_options))))) : (__builtin_constant_p((sizeof(struct ip_options))) ? __memset_generic((((opt))),(((0))),(((sizeof(struct ip_options))))) : __memset_generic(((opt)),((0)),((sizeof(struct ip_options))))));
  iph = skb->nh.raw;
...
error:
 if (skb) {
  icmp_send(skb, 12, 0, (( __be32)(__builtin_constant_p((__u32)(((pp_ptr-iph)<<24))) ? ({ __u32 __x = ((((pp_ptr-iph)<<24))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((((pp_ptr-iph)<<24))))));
 }
 return -22;
}
...
int ip_options_get(struct ip_options **optp, unsigned char *data, int optlen, int user)
{
 ...
 opt = kmalloc(sizeof(struct ip_options)+((optlen+3)&~3), (0x10 | 0x40 | 0x80));
 if (!opt)
  return -12;
 (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(struct ip_options))) ? __constant_c_and_count_memset(((opt)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct ip_options)))) : __constant_c_memset(((opt)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct ip_options))))) : (__builtin_constant_p((sizeof(struct ip_options))) ? __memset_generic((((opt))),(((0))),(((sizeof(struct ip_options))))) : __memset_generic(((opt)),((0)),((sizeof(struct ip_options))))));
 if (optlen) {
...
int ip_options_rcv_srr(struct sk_buff *skb)
{
 ...
 if (rt->rt_type == RTN_UNICAST) {
  if (!opt->is_strictroute)
   return 0;
  icmp_send(skb, 12, 0, (( __be32)(__builtin_constant_p((__u32)((16<<24))) ? ({ __u32 __x = (((16<<24))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32(((16<<24))))));
  return -22;
 }
 ...
 for (srrptr=optptr[2], srrspace = optptr[1]; srrptr <= srrspace; srrptr += 4) {
  if (srrptr + 3 > srrspace) {
   icmp_send(skb, 12, 0, (( __be32)(__builtin_constant_p((__u32)(((opt->srr+2)<<24))) ? ({ __u32 __x = ((((opt->srr+2)<<24))); ((__u32)( (((__u32)(__x) & (__u32)0x000000ffUL) << 24) | (((__u32)(__x) & (__u32)0x0000ff00UL) << 8) | (((__u32)(__x) & (__u32)0x00ff0000UL) >> 8) | (((__u32)(__x) & (__u32)0xff000000UL) >> 24) )); }) : __fswab32((((opt->srr+2)<<24))))));
   return -22;
  }
 ...
 typedef  const char   _GLOBAL_240_T; static  _GLOBAL_240_T  _GLOBAL_0___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_1___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_2___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_3___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_4___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_5___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_6___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_7___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_8___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_9___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_10___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_11___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_12___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_13___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_14___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_15___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_16___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_17___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_18___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_19___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_20___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_21___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_22___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_23___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_24___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_25___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_26___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_27___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_28___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_29___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_30___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_31___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_32___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_33___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_34___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_35___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_36___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_37___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_38___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_39___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_40___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_41___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_42___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_43___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_44___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_45___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_46___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_47___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_48___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static  _GLOBAL_240_T  _GLOBAL_49___kstrtab_ip_options_compile_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_compile"  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0___kstrtab_ip_options_compile_I) *_GLOBAL___kstrtab_ip_options_compile_33_A[NUM_STACKS] = { &_GLOBAL_0___kstrtab_ip_options_compile_I, &_GLOBAL_1___kstrtab_ip_options_compile_I, &_GLOBAL_2___kstrtab_ip_options_compile_I, &_GLOBAL_3___kstrtab_ip_options_compile_I, &_GLOBAL_4___kstrtab_ip_options_compile_I, &_GLOBAL_5___kstrtab_ip_options_compile_I, &_GLOBAL_6___kstrtab_ip_options_compile_I, &_GLOBAL_7___kstrtab_ip_options_compile_I, &_GLOBAL_8___kstrtab_ip_options_compile_I, &_GLOBAL_9___kstrtab_ip_options_compile_I, &_GLOBAL_10___kstrtab_ip_options_compile_I, &_GLOBAL_11___kstrtab_ip_options_compile_I, &_GLOBAL_12___kstrtab_ip_options_compile_I, &_GLOBAL_13___kstrtab_ip_options_compile_I, &_GLOBAL_14___kstrtab_ip_options_compile_I, &_GLOBAL_15___kstrtab_ip_options_compile_I, &_GLOBAL_16___kstrtab_ip_options_compile_I, &_GLOBAL_17___kstrtab_ip_options_compile_I, &_GLOBAL_18___kstrtab_ip_options_compile_I, &_GLOBAL_19___kstrtab_ip_options_compile_I, &_GLOBAL_20___kstrtab_ip_options_compile_I, &_GLOBAL_21___kstrtab_ip_options_compile_I, &_GLOBAL_22___kstrtab_ip_options_compile_I, &_GLOBAL_23___kstrtab_ip_options_compile_I, &_GLOBAL_24___kstrtab_ip_options_compile_I, &_GLOBAL_25___kstrtab_ip_options_compile_I, &_GLOBAL_26___kstrtab_ip_options_compile_I, &_GLOBAL_27___kstrtab_ip_options_compile_I, &_GLOBAL_28___kstrtab_ip_options_compile_I, &_GLOBAL_29___kstrtab_ip_options_compile_I, &_GLOBAL_30___kstrtab_ip_options_compile_I, &_GLOBAL_31___kstrtab_ip_options_compile_I, &_GLOBAL_32___kstrtab_ip_options_compile_I, &_GLOBAL_33___kstrtab_ip_options_compile_I, &_GLOBAL_34___kstrtab_ip_options_compile_I, &_GLOBAL_35___kstrtab_ip_options_compile_I, &_GLOBAL_36___kstrtab_ip_options_compile_I, &_GLOBAL_37___kstrtab_ip_options_compile_I, &_GLOBAL_38___kstrtab_ip_options_compile_I, &_GLOBAL_39___kstrtab_ip_options_compile_I, &_GLOBAL_40___kstrtab_ip_options_compile_I, &_GLOBAL_41___kstrtab_ip_options_compile_I, &_GLOBAL_42___kstrtab_ip_options_compile_I, &_GLOBAL_43___kstrtab_ip_options_compile_I, &_GLOBAL_44___kstrtab_ip_options_compile_I, &_GLOBAL_45___kstrtab_ip_options_compile_I, &_GLOBAL_46___kstrtab_ip_options_compile_I, &_GLOBAL_47___kstrtab_ip_options_compile_I, &_GLOBAL_48___kstrtab_ip_options_compile_I, &_GLOBAL_49___kstrtab_ip_options_compile_I, };        typedef  const struct kernel_symbol    _GLOBAL_241_T; static  _GLOBAL_241_T  global___ksymtab_ip_options_compile[NUM_STACKS] __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused))   = {  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_0___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_1___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_2___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_3___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_4___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_5___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_6___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_7___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_8___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_9___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_10___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_11___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_12___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_13___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_14___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_15___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_16___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_17___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_18___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_19___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_20___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_21___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_22___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_23___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_24___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_25___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_26___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_27___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_28___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_29___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_30___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_31___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_32___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_33___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_34___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_35___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_36___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_37___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_38___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_39___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_40___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_41___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_42___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_43___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_44___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_45___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_46___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_47___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_48___kstrtab_ip_options_compile_I  } ,  { ( unsigned long  ) & ip_options_compile   , _GLOBAL_49___kstrtab_ip_options_compile_I  } ,  };             
 typedef  const char   _GLOBAL_242_T; static  _GLOBAL_242_T  _GLOBAL_0___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_1___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_2___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_3___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_4___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_5___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_6___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_7___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_8___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_9___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_10___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_11___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_12___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_13___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_14___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_15___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_16___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_17___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_18___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_19___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_20___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_21___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_22___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_23___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_24___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_25___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_26___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_27___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_28___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_29___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_30___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_31___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_32___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_33___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_34___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_35___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_36___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_37___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_38___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_39___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_40___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_41___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_42___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_43___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_44___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_45___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_46___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_47___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_48___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static  _GLOBAL_242_T  _GLOBAL_49___kstrtab_ip_options_undo_I [ ] __attribute__((section("__ksymtab_strings")))   = "" "ip_options_undo"  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0___kstrtab_ip_options_undo_I) *_GLOBAL___kstrtab_ip_options_undo_34_A[NUM_STACKS] = { &_GLOBAL_0___kstrtab_ip_options_undo_I, &_GLOBAL_1___kstrtab_ip_options_undo_I, &_GLOBAL_2___kstrtab_ip_options_undo_I, &_GLOBAL_3___kstrtab_ip_options_undo_I, &_GLOBAL_4___kstrtab_ip_options_undo_I, &_GLOBAL_5___kstrtab_ip_options_undo_I, &_GLOBAL_6___kstrtab_ip_options_undo_I, &_GLOBAL_7___kstrtab_ip_options_undo_I, &_GLOBAL_8___kstrtab_ip_options_undo_I, &_GLOBAL_9___kstrtab_ip_options_undo_I, &_GLOBAL_10___kstrtab_ip_options_undo_I, &_GLOBAL_11___kstrtab_ip_options_undo_I, &_GLOBAL_12___kstrtab_ip_options_undo_I, &_GLOBAL_13___kstrtab_ip_options_undo_I, &_GLOBAL_14___kstrtab_ip_options_undo_I, &_GLOBAL_15___kstrtab_ip_options_undo_I, &_GLOBAL_16___kstrtab_ip_options_undo_I, &_GLOBAL_17___kstrtab_ip_options_undo_I, &_GLOBAL_18___kstrtab_ip_options_undo_I, &_GLOBAL_19___kstrtab_ip_options_undo_I, &_GLOBAL_20___kstrtab_ip_options_undo_I, &_GLOBAL_21___kstrtab_ip_options_undo_I, &_GLOBAL_22___kstrtab_ip_options_undo_I, &_GLOBAL_23___kstrtab_ip_options_undo_I, &_GLOBAL_24___kstrtab_ip_options_undo_I, &_GLOBAL_25___kstrtab_ip_options_undo_I, &_GLOBAL_26___kstrtab_ip_options_undo_I, &_GLOBAL_27___kstrtab_ip_options_undo_I, &_GLOBAL_28___kstrtab_ip_options_undo_I, &_GLOBAL_29___kstrtab_ip_options_undo_I, &_GLOBAL_30___kstrtab_ip_options_undo_I, &_GLOBAL_31___kstrtab_ip_options_undo_I, &_GLOBAL_32___kstrtab_ip_options_undo_I, &_GLOBAL_33___kstrtab_ip_options_undo_I, &_GLOBAL_34___kstrtab_ip_options_undo_I, &_GLOBAL_35___kstrtab_ip_options_undo_I, &_GLOBAL_36___kstrtab_ip_options_undo_I, &_GLOBAL_37___kstrtab_ip_options_undo_I, &_GLOBAL_38___kstrtab_ip_options_undo_I, &_GLOBAL_39___kstrtab_ip_options_undo_I, &_GLOBAL_40___kstrtab_ip_options_undo_I, &_GLOBAL_41___kstrtab_ip_options_undo_I, &_GLOBAL_42___kstrtab_ip_options_undo_I, &_GLOBAL_43___kstrtab_ip_options_undo_I, &_GLOBAL_44___kstrtab_ip_options_undo_I, &_GLOBAL_45___kstrtab_ip_options_undo_I, &_GLOBAL_46___kstrtab_ip_options_undo_I, &_GLOBAL_47___kstrtab_ip_options_undo_I, &_GLOBAL_48___kstrtab_ip_options_undo_I, &_GLOBAL_49___kstrtab_ip_options_undo_I, };        typedef  const struct kernel_symbol    _GLOBAL_243_T; static  _GLOBAL_243_T  global___ksymtab_ip_options_undo[NUM_STACKS] __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused))   = {  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_0___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_1___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_2___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_3___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_4___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_5___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_6___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_7___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_8___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_9___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_10___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_11___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_12___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_13___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_14___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_15___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_16___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_17___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_18___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_19___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_20___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_21___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_22___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_23___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_24___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_25___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_26___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_27___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_28___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_29___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_30___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_31___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_32___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_33___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_34___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_35___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_36___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_37___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_38___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_39___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_40___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_41___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_42___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_43___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_44___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_45___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_46___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_47___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_48___kstrtab_ip_options_undo_I  } ,  { ( unsigned long  ) & ip_options_undo   , _GLOBAL_49___kstrtab_ip_options_undo_I  } ,  };             
