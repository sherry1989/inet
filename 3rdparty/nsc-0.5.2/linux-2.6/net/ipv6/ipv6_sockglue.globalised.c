# 1 "linux-2.6/net/ipv6/ipv6_sockglue.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/net/ipv6/ipv6_sockglue.c"
# 28 "linux-2.6/net/ipv6/ipv6_sockglue.c"
...
# 29 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
# 33 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
# 36 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
# 37 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
typedef  struct rcu_ctrlblk   _GLOBAL_113_T; extern  _GLOBAL_113_T  global_rcu_ctrlblk[NUM_STACKS];    
typedef  struct rcu_ctrlblk   _GLOBAL_114_T; extern  _GLOBAL_114_T  global_rcu_bh_ctrlblk[NUM_STACKS];    
...
typedef  struct dentry_stat_t   _GLOBAL_115_T; extern  _GLOBAL_115_T  global_dentry_stat[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_116_T; extern  _GLOBAL_116_T  global_dcache_lock[NUM_STACKS];   
...
typedef  struct list_head   _GLOBAL_124_T; extern  _GLOBAL_124_T  global_file_lock_list[NUM_STACKS];    
...
typedef  struct file_operations   _GLOBAL_127_T; extern  _GLOBAL_127_T  global_def_blk_fops[NUM_STACKS];    
typedef  struct address_space_operations   _GLOBAL_128_T; extern  _GLOBAL_128_T  global_def_blk_aops[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_129_T; extern  _GLOBAL_129_T  global_def_chr_fops[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_130_T; extern  _GLOBAL_130_T  global_bad_sock_fops[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_131_T; extern  _GLOBAL_131_T  global_def_fifo_fops[NUM_STACKS];    
...
typedef  struct file_operations   _GLOBAL_132_T; extern  _GLOBAL_132_T  global_read_fifo_fops[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_133_T; extern  _GLOBAL_133_T  global_write_fifo_fops[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_134_T; extern  _GLOBAL_134_T  global_rdwr_fifo_fops[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_135_T; extern  _GLOBAL_135_T  global_read_pipe_fops[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_136_T; extern  _GLOBAL_136_T  global_write_pipe_fops[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_137_T; extern  _GLOBAL_137_T  global_rdwr_pipe_fops[NUM_STACKS];    
...
typedef  struct semaphore   _GLOBAL_138_T; extern  _GLOBAL_138_T  global_iprune_sem[NUM_STACKS];    
...
typedef  struct file_operations   _GLOBAL_139_T; extern  _GLOBAL_139_T  global_generic_ro_fops[NUM_STACKS];    
...
typedef  struct file_operations   _GLOBAL_141_T; extern  _GLOBAL_141_T  global_simple_dir_operations[NUM_STACKS];    
...
typedef  __typeof__ ( struct page_state  )   _GLOBAL_169_T; extern  _GLOBAL_169_T  global_per_cpu__page_states[NUM_STACKS];    
...
# 38 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
# 39 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
# 41 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
# 42 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
# 44 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
# 45 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
# 46 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
# 48 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
# 1 "linux-2.6/include/net/transp_v6.h" 1
# 12 "linux-2.6/include/net/transp_v6.h"
typedef  struct proto   _GLOBAL_237_T; extern  _GLOBAL_237_T  global_rawv6_prot[NUM_STACKS];    
typedef  struct proto   _GLOBAL_238_T; extern  _GLOBAL_238_T  global_udpv6_prot[NUM_STACKS];    
typedef  struct proto   _GLOBAL_239_T; extern  _GLOBAL_239_T  global_tcpv6_prot[NUM_STACKS];    
...
# 49 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
typedef  struct fib6_walker_t   _GLOBAL_240_T; extern  _GLOBAL_240_T  global_fib6_walker_list[NUM_STACKS];    
typedef  rwlock_t  _GLOBAL_241_T; extern  _GLOBAL_241_T  global_fib6_walker_lock[NUM_STACKS];   
...
typedef  struct fib6_node   _GLOBAL_242_T; extern  _GLOBAL_242_T  global_ip6_routing_table[NUM_STACKS];    
...
typedef  struct rt6_info   _GLOBAL_243_T; extern  _GLOBAL_243_T  global_ip6_null_entry[NUM_STACKS];    

typedef  int  _GLOBAL_244_T; extern  _GLOBAL_244_T  global_ip6_rt_gc_interval[NUM_STACKS];   
...
typedef  rwlock_t  _GLOBAL_245_T; extern  _GLOBAL_245_T  global_rt6_lock[NUM_STACKS];   
...
# 50 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
typedef  rwlock_t  _GLOBAL_246_T; extern  _GLOBAL_246_T  global_addrconf_lock[NUM_STACKS];   
...
# 51 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
# 1 "linux-2.6/include/net/inet_common.h" 1



typedef  struct proto_ops   _GLOBAL_247_T; extern  _GLOBAL_247_T  global_inet_stream_ops[NUM_STACKS];    
typedef  struct proto_ops   _GLOBAL_248_T; extern  _GLOBAL_248_T  global_inet_dgram_ops[NUM_STACKS];    
...
typedef  atomic_t  _GLOBAL_249_T; extern  _GLOBAL_249_T  global_inet_sock_nr[NUM_STACKS];   
...
# 52 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
typedef  struct ipv4_devconf   _GLOBAL_250_T; extern  _GLOBAL_250_T  global_ipv4_devconf[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_251_T; extern  _GLOBAL_251_T  global_inet_peer_unused_lock[NUM_STACKS];   
typedef  struct inet_peer   _GLOBAL_252_T; extern  _GLOBAL_252_T  * global_inet_peer_unused_head[NUM_STACKS];    
...
typedef  struct rt_cache_stat   _GLOBAL_255_T; extern  _GLOBAL_255_T  * global_rt_cache_stat[NUM_STACKS];    



typedef  struct ip_rt_acct   _GLOBAL_256_T; extern  _GLOBAL_256_T  * global_ip_rt_acct[NUM_STACKS];    
...
typedef  __u8  _GLOBAL_257_T; extern  _GLOBAL_257_T  _GLOBAL_0_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_1_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_2_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_3_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_4_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_5_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_6_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_7_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_8_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_9_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_10_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_11_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_12_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_13_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_14_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_15_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_16_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_17_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_18_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_19_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_20_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_21_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_22_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_23_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_24_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_25_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_26_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_27_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_28_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_29_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_30_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_31_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_32_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_33_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_34_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_35_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_36_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_37_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_38_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_39_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_40_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_41_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_42_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_43_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_44_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_45_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_46_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_47_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_48_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_257_T  _GLOBAL_49_ip_tos2prio_I [ 16 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ip_tos2prio_I) *_GLOBAL_ip_tos2prio_31_A[NUM_STACKS] = { &_GLOBAL_0_ip_tos2prio_I, &_GLOBAL_1_ip_tos2prio_I, &_GLOBAL_2_ip_tos2prio_I, &_GLOBAL_3_ip_tos2prio_I, &_GLOBAL_4_ip_tos2prio_I, &_GLOBAL_5_ip_tos2prio_I, &_GLOBAL_6_ip_tos2prio_I, &_GLOBAL_7_ip_tos2prio_I, &_GLOBAL_8_ip_tos2prio_I, &_GLOBAL_9_ip_tos2prio_I, &_GLOBAL_10_ip_tos2prio_I, &_GLOBAL_11_ip_tos2prio_I, &_GLOBAL_12_ip_tos2prio_I, &_GLOBAL_13_ip_tos2prio_I, &_GLOBAL_14_ip_tos2prio_I, &_GLOBAL_15_ip_tos2prio_I, &_GLOBAL_16_ip_tos2prio_I, &_GLOBAL_17_ip_tos2prio_I, &_GLOBAL_18_ip_tos2prio_I, &_GLOBAL_19_ip_tos2prio_I, &_GLOBAL_20_ip_tos2prio_I, &_GLOBAL_21_ip_tos2prio_I, &_GLOBAL_22_ip_tos2prio_I, &_GLOBAL_23_ip_tos2prio_I, &_GLOBAL_24_ip_tos2prio_I, &_GLOBAL_25_ip_tos2prio_I, &_GLOBAL_26_ip_tos2prio_I, &_GLOBAL_27_ip_tos2prio_I, &_GLOBAL_28_ip_tos2prio_I, &_GLOBAL_29_ip_tos2prio_I, &_GLOBAL_30_ip_tos2prio_I, &_GLOBAL_31_ip_tos2prio_I, &_GLOBAL_32_ip_tos2prio_I, &_GLOBAL_33_ip_tos2prio_I, &_GLOBAL_34_ip_tos2prio_I, &_GLOBAL_35_ip_tos2prio_I, &_GLOBAL_36_ip_tos2prio_I, &_GLOBAL_37_ip_tos2prio_I, &_GLOBAL_38_ip_tos2prio_I, &_GLOBAL_39_ip_tos2prio_I, &_GLOBAL_40_ip_tos2prio_I, &_GLOBAL_41_ip_tos2prio_I, &_GLOBAL_42_ip_tos2prio_I, &_GLOBAL_43_ip_tos2prio_I, &_GLOBAL_44_ip_tos2prio_I, &_GLOBAL_45_ip_tos2prio_I, &_GLOBAL_46_ip_tos2prio_I, &_GLOBAL_47_ip_tos2prio_I, &_GLOBAL_48_ip_tos2prio_I, &_GLOBAL_49_ip_tos2prio_I, };  
...
typedef  struct neigh_table   _GLOBAL_258_T; extern  _GLOBAL_258_T  global_arp_tbl[NUM_STACKS];    
...
typedef  struct neigh_ops   _GLOBAL_259_T; extern  _GLOBAL_259_T  global_arp_broken_ops[NUM_STACKS];    
...
typedef  struct ip_ra_chain   _GLOBAL_260_T; extern  _GLOBAL_260_T  * global_ip_ra_chain[NUM_STACKS];    
typedef  rwlock_t  _GLOBAL_261_T; extern  _GLOBAL_261_T  global_ip_ra_lock[NUM_STACKS];   
...
typedef  struct ipv4_config   _GLOBAL_262_T; extern  _GLOBAL_262_T  global_ipv4_config[NUM_STACKS];    
typedef  __typeof__ ( struct ipstats_mib  )   _GLOBAL_263_T; extern  _GLOBAL_263_T  * _GLOBAL_0_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_1_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_2_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_3_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_4_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_5_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_6_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_7_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_8_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_9_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_10_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_11_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_12_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_13_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_14_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_15_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_16_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_17_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_18_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_19_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_20_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_21_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_22_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_23_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_24_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_25_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_26_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_27_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_28_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_29_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_30_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_31_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_32_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_33_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_34_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_35_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_36_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_37_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_38_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_39_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_40_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_41_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_42_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_43_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_44_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_45_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_46_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_47_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_48_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_263_T  * _GLOBAL_49_ip_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ip_statistics_I) *_GLOBAL_ip_statistics_32_A[NUM_STACKS];   



typedef  __typeof__ ( struct linux_mib  )   _GLOBAL_264_T; extern  _GLOBAL_264_T  * _GLOBAL_0_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_1_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_2_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_3_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_4_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_5_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_6_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_7_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_8_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_9_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_10_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_11_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_12_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_13_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_14_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_15_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_16_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_17_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_18_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_19_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_20_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_21_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_22_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_23_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_24_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_25_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_26_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_27_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_28_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_29_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_30_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_31_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_32_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_33_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_34_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_35_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_36_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_37_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_38_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_39_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_40_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_41_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_42_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_43_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_44_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_45_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_46_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_47_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_48_net_statistics_I [ 2 ]  ; extern  _GLOBAL_264_T  * _GLOBAL_49_net_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_net_statistics_I) *_GLOBAL_net_statistics_33_A[NUM_STACKS] = { &_GLOBAL_0_net_statistics_I, &_GLOBAL_1_net_statistics_I, &_GLOBAL_2_net_statistics_I, &_GLOBAL_3_net_statistics_I, &_GLOBAL_4_net_statistics_I, &_GLOBAL_5_net_statistics_I, &_GLOBAL_6_net_statistics_I, &_GLOBAL_7_net_statistics_I, &_GLOBAL_8_net_statistics_I, &_GLOBAL_9_net_statistics_I, &_GLOBAL_10_net_statistics_I, &_GLOBAL_11_net_statistics_I, &_GLOBAL_12_net_statistics_I, &_GLOBAL_13_net_statistics_I, &_GLOBAL_14_net_statistics_I, &_GLOBAL_15_net_statistics_I, &_GLOBAL_16_net_statistics_I, &_GLOBAL_17_net_statistics_I, &_GLOBAL_18_net_statistics_I, &_GLOBAL_19_net_statistics_I, &_GLOBAL_20_net_statistics_I, &_GLOBAL_21_net_statistics_I, &_GLOBAL_22_net_statistics_I, &_GLOBAL_23_net_statistics_I, &_GLOBAL_24_net_statistics_I, &_GLOBAL_25_net_statistics_I, &_GLOBAL_26_net_statistics_I, &_GLOBAL_27_net_statistics_I, &_GLOBAL_28_net_statistics_I, &_GLOBAL_29_net_statistics_I, &_GLOBAL_30_net_statistics_I, &_GLOBAL_31_net_statistics_I, &_GLOBAL_32_net_statistics_I, &_GLOBAL_33_net_statistics_I, &_GLOBAL_34_net_statistics_I, &_GLOBAL_35_net_statistics_I, &_GLOBAL_36_net_statistics_I, &_GLOBAL_37_net_statistics_I, &_GLOBAL_38_net_statistics_I, &_GLOBAL_39_net_statistics_I, &_GLOBAL_40_net_statistics_I, &_GLOBAL_41_net_statistics_I, &_GLOBAL_42_net_statistics_I, &_GLOBAL_43_net_statistics_I, &_GLOBAL_44_net_statistics_I, &_GLOBAL_45_net_statistics_I, &_GLOBAL_46_net_statistics_I, &_GLOBAL_47_net_statistics_I, &_GLOBAL_48_net_statistics_I, &_GLOBAL_49_net_statistics_I, };   
...
typedef  int  _GLOBAL_265_T; extern  _GLOBAL_265_T  _GLOBAL_0_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_1_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_2_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_3_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_4_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_5_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_6_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_7_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_8_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_9_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_10_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_11_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_12_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_13_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_14_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_15_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_16_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_17_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_18_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_19_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_20_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_21_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_22_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_23_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_24_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_25_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_26_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_27_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_28_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_29_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_30_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_31_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_32_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_33_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_34_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_35_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_36_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_37_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_38_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_39_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_40_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_41_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_42_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_43_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_44_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_45_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_46_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_47_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_48_sysctl_local_port_range_I [ 2 ] ; extern  _GLOBAL_265_T  _GLOBAL_49_sysctl_local_port_range_I [ 2 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_sysctl_local_port_range_I) *_GLOBAL_sysctl_local_port_range_34_A[NUM_STACKS];  
typedef  int  _GLOBAL_266_T; extern  _GLOBAL_266_T  global_sysctl_ip_default_ttl[NUM_STACKS];   
...
typedef  kmem_cache_t  _GLOBAL_270_T; extern  _GLOBAL_270_T  * global_tcp_bucket_cachep[NUM_STACKS];   
extern struct tcp_bind_bucket *tcp_bucket_create(struct tcp_bind_hashbucket *head,
       unsigned short snum);
extern void tcp_bucket_destroy(struct tcp_bind_bucket *tb);
extern void tcp_bucket_unlock(struct sock *sk);
typedef  int  _GLOBAL_271_T; extern  _GLOBAL_271_T  global_tcp_port_rover[NUM_STACKS];   
...
typedef  kmem_cache_t  _GLOBAL_272_T; extern  _GLOBAL_272_T  * global_tcp_timewait_cachep[NUM_STACKS];   
...
typedef  atomic_t  _GLOBAL_273_T; extern  _GLOBAL_273_T  global_tcp_orphan_count[NUM_STACKS];   
typedef  int  _GLOBAL_274_T; extern  _GLOBAL_274_T  global_tcp_tw_count[NUM_STACKS];   
...
typedef  int  _GLOBAL_275_T; extern  _GLOBAL_275_T  global_sysctl_max_syn_backlog[NUM_STACKS];   
typedef  int  _GLOBAL_276_T; extern  _GLOBAL_276_T  global_sysctl_tcp_timestamps[NUM_STACKS];   
typedef  int  _GLOBAL_277_T; extern  _GLOBAL_277_T  global_sysctl_tcp_window_scaling[NUM_STACKS];   
typedef  int  _GLOBAL_278_T; extern  _GLOBAL_278_T  global_sysctl_tcp_sack[NUM_STACKS];   
typedef  int  _GLOBAL_279_T; extern  _GLOBAL_279_T  global_sysctl_tcp_fin_timeout[NUM_STACKS];   
typedef  int  _GLOBAL_280_T; extern  _GLOBAL_280_T  global_sysctl_tcp_tw_recycle[NUM_STACKS];   
typedef  int  _GLOBAL_281_T; extern  _GLOBAL_281_T  global_sysctl_tcp_keepalive_time[NUM_STACKS];   
typedef  int  _GLOBAL_282_T; extern  _GLOBAL_282_T  global_sysctl_tcp_keepalive_probes[NUM_STACKS];   
typedef  int  _GLOBAL_283_T; extern  _GLOBAL_283_T  global_sysctl_tcp_keepalive_intvl[NUM_STACKS];   
typedef  int  _GLOBAL_284_T; extern  _GLOBAL_284_T  global_sysctl_tcp_syn_retries[NUM_STACKS];   
typedef  int  _GLOBAL_285_T; extern  _GLOBAL_285_T  global_sysctl_tcp_synack_retries[NUM_STACKS];   
typedef  int  _GLOBAL_286_T; extern  _GLOBAL_286_T  global_sysctl_tcp_retries1[NUM_STACKS];   
typedef  int  _GLOBAL_287_T; extern  _GLOBAL_287_T  global_sysctl_tcp_retries2[NUM_STACKS];   
typedef  int  _GLOBAL_288_T; extern  _GLOBAL_288_T  global_sysctl_tcp_orphan_retries[NUM_STACKS];   
typedef  int  _GLOBAL_289_T; extern  _GLOBAL_289_T  global_sysctl_tcp_syncookies[NUM_STACKS];   
typedef  int  _GLOBAL_290_T; extern  _GLOBAL_290_T  global_sysctl_tcp_retrans_collapse[NUM_STACKS];   
typedef  int  _GLOBAL_291_T; extern  _GLOBAL_291_T  global_sysctl_tcp_stdurg[NUM_STACKS];   
typedef  int  _GLOBAL_292_T; extern  _GLOBAL_292_T  global_sysctl_tcp_rfc1337[NUM_STACKS];   
typedef  int  _GLOBAL_293_T; extern  _GLOBAL_293_T  global_sysctl_tcp_abort_on_overflow[NUM_STACKS];   
typedef  int  _GLOBAL_294_T; extern  _GLOBAL_294_T  global_sysctl_tcp_max_orphans[NUM_STACKS];   
typedef  int  _GLOBAL_295_T; extern  _GLOBAL_295_T  global_sysctl_tcp_max_tw_buckets[NUM_STACKS];   
typedef  int  _GLOBAL_296_T; extern  _GLOBAL_296_T  global_sysctl_tcp_fack[NUM_STACKS];   
typedef  int  _GLOBAL_297_T; extern  _GLOBAL_297_T  global_sysctl_tcp_reordering[NUM_STACKS];   
typedef  int  _GLOBAL_298_T; extern  _GLOBAL_298_T  global_sysctl_tcp_ecn[NUM_STACKS];   
typedef  int  _GLOBAL_299_T; extern  _GLOBAL_299_T  global_sysctl_tcp_dsack[NUM_STACKS];   
typedef  int  _GLOBAL_300_T; extern  _GLOBAL_300_T  _GLOBAL_0_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_1_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_2_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_3_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_4_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_5_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_6_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_7_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_8_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_9_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_10_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_11_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_12_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_13_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_14_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_15_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_16_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_17_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_18_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_19_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_20_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_21_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_22_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_23_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_24_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_25_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_26_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_27_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_28_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_29_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_30_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_31_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_32_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_33_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_34_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_35_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_36_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_37_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_38_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_39_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_40_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_41_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_42_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_43_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_44_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_45_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_46_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_47_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_48_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_300_T  _GLOBAL_49_sysctl_tcp_mem_I [ 3 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_sysctl_tcp_mem_I) *_GLOBAL_sysctl_tcp_mem_35_A[NUM_STACKS];  
typedef  int  _GLOBAL_301_T; extern  _GLOBAL_301_T  _GLOBAL_0_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_1_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_2_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_3_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_4_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_5_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_6_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_7_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_8_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_9_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_10_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_11_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_12_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_13_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_14_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_15_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_16_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_17_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_18_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_19_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_20_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_21_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_22_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_23_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_24_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_25_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_26_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_27_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_28_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_29_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_30_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_31_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_32_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_33_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_34_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_35_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_36_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_37_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_38_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_39_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_40_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_41_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_42_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_43_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_44_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_45_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_46_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_47_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_48_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_301_T  _GLOBAL_49_sysctl_tcp_wmem_I [ 3 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_sysctl_tcp_wmem_I) *_GLOBAL_sysctl_tcp_wmem_36_A[NUM_STACKS];  
typedef  int  _GLOBAL_302_T; extern  _GLOBAL_302_T  _GLOBAL_0_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_1_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_2_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_3_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_4_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_5_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_6_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_7_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_8_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_9_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_10_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_11_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_12_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_13_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_14_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_15_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_16_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_17_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_18_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_19_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_20_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_21_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_22_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_23_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_24_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_25_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_26_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_27_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_28_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_29_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_30_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_31_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_32_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_33_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_34_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_35_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_36_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_37_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_38_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_39_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_40_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_41_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_42_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_43_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_44_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_45_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_46_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_47_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_48_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_302_T  _GLOBAL_49_sysctl_tcp_rmem_I [ 3 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_sysctl_tcp_rmem_I) *_GLOBAL_sysctl_tcp_rmem_37_A[NUM_STACKS];  
typedef  int  _GLOBAL_303_T; extern  _GLOBAL_303_T  global_sysctl_tcp_app_win[NUM_STACKS];   
typedef  int  _GLOBAL_304_T; extern  _GLOBAL_304_T  global_sysctl_tcp_adv_win_scale[NUM_STACKS];   
typedef  int  _GLOBAL_305_T; extern  _GLOBAL_305_T  global_sysctl_tcp_tw_reuse[NUM_STACKS];   
typedef  int  _GLOBAL_306_T; extern  _GLOBAL_306_T  global_sysctl_tcp_frto[NUM_STACKS];   
typedef  int  _GLOBAL_307_T; extern  _GLOBAL_307_T  global_sysctl_tcp_low_latency[NUM_STACKS];   
typedef  int  _GLOBAL_308_T; extern  _GLOBAL_308_T  global_sysctl_tcp_westwood[NUM_STACKS];   
typedef  int  _GLOBAL_309_T; extern  _GLOBAL_309_T  global_sysctl_tcp_vegas_cong_avoid[NUM_STACKS];   
typedef  int  _GLOBAL_310_T; extern  _GLOBAL_310_T  global_sysctl_tcp_vegas_alpha[NUM_STACKS];   
typedef  int  _GLOBAL_311_T; extern  _GLOBAL_311_T  global_sysctl_tcp_vegas_beta[NUM_STACKS];   
typedef  int  _GLOBAL_312_T; extern  _GLOBAL_312_T  global_sysctl_tcp_vegas_gamma[NUM_STACKS];   
typedef  int  _GLOBAL_313_T; extern  _GLOBAL_313_T  global_sysctl_tcp_nometrics_save[NUM_STACKS];   
typedef  int  _GLOBAL_314_T; extern  _GLOBAL_314_T  global_sysctl_tcp_bic[NUM_STACKS];   
typedef  int  _GLOBAL_315_T; extern  _GLOBAL_315_T  global_sysctl_tcp_bic_fast_convergence[NUM_STACKS];   
typedef  int  _GLOBAL_316_T; extern  _GLOBAL_316_T  global_sysctl_tcp_bic_low_window[NUM_STACKS];   
typedef  int  _GLOBAL_317_T; extern  _GLOBAL_317_T  global_sysctl_tcp_moderate_rcvbuf[NUM_STACKS];   
typedef  int  _GLOBAL_318_T; extern  _GLOBAL_318_T  global_sysctl_tcp_tso_win_divisor[NUM_STACKS];   

typedef  atomic_t  _GLOBAL_319_T; extern  _GLOBAL_319_T  global_tcp_memory_allocated[NUM_STACKS];   
typedef  atomic_t  _GLOBAL_320_T; extern  _GLOBAL_320_T  global_tcp_sockets_allocated[NUM_STACKS];   
typedef  int  _GLOBAL_321_T; extern  _GLOBAL_321_T  global_tcp_memory_pressure[NUM_STACKS];   
...
typedef  kmem_cache_t  _GLOBAL_322_T; extern  _GLOBAL_322_T  * global_tcp_openreq_cachep[NUM_STACKS];   
...
typedef  const char   _GLOBAL_325_T; extern  _GLOBAL_325_T  _GLOBAL_0_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_1_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_2_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_3_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_4_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_5_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_6_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_7_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_8_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_9_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_10_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_11_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_12_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_13_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_14_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_15_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_16_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_17_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_18_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_19_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_20_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_21_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_22_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_23_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_24_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_25_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_26_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_27_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_28_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_29_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_30_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_31_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_32_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_33_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_34_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_35_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_36_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_37_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_38_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_39_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_40_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_41_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_42_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_43_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_44_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_45_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_46_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_47_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_48_tcp_timer_bug_msg_I [ ] ; extern  _GLOBAL_325_T  _GLOBAL_49_tcp_timer_bug_msg_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_tcp_timer_bug_msg_I) *_GLOBAL_tcp_timer_bug_msg_39_A[NUM_STACKS] = { &_GLOBAL_0_tcp_timer_bug_msg_I, &_GLOBAL_1_tcp_timer_bug_msg_I, &_GLOBAL_2_tcp_timer_bug_msg_I, &_GLOBAL_3_tcp_timer_bug_msg_I, &_GLOBAL_4_tcp_timer_bug_msg_I, &_GLOBAL_5_tcp_timer_bug_msg_I, &_GLOBAL_6_tcp_timer_bug_msg_I, &_GLOBAL_7_tcp_timer_bug_msg_I, &_GLOBAL_8_tcp_timer_bug_msg_I, &_GLOBAL_9_tcp_timer_bug_msg_I, &_GLOBAL_10_tcp_timer_bug_msg_I, &_GLOBAL_11_tcp_timer_bug_msg_I, &_GLOBAL_12_tcp_timer_bug_msg_I, &_GLOBAL_13_tcp_timer_bug_msg_I, &_GLOBAL_14_tcp_timer_bug_msg_I, &_GLOBAL_15_tcp_timer_bug_msg_I, &_GLOBAL_16_tcp_timer_bug_msg_I, &_GLOBAL_17_tcp_timer_bug_msg_I, &_GLOBAL_18_tcp_timer_bug_msg_I, &_GLOBAL_19_tcp_timer_bug_msg_I, &_GLOBAL_20_tcp_timer_bug_msg_I, &_GLOBAL_21_tcp_timer_bug_msg_I, &_GLOBAL_22_tcp_timer_bug_msg_I, &_GLOBAL_23_tcp_timer_bug_msg_I, &_GLOBAL_24_tcp_timer_bug_msg_I, &_GLOBAL_25_tcp_timer_bug_msg_I, &_GLOBAL_26_tcp_timer_bug_msg_I, &_GLOBAL_27_tcp_timer_bug_msg_I, &_GLOBAL_28_tcp_timer_bug_msg_I, &_GLOBAL_29_tcp_timer_bug_msg_I, &_GLOBAL_30_tcp_timer_bug_msg_I, &_GLOBAL_31_tcp_timer_bug_msg_I, &_GLOBAL_32_tcp_timer_bug_msg_I, &_GLOBAL_33_tcp_timer_bug_msg_I, &_GLOBAL_34_tcp_timer_bug_msg_I, &_GLOBAL_35_tcp_timer_bug_msg_I, &_GLOBAL_36_tcp_timer_bug_msg_I, &_GLOBAL_37_tcp_timer_bug_msg_I, &_GLOBAL_38_tcp_timer_bug_msg_I, &_GLOBAL_39_tcp_timer_bug_msg_I, &_GLOBAL_40_tcp_timer_bug_msg_I, &_GLOBAL_41_tcp_timer_bug_msg_I, &_GLOBAL_42_tcp_timer_bug_msg_I, &_GLOBAL_43_tcp_timer_bug_msg_I, &_GLOBAL_44_tcp_timer_bug_msg_I, &_GLOBAL_45_tcp_timer_bug_msg_I, &_GLOBAL_46_tcp_timer_bug_msg_I, &_GLOBAL_47_tcp_timer_bug_msg_I, &_GLOBAL_48_tcp_timer_bug_msg_I, &_GLOBAL_49_tcp_timer_bug_msg_I, };   
...
# 53 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
# 1 "linux-2.6/include/net/udp.h" 1
# 38 "linux-2.6/include/net/udp.h"
typedef  struct hlist_head   _GLOBAL_326_T; extern  _GLOBAL_326_T  _GLOBAL_0_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_1_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_2_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_3_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_4_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_5_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_6_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_7_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_8_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_9_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_10_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_11_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_12_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_13_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_14_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_15_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_16_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_17_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_18_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_19_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_20_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_21_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_22_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_23_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_24_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_25_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_26_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_27_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_28_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_29_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_30_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_31_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_32_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_33_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_34_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_35_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_36_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_37_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_38_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_39_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_40_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_41_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_42_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_43_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_44_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_45_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_46_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_47_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_48_udp_hash_I [ 128 ] ; extern  _GLOBAL_326_T  _GLOBAL_49_udp_hash_I [ 128 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_udp_hash_I) *_GLOBAL_udp_hash_40_A[NUM_STACKS] = { &_GLOBAL_0_udp_hash_I, &_GLOBAL_1_udp_hash_I, &_GLOBAL_2_udp_hash_I, &_GLOBAL_3_udp_hash_I, &_GLOBAL_4_udp_hash_I, &_GLOBAL_5_udp_hash_I, &_GLOBAL_6_udp_hash_I, &_GLOBAL_7_udp_hash_I, &_GLOBAL_8_udp_hash_I, &_GLOBAL_9_udp_hash_I, &_GLOBAL_10_udp_hash_I, &_GLOBAL_11_udp_hash_I, &_GLOBAL_12_udp_hash_I, &_GLOBAL_13_udp_hash_I, &_GLOBAL_14_udp_hash_I, &_GLOBAL_15_udp_hash_I, &_GLOBAL_16_udp_hash_I, &_GLOBAL_17_udp_hash_I, &_GLOBAL_18_udp_hash_I, &_GLOBAL_19_udp_hash_I, &_GLOBAL_20_udp_hash_I, &_GLOBAL_21_udp_hash_I, &_GLOBAL_22_udp_hash_I, &_GLOBAL_23_udp_hash_I, &_GLOBAL_24_udp_hash_I, &_GLOBAL_25_udp_hash_I, &_GLOBAL_26_udp_hash_I, &_GLOBAL_27_udp_hash_I, &_GLOBAL_28_udp_hash_I, &_GLOBAL_29_udp_hash_I, &_GLOBAL_30_udp_hash_I, &_GLOBAL_31_udp_hash_I, &_GLOBAL_32_udp_hash_I, &_GLOBAL_33_udp_hash_I, &_GLOBAL_34_udp_hash_I, &_GLOBAL_35_udp_hash_I, &_GLOBAL_36_udp_hash_I, &_GLOBAL_37_udp_hash_I, &_GLOBAL_38_udp_hash_I, &_GLOBAL_39_udp_hash_I, &_GLOBAL_40_udp_hash_I, &_GLOBAL_41_udp_hash_I, &_GLOBAL_42_udp_hash_I, &_GLOBAL_43_udp_hash_I, &_GLOBAL_44_udp_hash_I, &_GLOBAL_45_udp_hash_I, &_GLOBAL_46_udp_hash_I, &_GLOBAL_47_udp_hash_I, &_GLOBAL_48_udp_hash_I, &_GLOBAL_49_udp_hash_I, };   
typedef  rwlock_t  _GLOBAL_327_T; extern  _GLOBAL_327_T  global_udp_hash_lock[NUM_STACKS];   

typedef  int  _GLOBAL_328_T; extern  _GLOBAL_328_T  global_udp_port_rover[NUM_STACKS];   
...
typedef  struct proto   _GLOBAL_329_T; extern  _GLOBAL_329_T  global_udp_prot[NUM_STACKS];    
...
typedef  __typeof__ ( struct udp_mib  )   _GLOBAL_330_T; extern  _GLOBAL_330_T  * _GLOBAL_0_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_1_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_2_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_3_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_4_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_5_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_6_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_7_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_8_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_9_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_10_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_11_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_12_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_13_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_14_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_15_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_16_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_17_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_18_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_19_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_20_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_21_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_22_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_23_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_24_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_25_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_26_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_27_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_28_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_29_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_30_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_31_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_32_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_33_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_34_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_35_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_36_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_37_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_38_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_39_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_40_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_41_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_42_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_43_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_44_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_45_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_46_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_47_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_48_udp_statistics_I [ 2 ]  ; extern  _GLOBAL_330_T  * _GLOBAL_49_udp_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_udp_statistics_I) *_GLOBAL_udp_statistics_41_A[NUM_STACKS];   
...
# 54 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2
...
typedef  struct semaphore   _GLOBAL_331_T; extern  _GLOBAL_331_T  global_xfrm_cfg_sem[NUM_STACKS];    
...
# 55 "linux-2.6/net/ipv6/ipv6_sockglue.c" 2



typedef  __typeof__ ( struct ipstats_mib  )  _GLOBAL_334_T;  _GLOBAL_334_T  * _GLOBAL_0_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_1_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_2_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_3_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_4_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_5_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_6_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_7_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_8_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_9_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_10_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_11_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_12_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_13_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_14_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_15_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_16_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_17_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_18_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_19_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_20_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_21_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_22_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_23_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_24_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_25_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_26_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_27_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_28_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_29_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_30_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_31_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_32_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_33_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_34_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_35_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_36_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_37_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_38_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_39_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_40_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_41_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_42_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_43_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_44_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_45_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_46_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_47_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_48_ipv6_statistics_I [ 2 ]  ;  _GLOBAL_334_T  * _GLOBAL_49_ipv6_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv6_statistics_I) *_GLOBAL_ipv6_statistics_43_A[NUM_STACKS] = { &_GLOBAL_0_ipv6_statistics_I, &_GLOBAL_1_ipv6_statistics_I, &_GLOBAL_2_ipv6_statistics_I, &_GLOBAL_3_ipv6_statistics_I, &_GLOBAL_4_ipv6_statistics_I, &_GLOBAL_5_ipv6_statistics_I, &_GLOBAL_6_ipv6_statistics_I, &_GLOBAL_7_ipv6_statistics_I, &_GLOBAL_8_ipv6_statistics_I, &_GLOBAL_9_ipv6_statistics_I, &_GLOBAL_10_ipv6_statistics_I, &_GLOBAL_11_ipv6_statistics_I, &_GLOBAL_12_ipv6_statistics_I, &_GLOBAL_13_ipv6_statistics_I, &_GLOBAL_14_ipv6_statistics_I, &_GLOBAL_15_ipv6_statistics_I, &_GLOBAL_16_ipv6_statistics_I, &_GLOBAL_17_ipv6_statistics_I, &_GLOBAL_18_ipv6_statistics_I, &_GLOBAL_19_ipv6_statistics_I, &_GLOBAL_20_ipv6_statistics_I, &_GLOBAL_21_ipv6_statistics_I, &_GLOBAL_22_ipv6_statistics_I, &_GLOBAL_23_ipv6_statistics_I, &_GLOBAL_24_ipv6_statistics_I, &_GLOBAL_25_ipv6_statistics_I, &_GLOBAL_26_ipv6_statistics_I, &_GLOBAL_27_ipv6_statistics_I, &_GLOBAL_28_ipv6_statistics_I, &_GLOBAL_29_ipv6_statistics_I, &_GLOBAL_30_ipv6_statistics_I, &_GLOBAL_31_ipv6_statistics_I, &_GLOBAL_32_ipv6_statistics_I, &_GLOBAL_33_ipv6_statistics_I, &_GLOBAL_34_ipv6_statistics_I, &_GLOBAL_35_ipv6_statistics_I, &_GLOBAL_36_ipv6_statistics_I, &_GLOBAL_37_ipv6_statistics_I, &_GLOBAL_38_ipv6_statistics_I, &_GLOBAL_39_ipv6_statistics_I, &_GLOBAL_40_ipv6_statistics_I, &_GLOBAL_41_ipv6_statistics_I, &_GLOBAL_42_ipv6_statistics_I, &_GLOBAL_43_ipv6_statistics_I, &_GLOBAL_44_ipv6_statistics_I, &_GLOBAL_45_ipv6_statistics_I, &_GLOBAL_46_ipv6_statistics_I, &_GLOBAL_47_ipv6_statistics_I, &_GLOBAL_48_ipv6_statistics_I, &_GLOBAL_49_ipv6_statistics_I, };  

typedef  struct packet_type   _GLOBAL_335_T; static  _GLOBAL_335_T  global_ipv6_packet_type[NUM_STACKS] = {  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  { . type  = ( ( __be16 ) ( ( __u16 ) ( ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0x00ffU   )  << 8  )  | ( ( ( __u16 ) ( ( 0x86DD )  )   & ( __u16 ) 0xff00U   )  >> 8  )   )   )   )   , . func  = ipv6_rcv   , } ,  };      
                
   


typedef  struct ip6_ra_chain  _GLOBAL_336_T;  _GLOBAL_336_T  * global_ip6_ra_chain[NUM_STACKS];   
typedef  rwlock_t _GLOBAL_337_T;  _GLOBAL_337_T  global_ip6_ra_lock[NUM_STACKS] = {  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  ( rwlock_t ) { } ,  };      
...
int ip6_ra_control(struct sock *sk, int sel, void (*destructor)(struct sock *))
{
 ...
 new_ra = (sel>=0) ? kmalloc(sizeof(*new_ra), (0x10 | 0x40 | 0x80)) : ((void *)0);

 do { do { (current_thread_info()->preempt_count) += (1UL << (0 + 8)); __asm__ __volatile__("": : :"memory"); } while (0); do { } while (0); do { (void)(&global_ip6_ra_lock[get_stack_id()]); } while(0); (void)0; } while (0);
 for (rap = &global_ip6_ra_chain[get_stack_id()]; (ra=*rap) != ((void *)0); rap = &ra->next) {
  if (ra->sk == sk) {
   if (sel>=0) {
    do { do { (void)(&global_ip6_ra_lock[get_stack_id()]); } while(0); do { } while (0); local_bh_enable(); (void)0; } while (0);
    if (new_ra)
     kfree(new_ra);
    return -98;
   }
      ...
      char *optval, int optlen)
{
 ...
 if (optval == ((void *)0))
  val=0;
 else if (({ int __ret_gu,__val_gu; (void)0; switch(sizeof (*((int *) optval))) { case 1: __asm__ __volatile__("call __get_user_" "1" :"=a" (__ret_gu),"=d" (__val_gu) :"0" ((int *) optval)); break; case 2: __asm__ __volatile__("call __get_user_" "2" :"=a" (__ret_gu),"=d" (__val_gu) :"0" ((int *) optval)); break; case 4: __asm__ __volatile__("call __get_user_" "4" :"=a" (__ret_gu),"=d" (__val_gu) :"0" ((int *) optval)); break; default: __asm__ __volatile__("call __get_user_" "X" :"=a" (__ret_gu),"=d" (__val_gu) :"0" ((int *) optval)); break; } (val) = (__typeof__(*((int *) optval)))__val_gu; __ret_gu; }))
  return -14;
 ...
 case 1:
  if (val == 2) {
   ...
   if (sk->sk_protocol == IPPROTO_TCP) {
    ...
    local_bh_enable();
    sk->sk_prot = &global_tcp_prot[get_stack_id()];
    ...
    local_bh_enable();
    sk->sk_prot = &global_udp_prot[get_stack_id()];
 ...
 case 6:
 {
  ...
  opt = sock_kmalloc(sk, sizeof(*opt) + optlen, (0x10 | 0x40 | 0x80));
  retv = -105;
  if (opt == ((void *)0))
   break;
...
update:
 ...
 case 48:
 {
  typedef  int  _GLOBAL_338_T; extern  _GLOBAL_338_T  global_sysctl_optmem_max[NUM_STACKS];   
  typedef  int  _GLOBAL_339_T; extern  _GLOBAL_339_T  global_sysctl_mld_max_msf[NUM_STACKS];   
 ...
 default:
  retv = nf_setsockopt(sk, 10, optname, optval,
         optlen);
  break;
      ...
      char *optval, int *optlen)
{
 ...
 default:
  ...
  lock_sock(sk);
  val = nf_getsockopt(sk, 10, optname, optval,
        &len);
  release_sock(sk);
  if (val >= 0)
...
void   __attribute__((__used__)) __attribute__ ((__section__(".exit.text"))) ipv6_packet_cleanup(void)
{
