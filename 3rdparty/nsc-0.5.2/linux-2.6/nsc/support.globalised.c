# 1 "linux-2.6/nsc/support.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "linux-2.6/nsc/support.c"
# 19 "linux-2.6/nsc/support.c"
...
# 25 "linux-2.6/nsc/support.c" 2

# 1 "linux-2.6/include/linux/delay.h" 1
# 10 "linux-2.6/include/linux/delay.h"
typedef  unsigned long   _GLOBAL_209_T; extern  _GLOBAL_209_T  global_loops_per_jiffy[NUM_STACKS];    
...
typedef  struct vfsmount   _GLOBAL_305_T; extern  _GLOBAL_305_T  * global_proc_mnt[NUM_STACKS];    
...
typedef  struct file_operations   _GLOBAL_306_T; extern  _GLOBAL_306_T  global_proc_kcore_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_307_T; extern  _GLOBAL_307_T  global_proc_kmsg_operations[NUM_STACKS];    
typedef  struct file_operations   _GLOBAL_308_T; extern  _GLOBAL_308_T  global_ppc_htab_operations[NUM_STACKS];    
...
# 38 "linux-2.6/nsc/support.c" 2

# 1 "linux-2.6/nsc/../nsc/nsc.h" 1
# 26 "linux-2.6/nsc/../nsc/nsc.h"
...
typedef  struct proc_dir_entry   _GLOBAL_309_T; extern  _GLOBAL_309_T  * global_proc_net[NUM_STACKS]; extern  _GLOBAL_309_T  * global_proc_sys_root[NUM_STACKS];     
typedef  int  _GLOBAL_310_T; extern  _GLOBAL_310_T  global_nsc_g_l26_diagnostic[NUM_STACKS];   

void nsc_sysctl_a(void);
struct thread_info *nsc_get_current_thread_info(void);

typedef  struct task_struct  _GLOBAL_311_T;  _GLOBAL_311_T  * global_nsc_task[NUM_STACKS];   
...
void nsc_init(void)
{
    ...
    get_current()->cap_effective = 0xFFFFFFFF;
    get_current()->euid = 0;
    get_current()->thread_info = (struct thread_info *)nsc_malloc(sizeof(struct thread_info));
    (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(struct thread_info))) ? __constant_c_and_count_memset(((get_current()->thread_info)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct thread_info)))) : __constant_c_memset(((get_current()->thread_info)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct thread_info))))) : (__builtin_constant_p((sizeof(struct thread_info))) ? __memset_generic((((get_current()->thread_info))),(((0))),(((sizeof(struct thread_info))))) : __memset_generic(((get_current()->thread_info)),((0)),((sizeof(struct thread_info))))));
    get_current()->thread_info->addr_limit.seg = 0xFFFFFFFF;
...
struct thread_info *nsc_get_current_thread_info()
{
    return global_nsc_task[get_stack_id()]->thread_info;
}

typedef  unsigned long    _GLOBAL_312_T; extern volatile  _GLOBAL_312_T  global_jiffies[NUM_STACKS];     
...
static int nsc_if_xmit(struct sk_buff *skb, struct net_device *dev)
{
    ...
    packetbuf = (unsigned char *)skb->nh.iph;
...
void nsc_netdev_setup(struct net_device *a)
{
...
void *nsc_newif(unsigned int addr, unsigned int mask, int mtu)
{
    ...
    ifp = alloc_netdev(0, "sa%d", &nsc_netdev_setup);
...
void nsc_soconnect(void *so, unsigned int dest, unsigned short port)
{
    ...
    error = sock->ops->connect(sock, (struct sockaddr *)&addr, addrlen, 04000);
...
int nsc_accept(void *so, void **a)
{
    ...
    error = sock->ops->accept(sock, newsock, 04000);
...
# 484 "linux-2.6/nsc/support.c"
void nsc_add_default_gw(unsigned int gw_addr)
{
# 589 "linux-2.6/nsc/support.c"
    struct rtentry
    {
        ...
        void *newval, size_t newlen)
{
    ...
    do {
        ...
        if(strncmp(s, "net/", 4) == 0) {
            ...
            name[nlen++] = NET_CORE;
        } else if(strncmp(s, "tcp_westwood", 12) == 0) {
            name[nlen++] = NET_TCP_WESTWOOD;
