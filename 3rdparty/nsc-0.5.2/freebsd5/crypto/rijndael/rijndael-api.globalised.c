# 1 "freebsd5/crypto/rijndael/rijndael-api.c"
...
# 1 "<command-line>" 2
# 1 "freebsd5/crypto/rijndael/rijndael-api.c"
# 29 "freebsd5/crypto/rijndael/rijndael-api.c"
# 1 "freebsd5/freebsd/usr/src/sys/sys/cdefs.h" 1
# 30 "freebsd5/crypto/rijndael/rijndael-api.c" 2
#include "num_stacks.h"
__asm__(".ident\t\"" "$FreeBSD: src/sys/crypto/rijndael/rijndael-api.c,v 1.1 2003/11/12 04:22:37 ume Exp $" "\"");
...
# 33 "freebsd5/crypto/rijndael/rijndael-api.c" 2
...
void DELAY(int usec);
# 34 "freebsd5/crypto/rijndael/rijndael-api.c" 2
...
# 36 "freebsd5/crypto/rijndael/rijndael-api.c" 2

void
_rijndael_set_key(rijndael_ctx *ctx, const u_char *key, int bits)
{
...
void
_rijndael_decrypt(const rijndael_ctx *ctx, const u_char *src, u_char *dst)
{
...
void
_rijndael_encrypt(const rijndael_ctx *ctx, const u_char *src, u_char *dst)
{
