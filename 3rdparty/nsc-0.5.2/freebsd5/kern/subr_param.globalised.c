...
# 1 "<command-line>" 2
# 1 "freebsd5/kern/subr_param.c"
# 37 "freebsd5/kern/subr_param.c"
# 1 "freebsd5/freebsd/usr/src/sys/sys/cdefs.h" 1
# 38 "freebsd5/kern/subr_param.c" 2
#include "num_stacks.h"
__asm__(".ident\t\"" "$FreeBSD: src/sys/kern/subr_param.c,v 1.64 2004/04/05 21:03:35 imp Exp $" "\"");

# 1 "freebsd5/freebsd/usr/obj/usr/src/sys/GENERIC/opt_param.h" 1
# 41 "freebsd5/kern/subr_param.c" 2
# 1 "freebsd5/freebsd/usr/obj/usr/src/sys/GENERIC/opt_maxusers.h" 1
# 42 "freebsd5/kern/subr_param.c" 2
...
# 44 "freebsd5/kern/subr_param.c" 2
...
void DELAY(int usec);
# 45 "freebsd5/kern/subr_param.c" 2
...
# 46 "freebsd5/kern/subr_param.c" 2

# 1 "freebsd5/freebsd/usr/obj/usr/src/sys/GENERIC/machine/vmparam.h" 1
# 48 "freebsd5/kern/subr_param.c" 2
# 68 "freebsd5/kern/subr_param.c"
typedef  int _GLOBAL_56_T;  _GLOBAL_56_T  global_hz[NUM_STACKS];  
typedef  int _GLOBAL_57_T;  _GLOBAL_57_T  global_tick[NUM_STACKS];  
typedef  int _GLOBAL_58_T;  _GLOBAL_58_T  global_maxusers[NUM_STACKS];  
typedef  int _GLOBAL_59_T;  _GLOBAL_59_T  global_maxproc[NUM_STACKS];  
typedef  int _GLOBAL_60_T;  _GLOBAL_60_T  global_maxprocperuid[NUM_STACKS];  
typedef  int _GLOBAL_61_T;  _GLOBAL_61_T  global_maxfiles[NUM_STACKS];  
typedef  int _GLOBAL_62_T;  _GLOBAL_62_T  global_maxfilesperproc[NUM_STACKS];  
typedef  int _GLOBAL_63_T;  _GLOBAL_63_T  global_ncallout[NUM_STACKS];  
typedef  int _GLOBAL_64_T;  _GLOBAL_64_T  global_nbuf[NUM_STACKS];  
typedef  int _GLOBAL_65_T;  _GLOBAL_65_T  global_nswbuf[NUM_STACKS];  
typedef  int _GLOBAL_66_T;  _GLOBAL_66_T  global_maxswzone[NUM_STACKS];  
typedef  int _GLOBAL_67_T;  _GLOBAL_67_T  global_maxbcache[NUM_STACKS];  
typedef  int _GLOBAL_68_T;  _GLOBAL_68_T  global_maxpipekva[NUM_STACKS];  
typedef  u_quad_t _GLOBAL_69_T;  _GLOBAL_69_T  global_maxtsiz[NUM_STACKS];  
typedef  u_quad_t _GLOBAL_70_T;  _GLOBAL_70_T  global_dfldsiz[NUM_STACKS];  
typedef  u_quad_t _GLOBAL_71_T;  _GLOBAL_71_T  global_maxdsiz[NUM_STACKS];  
typedef  u_quad_t _GLOBAL_72_T;  _GLOBAL_72_T  global_dflssiz[NUM_STACKS];  
typedef  u_quad_t _GLOBAL_73_T;  _GLOBAL_73_T  global_maxssiz[NUM_STACKS];  
typedef  u_quad_t _GLOBAL_74_T;  _GLOBAL_74_T  global_sgrowsiz[NUM_STACKS];  
...
typedef  struct buf  _GLOBAL_75_T;  _GLOBAL_75_T  * global_swbuf[NUM_STACKS];   
...
init_param1(void)
{
    ...
    global_ticks[get_stack_id()] = global_softticks[get_stack_id()] = 1;




 getenv_int(("kern.hz"), (&global_hz[get_stack_id()]));
 global_tick[get_stack_id()] = 1000000 / global_hz[get_stack_id()];


 global_maxswzone[get_stack_id()] = (32 * 1024 * 1024);

 getenv_int(("kern.maxswzone"), (&global_maxswzone[get_stack_id()]));

 global_maxbcache[get_stack_id()] = (200 * 1024 * 1024);

 getenv_int(("kern.maxbcache"), (&global_maxbcache[get_stack_id()]));

 global_maxtsiz[get_stack_id()] = (128UL*1024*1024);
 getenv_quad(("kern.maxtsiz"), (&global_maxtsiz[get_stack_id()]));
 global_dfldsiz[get_stack_id()] = (128UL*1024*1024);
 getenv_quad(("kern.dfldsiz"), (&global_dfldsiz[get_stack_id()]));
 global_maxdsiz[get_stack_id()] = (512UL*1024*1024);
 getenv_quad(("kern.maxdsiz"), (&global_maxdsiz[get_stack_id()]));
 global_dflssiz[get_stack_id()] = (8UL*1024*1024);
 getenv_quad(("kern.dflssiz"), (&global_dflssiz[get_stack_id()]));
 global_maxssiz[get_stack_id()] = (64UL*1024*1024);
 getenv_quad(("kern.maxssiz"), (&global_maxssiz[get_stack_id()]));
 global_sgrowsiz[get_stack_id()] = (128UL*1024);
 getenv_quad(("kern.sgrowsiz"), (&global_sgrowsiz[get_stack_id()]));
}
...
init_param2(long physpages)
{
 ...
 global_maxusers[get_stack_id()] = 0;
 getenv_int(("kern.maxusers"), (&global_maxusers[get_stack_id()]));
 if (global_maxusers[get_stack_id()] == 0) {
  global_maxusers[get_stack_id()] = physpages / (2 * 1024 * 1024 / (1<<12));
  if (global_maxusers[get_stack_id()] < 32)
   global_maxusers[get_stack_id()] = 32;
  if (global_maxusers[get_stack_id()] > 384)
   global_maxusers[get_stack_id()] = 384;
 }
 ...
 global_maxproc[get_stack_id()] = (20 + 16 * global_maxusers[get_stack_id()]);
 getenv_int(("kern.maxproc"), (&global_maxproc[get_stack_id()]));




 if (global_maxproc[get_stack_id()] > (physpages / 12))
  global_maxproc[get_stack_id()] = physpages / 12;
 global_maxfiles[get_stack_id()] = (global_maxproc[get_stack_id()] * 2);
 getenv_int(("kern.maxfiles"), (&global_maxfiles[get_stack_id()]));
 global_maxprocperuid[get_stack_id()] = (global_maxproc[get_stack_id()] * 9) / 10;
 global_maxfilesperproc[get_stack_id()] = (global_maxfiles[get_stack_id()] * 9) / 10;




 global_nbuf[get_stack_id()] = 0;
 getenv_int(("kern.nbuf"), (&global_nbuf[get_stack_id()]));

 global_ncallout[get_stack_id()] = 16 + global_maxproc[get_stack_id()] + global_maxfiles[get_stack_id()];
 getenv_int(("kern.ncallout"), (&global_ncallout[get_stack_id()]));
}
...
init_param3(long kmempages)
{
 ...
 global_maxpipekva[get_stack_id()] = (kmempages / 20) * (1<<12);
 if (global_maxpipekva[get_stack_id()] < 512 * 1024)
  global_maxpipekva[get_stack_id()] = 512 * 1024;
 getenv_int(("kern.ipc.maxpipekva"), (&global_maxpipekva[get_stack_id()]));
}
