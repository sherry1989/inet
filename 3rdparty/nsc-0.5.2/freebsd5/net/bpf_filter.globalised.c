...
# 40 "freebsd5/net/bpf_filter.c" 2
# 65 "freebsd5/net/bpf_filter.c"
...
# 66 "freebsd5/net/bpf_filter.c" 2
...
# 68 "freebsd5/net/bpf_filter.c" 2
# 82 "freebsd5/net/bpf_filter.c"
 ...
 register int *err;
{
 ...
 if (len - k >= 2) {
  *err = 0;
  return ((u_int16_t)__bswap16(*(u_int16_t *)cp));
 }
 m0 = m->m_hdr.mh_next;
 if (m0 == 0)
  goto bad;
 ...
 register u_int buflen;
{
 ...
 while (1) {
  ...
  case 0x00|0x08|0x20:
   ...
   A = ((u_int16_t)__bswap16(*(u_int16_t *)&p[k]));
   continue;
  ...
  case 0x00|0x10|0x20:
   ...
   if (k >= buflen) {
    ...
    if (buflen != 0)
     return 0;
    m = (struct mbuf *)p;
    { register int len = m->m_hdr.mh_len; while (k >= len) { k -= len; m = m->m_hdr.mh_next; if (m == 0) return 0; len = m->m_hdr.mh_len; } };
