...
# 1 "<command-line>" 2
# 1 "freebsd5/net/if_ef.c"
# 29 "freebsd5/net/if_ef.c"
# 1 "freebsd5/freebsd/usr/obj/usr/src/sys/GENERIC/opt_inet.h" 1
# 30 "freebsd5/net/if_ef.c" 2
# 1 "freebsd5/freebsd/usr/obj/usr/src/sys/GENERIC/opt_ipx.h" 1
# 31 "freebsd5/net/if_ef.c" 2
# 1 "freebsd5/freebsd/usr/obj/usr/src/sys/GENERIC/opt_ef.h" 1
# 32 "freebsd5/net/if_ef.c" 2
...
# 39 "freebsd5/net/if_ef.c" 2
# 1 "freebsd5/freebsd/usr/src/sys/sys/syslog.h" 1
# 40 "freebsd5/net/if_ef.c" 2
...
# 48 "freebsd5/net/if_ef.c" 2
# 1 "freebsd5/net/if_types.h" 1
# 49 "freebsd5/net/if_ef.c" 2
...
# 57 "freebsd5/net/if_ef.c" 2
# 79 "freebsd5/net/if_ef.c"
struct efnet {
 struct arpcom ef_ac;
 struct ifnet * ef_ifp;
 int ef_frametype;
...
struct ef_link {
 struct { struct ef_link *sle_next; } el_next;
 struct ifnet *el_ifp;
 struct efnet *el_units[4];
};

typedef  struct ef_link_head { struct ef_link   * slh_first  ;  }   _GLOBAL_141_T; static  _GLOBAL_141_T  global_efdev[NUM_STACKS] = {  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  { ( ( void *  ) 0  )  } ,  };            
typedef  int  _GLOBAL_142_T; static  _GLOBAL_142_T  global_efcount[NUM_STACKS];   

typedef  int   ( *_GLOBAL_144_T  )  ( struct ifnet   *  , struct ether_header   * eh    , struct mbuf   * m    ) ; extern  _GLOBAL_144_T global_ef_inputp[NUM_STACKS];          
typedef  int   ( *_GLOBAL_146_T  )  ( struct ifnet   * ifp   , struct mbuf   * *  mp    , struct sockaddr   * dst    , short  * tp    , int  * hlen    ) ; extern  _GLOBAL_146_T global_ef_outputp[NUM_STACKS];        
...
ef_attach(struct efnet *sc)
{
 ...
 ifa2 = global_ifindex_table[get_stack_id()][(sc->ef_ifp->if_index)].ife_ifnet_addr;
 sdl2 = (struct sockaddr_dl *)ifa2->ifa_addr;
 ether_ifattach(ifp, ((caddr_t)((sdl2)->sdl_data + (sdl2)->sdl_nlen)));

 ifp->if_resolvemulti = 0;
 ifp->if_data.ifi_type = 0x1a;
 ifp->if_flags |= 0x40;

 bcopy(((caddr_t)((sdl2)->sdl_data + (sdl2)->sdl_nlen)), sc->ef_ac.ac_enaddr, 6);
...
ef_ioctl(struct ifnet *ifp, u_long cmd, caddr_t data)
{
 ...
 switch (cmd) {
  ...
  if (sc->ef_frametype == 1 &&
      ifa->ifa_addr->sa_family != 23) {
   error = 47;
   break;
  }
  ifp->if_flags |= 0x1;
...
ef_input(struct ifnet *ifp, struct ether_header *eh, struct mbuf *m)
{
 ...
 if (ether_type < (1518 -(6*2+2)-4)) {
  ...
  if (l->llc_dsap == 0xff && l->llc_ssap == 0xff) {
   ...
   ft = 3;
   ether_type = __bswap16(l->llc_un.type_snap.ether_type);
 ...
 efp = ((void *)0);
 for ((efl) = (((&global_efdev[get_stack_id()]))->slh_first); (efl); (efl) = (((efl))->el_next.sle_next)) {
  if (efl->el_ifp == ifp) {
   efp = efl->el_units[ft];
   break;
  }
 ...
 if ((eifp->if_flags & 0x1) == 0)
  return 43;
 eifp->if_data.ifi_ibytes += m->M_dat.MH.MH_pkthdr.len + sizeof (*eh);
 m->M_dat.MH.MH_pkthdr.rcvif = eifp;

 do { if ((eifp)->if_bpf) { ; bpf_mtap2((eifp)->if_bpf,(eh),((6*2+2)),(m)); } } while (0);
 ...
 int *hlen)
{
  ...
  *hlen += 3;
  break;
     case 3:
  do { struct mbuf **_mmp = &(m); struct mbuf *_mm = *_mmp; int _mplen = (8); int __mhow = (0x0002); ; if (((_mm)->m_hdr.mh_flags & 0x0001 ? ((!((_mm)->m_hdr.mh_flags & 0x0008) && (!((_mm)->m_hdr.mh_flags & 0x0001) || !(((_mm)->M_dat.MH.MH_dat.MH_ext.ref_cnt != ((void *)0)) && (*((_mm)->M_dat.MH.MH_dat.MH_ext.ref_cnt) > 1)))) ? (_mm)->m_hdr.mh_data - (_mm)->M_dat.MH.MH_dat.MH_ext.ext_buf : 0): (_mm)->m_hdr.mh_flags & 0x0002 ? (_mm)->m_hdr.mh_data - (_mm)->M_dat.MH.MH_dat.MH_databuf : (_mm)->m_hdr.mh_data - (_mm)->M_dat.M_databuf) >= _mplen) { _mm->m_hdr.mh_data -= _mplen; _mm->m_hdr.mh_len += _mplen; } else _mm = m_prepend(_mm, _mplen, __mhow); if (_mm != ((void *)0) && _mm->m_hdr.mh_flags & 0x0002) _mm->M_dat.MH.MH_pkthdr.len += _mplen; *_mmp = _mm; } while (0);
  if (m == ((void *)0)) {
   *mp = ((void *)0);
   return 55;
  }
...
ef_clone(struct ef_link *efl, int ft)
{
 ...
 efp = (struct efnet*)nsc_malloc(sizeof(struct efnet), (*_GLOBAL_M_IFADDR_23_A[get_stack_id()]),
     0x0002 | 0x0100);
 if (efp == ((void *)0))
  return 12;
 efp->ef_ifp = ifp;
...
ef_load(void)
{
 struct ifnet *ifp;
 struct efnet *efp;
 struct ef_link *efl = ((void *)0);
 int error = 0, d;

 do { struct thread *_tid = (global___pcpu[get_stack_id()].pc_curthread); if (!atomic_cmpset_ptr(&((((&global_ifnet_lock[get_stack_id()]))))->mtx_lock, (void *)0x00000004, (_tid))) _mtx_lock_sleep((((&global_ifnet_lock[get_stack_id()]))), _tid, ((0)), (((void *)0)), (0)); } while (0);
 for ((ifp) = (((&global_ifnet[get_stack_id()]))->tqh_first); (ifp); (ifp) = (((ifp))->if_link.tqe_next)) {
  if (ifp->if_data.ifi_type != 0x6) continue;
  ;
  efl = (struct ef_link*)nsc_malloc(sizeof(struct ef_link),
      (*_GLOBAL_M_IFADDR_23_A[get_stack_id()]), 0x0002 | 0x0100);
  if (efl == ((void *)0)) {
   error = 12;
   break;
  }
  ...
  efl->el_ifp = ifp;
# 530 "freebsd5/net/if_ef.c"
  global_efcount[get_stack_id()]++;
  do { (((efl))->el_next.sle_next) = (((&global_efdev[get_stack_id()]))->slh_first); (((&global_efdev[get_stack_id()]))->slh_first) = (efl); } while (0);
 }
 do { if (!atomic_cmpset_ptr(&((((&global_ifnet_lock[get_stack_id()]))))->mtx_lock, ((global___pcpu[get_stack_id()].pc_curthread)), (void *)0x00000004)) _mtx_unlock_sleep((((&global_ifnet_lock[get_stack_id()]))), ((0)), (((void *)0)), (0)); } while (0);
 if (error) {
  if (efl)
  ...
  for ((efl) = (((&global_efdev[get_stack_id()]))->slh_first); (efl); (efl) = (((efl))->el_next.sle_next)) {
   for (d = 0; d < 4; d++)
    if (efl->el_units[d])
     nsc_free(efl->el_units[d], (*_GLOBAL_M_IFADDR_23_A[get_stack_id()]));
   nsc_free(efl, (*_GLOBAL_M_IFADDR_23_A[get_stack_id()]));
  }
  return error;
 }
 for ((efl) = (((&global_efdev[get_stack_id()]))->slh_first); (efl); (efl) = (((efl))->el_next.sle_next)) {
 ...
 global_ef_inputp[get_stack_id()] = ef_input;
 global_ef_outputp[get_stack_id()] = ef_output;
 ;
 return 0;
}
...
ef_unload(void)
{
 ...
 global_ef_inputp[get_stack_id()] = ((void *)0);
 global_ef_outputp[get_stack_id()] = ((void *)0);
 for ((efl) = (((&global_efdev[get_stack_id()]))->slh_first); (efl); (efl) = (((efl))->el_next.sle_next)) {
  for (d = 0; d < 4; d++) {
   efp = efl->el_units[d];
   if (efp) {
...
typedef  moduledata_t  _GLOBAL_147_T; static  _GLOBAL_147_T  global_if_ef_mod[NUM_STACKS] = {  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  { "if_ef" , if_ef_modevent  , ( ( void *  ) 0  )   } ,  };     
    


typedef  struct mod_metadata   _GLOBAL_148_T; static  _GLOBAL_148_T  global__mod_metadata_md_if_ef[NUM_STACKS] = {  { 1 , 2  , & global_if_ef_mod[0]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[1]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[2]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[3]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[4]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[5]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[6]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[7]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[8]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[9]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[10]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[11]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[12]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[13]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[14]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[15]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[16]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[17]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[18]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[19]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[20]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[21]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[22]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[23]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[24]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[25]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[26]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[27]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[28]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[29]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[30]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[31]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[32]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[33]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[34]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[35]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[36]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[37]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[38]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[39]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[40]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[41]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[42]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[43]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[44]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[45]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[46]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[47]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[48]   , "if_ef"  } ,  { 1 , 2  , & global_if_ef_mod[49]   , "if_ef"  } ,  };            typedef  void const   _GLOBAL_149_T; static  _GLOBAL_149_T  * const  _global_section_0___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_0_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[0] ;static  _GLOBAL_149_T  * const  _global_section_1___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_1_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[1] ;static  _GLOBAL_149_T  * const  _global_section_2___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_2_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[2] ;static  _GLOBAL_149_T  * const  _global_section_3___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_3_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[3] ;static  _GLOBAL_149_T  * const  _global_section_4___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_4_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[4] ;static  _GLOBAL_149_T  * const  _global_section_5___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_5_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[5] ;static  _GLOBAL_149_T  * const  _global_section_6___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_6_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[6] ;static  _GLOBAL_149_T  * const  _global_section_7___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_7_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[7] ;static  _GLOBAL_149_T  * const  _global_section_8___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_8_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[8] ;static  _GLOBAL_149_T  * const  _global_section_9___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_9_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[9] ;static  _GLOBAL_149_T  * const  _global_section_10___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_10_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[10] ;static  _GLOBAL_149_T  * const  _global_section_11___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_11_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[11] ;static  _GLOBAL_149_T  * const  _global_section_12___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_12_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[12] ;static  _GLOBAL_149_T  * const  _global_section_13___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_13_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[13] ;static  _GLOBAL_149_T  * const  _global_section_14___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_14_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[14] ;static  _GLOBAL_149_T  * const  _global_section_15___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_15_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[15] ;static  _GLOBAL_149_T  * const  _global_section_16___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_16_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[16] ;static  _GLOBAL_149_T  * const  _global_section_17___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_17_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[17] ;static  _GLOBAL_149_T  * const  _global_section_18___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_18_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef[18] ;static  _GLOBAL_149_T  * const  _global_section_19___set_modmetadata_set_sym__mod_metadata_md_if_ef __attribute__((__section__("set_" "modmetadata_set" "_global_section_19_")) ) __attribute__((__used__))   =  & global__mod_metadata_md_if_ef