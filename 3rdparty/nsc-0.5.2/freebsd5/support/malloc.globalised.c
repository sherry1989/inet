...
# 20 "freebsd5/support/malloc.c" 2
...
# 23 "freebsd5/support/malloc.c" 2
...
# 35 "freebsd5/support/malloc.c" 2
# 45 "freebsd5/support/malloc.c"
...
void *nsc_realloc(void *addr, unsigned long size, struct malloc_type *type,
  ...
  if ((newaddr = nsc_malloc(size, type, flags)) == ((void *)0))
    return (((void *)0));
