...
# 37 "freebsd5/netinet6/dest6.c" 2
...
void DELAY(int usec);
# 38 "freebsd5/netinet6/dest6.c" 2
...
void *reallocf(void *addr, unsigned long size, struct malloc_type *type,
     int flags);
# 39 "freebsd5/netinet6/dest6.c" 2
...
# 40 "freebsd5/netinet6/dest6.c" 2
...
# 41 "freebsd5/netinet6/dest6.c" 2
...
# 42 "freebsd5/netinet6/dest6.c" 2
...
# 43 "freebsd5/netinet6/dest6.c" 2
...
# 46 "freebsd5/netinet6/dest6.c" 2
...
# 48 "freebsd5/netinet6/dest6.c" 2
...
# 49 "freebsd5/netinet6/dest6.c" 2
...
# 51 "freebsd5/netinet6/dest6.c" 2
...
# 52 "freebsd5/netinet6/dest6.c" 2
...
# 53 "freebsd5/netinet6/dest6.c" 2
...
# 54 "freebsd5/netinet6/dest6.c" 2
...
# 55 "freebsd5/netinet6/dest6.c" 2
 ...
 int *offp, proto;
{
 ...
 do { if ((m)->m_hdr.mh_next != ((void *)0)) { if (((m)->m_hdr.mh_flags & 0x0080) && ((m)->m_hdr.mh_len < (off) + (sizeof(*dstopts))) && (((m) = m_pullup((m), (off) + (sizeof(*dstopts)))) == ((void *)0))) { global_ip6stat[get_stack_id()].ip6s_exthdrtoolong++; return 257; } else if ((m)->m_hdr.mh_flags & 0x0001) { if ((m)->m_hdr.mh_len < (off) + (sizeof(*dstopts))) { global_ip6stat[get_stack_id()].ip6s_exthdrtoolong++; m_freem(m); return 257; } } else { if ((m)->m_hdr.mh_len < (off) + (sizeof(*dstopts))) { global_ip6stat[get_stack_id()].ip6s_exthdrtoolong++; m_freem(m); return 257; } } } else { if ((m)->m_hdr.mh_len < (off) + (sizeof(*dstopts))) { global_ip6stat[get_stack_id()].ip6s_tooshort++; do { if (m->M_dat.MH.MH_pkthdr.rcvif) ((struct in6_ifextra *)((m->M_dat.MH.MH_pkthdr.rcvif)->if_afdata[28]))->in6_ifstat->ifs6_in_truncated++; } while ( 0); m_freem(m); return 257; } } } while ( 0);
 dstopts = (struct ip6_dest *)(((caddr_t)((m)->m_hdr.mh_data)) + off);
 ...
 do { if ((m)->m_hdr.mh_next != ((void *)0)) { if (((m)->m_hdr.mh_flags & 0x0080) && ((m)->m_hdr.mh_len < (off) + (dstoptlen)) && (((m) = m_pullup((m), (off) + (dstoptlen))) == ((void *)0))) { global_ip6stat[get_stack_id()].ip6s_exthdrtoolong++; return 257; } else if ((m)->m_hdr.mh_flags & 0x0001) { if ((m)->m_hdr.mh_len < (off) + (dstoptlen)) { global_ip6stat[get_stack_id()].ip6s_exthdrtoolong++; m_freem(m); return 257; } } else { if ((m)->m_hdr.mh_len < (off) + (dstoptlen)) { global_ip6stat[get_stack_id()].ip6s_exthdrtoolong++; m_freem(m); return 257; } } } else { if ((m)->m_hdr.mh_len < (off) + (dstoptlen)) { global_ip6stat[get_stack_id()].ip6s_tooshort++; do { if (m->M_dat.MH.MH_pkthdr.rcvif) ((struct in6_ifextra *)((m->M_dat.MH.MH_pkthdr.rcvif)->if_afdata[28]))->in6_ifstat->ifs6_in_truncated++; } while ( 0); m_freem(m); return 257; } } } while ( 0);
 dstopts = (struct ip6_dest *)(((caddr_t)((m)->m_hdr.mh_data)) + off);
