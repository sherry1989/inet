# 1 "freebsd5/netinet6/in6_cksum.c"
...
# 1 "<command-line>" 2
# 1 "freebsd5/netinet6/in6_cksum.c"
# 64 "freebsd5/netinet6/in6_cksum.c"
...
# 65 "freebsd5/netinet6/in6_cksum.c" 2
...
# 66 "freebsd5/netinet6/in6_cksum.c" 2
...
# 68 "freebsd5/netinet6/in6_cksum.c" 2
...
# 69 "freebsd5/netinet6/in6_cksum.c" 2

# 1 "freebsd5/net/net_osdep.h" 1
# 322 "freebsd5/net/net_osdep.h"
struct ifnet;
extern const char *if_name(struct ifnet *);
# 71 "freebsd5/netinet6/in6_cksum.c" 2
# 89 "freebsd5/netinet6/in6_cksum.c"
int
 ...
 u_int32_t off, len;
{
 ...
 for (;m && len; m = m->m_hdr.mh_next) {
  ...
  if (mlen == -1) {
# 230 "freebsd5/netinet6/in6_cksum.c"
   s_util.c[1] = *(char *)w;
   sum += s_util.s;
   w = (u_int16_t *)((char *)w + 1);
