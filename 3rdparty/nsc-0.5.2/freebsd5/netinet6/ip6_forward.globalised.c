# 1 "freebsd5/netinet6/ip6_forward.c"
...
# 39 "freebsd5/netinet6/ip6_forward.c" 2
...
void DELAY(int usec);
# 40 "freebsd5/netinet6/ip6_forward.c" 2
...
void *reallocf(void *addr, unsigned long size, struct malloc_type *type,
     int flags);
# 41 "freebsd5/netinet6/ip6_forward.c" 2
...
# 42 "freebsd5/netinet6/ip6_forward.c" 2
...
# 43 "freebsd5/netinet6/ip6_forward.c" 2
...
# 44 "freebsd5/netinet6/ip6_forward.c" 2
...
# 45 "freebsd5/netinet6/ip6_forward.c" 2
...
# 48 "freebsd5/netinet6/ip6_forward.c" 2
# 1 "freebsd5/freebsd/usr/src/sys/sys/syslog.h" 1
# 49 "freebsd5/netinet6/ip6_forward.c" 2
...
# 51 "freebsd5/netinet6/ip6_forward.c" 2
...
# 52 "freebsd5/netinet6/ip6_forward.c" 2
...
# 53 "freebsd5/netinet6/ip6_forward.c" 2
...
# 55 "freebsd5/netinet6/ip6_forward.c" 2
...
# 56 "freebsd5/netinet6/ip6_forward.c" 2
...
n_time iptime(void);
# 57 "freebsd5/netinet6/ip6_forward.c" 2
...
# 58 "freebsd5/netinet6/ip6_forward.c" 2
...
typedef  struct pfil_head   _GLOBAL_161_T; extern  _GLOBAL_161_T  global_inet_pfil_hook[NUM_STACKS];    
...
# 59 "freebsd5/netinet6/ip6_forward.c" 2
...
# 61 "freebsd5/netinet6/ip6_forward.c" 2
...
typedef  struct pfil_head   _GLOBAL_192_T; extern  _GLOBAL_192_T  global_inet6_pfil_hook[NUM_STACKS];    
...
# 62 "freebsd5/netinet6/ip6_forward.c" 2
...
typedef  int  _GLOBAL_194_T; extern  _GLOBAL_194_T  global_icmp6_rediraccept[NUM_STACKS];   
typedef  int  _GLOBAL_195_T; extern  _GLOBAL_195_T  global_icmp6_redirtimeout[NUM_STACKS];   
# 63 "freebsd5/netinet6/ip6_forward.c" 2
...
typedef  int  _GLOBAL_196_T; extern  _GLOBAL_196_T  global_nd6_prune[NUM_STACKS];   
typedef  int  _GLOBAL_197_T; extern  _GLOBAL_197_T  global_nd6_delay[NUM_STACKS];   
typedef  int  _GLOBAL_198_T; extern  _GLOBAL_198_T  global_nd6_umaxtries[NUM_STACKS];   
typedef  int  _GLOBAL_199_T; extern  _GLOBAL_199_T  global_nd6_mmaxtries[NUM_STACKS];   
typedef  int  _GLOBAL_200_T; extern  _GLOBAL_200_T  global_nd6_useloopback[NUM_STACKS];   
typedef  int  _GLOBAL_201_T; extern  _GLOBAL_201_T  global_nd6_maxnudhint[NUM_STACKS];   
typedef  int  _GLOBAL_202_T; extern  _GLOBAL_202_T  global_nd6_gctimer[NUM_STACKS];   
typedef  struct llinfo_nd6   _GLOBAL_203_T; extern  _GLOBAL_203_T  global_llinfo_nd6[NUM_STACKS];    
typedef  struct nd_ifinfo   _GLOBAL_204_T; extern  _GLOBAL_204_T  * global_nd_ifinfo[NUM_STACKS];    
typedef  struct nd_drhead   _GLOBAL_205_T; extern  _GLOBAL_205_T  global_nd_defrouter[NUM_STACKS];    
typedef  struct nd_prhead   _GLOBAL_206_T; extern  _GLOBAL_206_T  global_nd_prefix[NUM_STACKS];    
typedef  int  _GLOBAL_207_T; extern  _GLOBAL_207_T  global_nd6_debug[NUM_STACKS];   



typedef  struct callout   _GLOBAL_208_T; extern  _GLOBAL_208_T  global_nd6_timer_ch[NUM_STACKS];    


typedef  int  _GLOBAL_209_T; extern  _GLOBAL_209_T  global_nd6_defifindex[NUM_STACKS];   
typedef  int  _GLOBAL_210_T; extern  _GLOBAL_210_T  global_ip6_desync_factor[NUM_STACKS];   
typedef  u_int32_t  _GLOBAL_211_T; extern  _GLOBAL_211_T  global_ip6_temp_preferred_lifetime[NUM_STACKS];   
typedef  u_int32_t  _GLOBAL_212_T; extern  _GLOBAL_212_T  global_ip6_temp_valid_lifetime[NUM_STACKS];   
typedef  int  _GLOBAL_213_T; extern  _GLOBAL_213_T  global_ip6_temp_regen_advance[NUM_STACKS];   
...
# 64 "freebsd5/netinet6/ip6_forward.c" 2
...
typedef  int  _GLOBAL_214_T; extern  _GLOBAL_214_T  global_ipport_lowfirstauto[NUM_STACKS];   
typedef  int  _GLOBAL_215_T; extern  _GLOBAL_215_T  global_ipport_lowlastauto[NUM_STACKS];   
typedef  int  _GLOBAL_216_T; extern  _GLOBAL_216_T  global_ipport_firstauto[NUM_STACKS];   
typedef  int  _GLOBAL_217_T; extern  _GLOBAL_217_T  global_ipport_lastauto[NUM_STACKS];   
typedef  int  _GLOBAL_218_T; extern  _GLOBAL_218_T  global_ipport_hifirstauto[NUM_STACKS];   
typedef  int  _GLOBAL_219_T; extern  _GLOBAL_219_T  global_ipport_hilastauto[NUM_STACKS];   
...
# 66 "freebsd5/netinet6/ip6_forward.c" 2
# 82 "freebsd5/netinet6/ip6_forward.c"
...
typedef  ip6_fw_chk_t  _GLOBAL_220_T; extern  _GLOBAL_220_T  * global_ip6_fw_chk_ptr[NUM_STACKS];   
typedef  ip6_fw_ctl_t  _GLOBAL_221_T; extern  _GLOBAL_221_T  * global_ip6_fw_ctl_ptr[NUM_STACKS];   
typedef  int  _GLOBAL_222_T; extern  _GLOBAL_222_T  global_ip6_fw_enable[NUM_STACKS];   
# 83 "freebsd5/netinet6/ip6_forward.c" 2

# 1 "freebsd5/net/net_osdep.h" 1
# 322 "freebsd5/net/net_osdep.h"
struct ifnet;
extern const char *if_name(struct ifnet *);
# 85 "freebsd5/netinet6/ip6_forward.c" 2
...
typedef  struct ip6protosw   _GLOBAL_223_T; extern  _GLOBAL_223_T  _GLOBAL_0_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_1_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_2_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_3_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_4_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_5_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_6_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_7_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_8_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_9_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_10_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_11_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_12_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_13_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_14_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_15_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_16_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_17_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_18_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_19_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_20_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_21_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_22_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_23_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_24_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_25_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_26_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_27_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_28_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_29_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_30_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_31_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_32_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_33_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_34_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_35_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_36_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_37_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_38_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_39_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_40_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_41_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_42_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_43_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_44_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_45_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_46_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_47_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_48_inet6sw_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_49_inet6sw_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_inet6sw_I) *_GLOBAL_inet6sw_37_A[NUM_STACKS];   
# 87 "freebsd5/netinet6/ip6_forward.c" 2

typedef  struct route_in6  _GLOBAL_224_T;  _GLOBAL_224_T  global_ip6_forward_rt[NUM_STACKS];   
# 103 "freebsd5/netinet6/ip6_forward.c"
void
ip6_forward(m, srcrt)
 struct mbuf *m;
 int srcrt;
{
 ...
 struct sockaddr_in6 *dst = ((void *)0);
 struct rtentry *rt = ((void *)0);
 int error, type = 0, code = 0;
 struct mbuf *mcopy = ((void *)0);
 struct ifnet *origifp;
 u_int32_t srczone, dstzone;
# 143 "freebsd5/netinet6/ip6_forward.c"
 if ((m->m_hdr.mh_flags & (0x0200|0x0400)) != 0 ||
...
# 179 "freebsd5/netinet6/ip6_forward.c"
 mcopy = m_copym((m), (0), (imin(m->M_dat.MH.MH_pkthdr.len, 1232)), 0x0001);
# 350 "freebsd5/netinet6/ip6_forward.c"
 dst = (struct sockaddr_in6 *)&global_ip6_forward_rt[get_stack_id()].ro_dst;
 if (!srcrt) {
  ...
  if (global_ip6_forward_rt[get_stack_id()].ro_rt == 0) {
   ...
   do { if (m->M_dat.MH.MH_pkthdr.rcvif) ((struct in6_ifextra *)((m->M_dat.MH.MH_pkthdr.rcvif)->if_afdata[28]))->in6_ifstat->ifs6_in_noroute++; } while ( 0);
   if (mcopy) {
    icmp6_error(mcopy, 1,
         0, 0);
   }
...
# 409 "freebsd5/netinet6/ip6_forward.c"
 ...
 if (srczone != dstzone
  ...
  global_ip6stat[get_stack_id()].ip6s_cantforward++;
  global_ip6stat[get_stack_id()].ip6s_badscope++;
  do { if (rt->rt_ifp) ((struct in6_ifextra *)((rt->rt_ifp)->if_afdata[28]))->in6_ifstat->ifs6_in_discard++; } while ( 0);
 ...
 if (m->M_dat.MH.MH_pkthdr.len > (((((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->linkmtu && (((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->linkmtu < (rt->rt_ifp)->if_data.ifi_mtu) ? (((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->linkmtu : (((((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->maxmtu && (((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->maxmtu < (rt->rt_ifp)->if_data.ifi_mtu) ? (((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->maxmtu : (rt->rt_ifp)->if_data.ifi_mtu))) {
  do { if (rt->rt_ifp) ((struct in6_ifextra *)((rt->rt_ifp)->if_afdata[28]))->in6_ifstat->ifs6_in_toobig++; } while ( 0);
  if (mcopy) {
   u_long mtu;
   ...
   mtu = (((((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->linkmtu && (((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->linkmtu < (rt->rt_ifp)->if_data.ifi_mtu) ? (((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->linkmtu : (((((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->maxmtu && (((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->maxmtu < (rt->rt_ifp)->if_data.ifi_mtu) ? (((struct in6_ifextra *)(rt->rt_ifp)->if_afdata[28])->nd_ifinfo)->maxmtu : (rt->rt_ifp)->if_data.ifi_mtu));
# 478 "freebsd5/netinet6/ip6_forward.c"
...
# 496 "freebsd5/netinet6/ip6_forward.c"
 if (rt->rt_ifp == m->M_dat.MH.MH_pkthdr.rcvif && !srcrt &&



     (rt->rt_flags & (0x10|0x20)) == 0) {
  if ((rt->rt_ifp->if_flags & 0x10) != 0) {
# 512 "freebsd5/netinet6/ip6_forward.c"
   icmp6_error(mcopy, 1,
        3, 0);
   m_freem(m);
   return;
 ...
 if (global_ip6_fw_enable[get_stack_id()] && global_ip6_fw_chk_ptr[get_stack_id()]) {
  ...
  if ((*global_ip6_fw_chk_ptr[get_stack_id()])(&ip6, rt->rt_ifp, &port, &m)) {
   m_freem(m);
   goto freecopy;
  }
  if (!m)
...
# 542 "freebsd5/netinet6/ip6_forward.c"
 if ((rt->rt_ifp->if_flags & 0x8) != 0) {
# 553 "freebsd5/netinet6/ip6_forward.c"
  if (0)



  {
   nsc_printf("ip6_forward: outgoing interface is loopback. "
    "src %s, dst %s, nxt %d, rcvif %s, outif %s\n",
    ip6_sprintf(&ip6->ip6_src),
    ip6_sprintf(&ip6->ip6_dst),
    ip6->ip6_ctlun.ip6_un1.ip6_un1_nxt, if_name(m->M_dat.MH.MH_pkthdr.rcvif),
    if_name(rt->rt_ifp));
  }
 ...
 error = pfil_run_hooks(&global_inet6_pfil_hook[get_stack_id()], &m, rt->rt_ifp, 0x00000002, ((void *)0));
 if (error != 0)
  goto senderr;
   if (m == ((void *)0))
    goto freecopy;
...
pass:
 ...
 if (error) {
  do { if (rt->rt_ifp) ((struct in6_ifextra *)((rt->rt_ifp)->if_afdata[28]))->in6_ifstat->ifs6_out_discard++; } while ( 0);
  global_ip6stat[get_stack_id()].ip6s_cantforward++;
 } else {
  global_ip6stat[get_stack_id()].ip6s_forward++;
  do { if (rt->rt_ifp) ((struct in6_ifextra *)((rt->rt_ifp)->if_afdata[28]))->in6_ifstat->ifs6_out_forward++; } while ( 0);
  if (type)
