...
# 1 "<command-line>" 2
# 1 "freebsd5/netinet/in_cksum.c"
# 33 "freebsd5/netinet/in_cksum.c"
...
# 34 "freebsd5/netinet/in_cksum.c" 2
...
# 35 "freebsd5/netinet/in_cksum.c" 2
# 46 "freebsd5/netinet/in_cksum.c"
int
in_cksum(m, len)
 ...
 register int len;
{
 ...
 for (;m && len; m = m->m_hdr.mh_next) {
  ...
  if (mlen == -1) {
# 78 "freebsd5/netinet/in_cksum.c"
   s_util.c[1] = *(char *)w;
   sum += s_util.s;
   w = (u_short *)((char *)w + 1);
