...
# 42 "freebsd5/netinet/ip_ecn.c" 2
...
void DELAY(int usec);
# 43 "freebsd5/netinet/ip_ecn.c" 2
...
# 44 "freebsd5/netinet/ip_ecn.c" 2
...
# 47 "freebsd5/netinet/ip_ecn.c" 2
...
n_time iptime(void);
# 48 "freebsd5/netinet/ip_ecn.c" 2
...
# 49 "freebsd5/netinet/ip_ecn.c" 2
...
# 51 "freebsd5/netinet/ip_ecn.c" 2
...
# 54 "freebsd5/netinet/ip_ecn.c" 2
...
# 56 "freebsd5/netinet/ip_ecn.c" 2
# 92 "freebsd5/netinet/ip_ecn.c"
void
 ...
 const u_int32_t *inner;
{
 ...
 inner8 = (__bswap32(*inner) >> 20) & 0xff;
 ip_ecn_ingress(mode, &outer8, &inner8);
 *outer &= ~__bswap32(0xff << 20);
 *outer |= __bswap32((u_int32_t)outer8 << 20);
}
 ...
 u_int32_t *inner;
{
 ...
 outer8 = (__bswap32(*outer) >> 20) & 0xff;
 inner8 = oinner8 = (__bswap32(*inner) >> 20) & 0xff;
 if (ip_ecn_egress(mode, &outer8, &inner8) == 0)
  return (0);
 if (inner8 != oinner8) {
 *inner &= ~__bswap32(0xff << 20);
 *inner |= __bswap32((u_int32_t)inner8 << 20);
 }
 return (1);
}
