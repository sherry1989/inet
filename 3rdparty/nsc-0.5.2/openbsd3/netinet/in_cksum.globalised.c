# 1 "openbsd3/netinet/in_cksum.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/netinet/in_cksum.c"
# 35 "openbsd3/netinet/in_cksum.c"
...
# 36 "openbsd3/netinet/in_cksum.c" 2
...
# 37 "openbsd3/netinet/in_cksum.c" 2
...
# 38 "openbsd3/netinet/in_cksum.c" 2
...
# 39 "openbsd3/netinet/in_cksum.c" 2
# 50 "openbsd3/netinet/in_cksum.c"
int
in_cksum(m, len)
 struct mbuf *m;
 int len;
{
 ...
 for (;m && len; m = m->m_hdr.mh_next) {
  ...
  if (mlen == -1) {
# 82 "openbsd3/netinet/in_cksum.c"
