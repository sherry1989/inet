# 1 "openbsd3/netinet/ip_ecn.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/netinet/ip_ecn.c"
# 38 "openbsd3/netinet/ip_ecn.c"
...
# 39 "openbsd3/netinet/ip_ecn.c" 2
...
# 40 "openbsd3/netinet/ip_ecn.c" 2
...
# 41 "openbsd3/netinet/ip_ecn.c" 2
...
# 44 "openbsd3/netinet/ip_ecn.c" 2
...
n_time iptime(void);
# 45 "openbsd3/netinet/ip_ecn.c" 2
...
# 46 "openbsd3/netinet/ip_ecn.c" 2
...
# 53 "openbsd3/netinet/ip_ecn.c" 2
...
# 56 "openbsd3/netinet/ip_ecn.c" 2
# 92 "openbsd3/netinet/ip_ecn.c"
void
 ...
 u_int32_t *inner;
{
 ...
 inner8 = (__extension__({ u_int32_t __swap32_x = (*inner); __builtin_constant_p(*inner) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); }) >> 20) & 0xff;
 ip_ecn_ingress(mode, &outer8, &inner8);
 *outer &= ~__extension__({ u_int32_t __swap32_x = (0xff << 20); __builtin_constant_p(0xff << 20) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); });
 *outer |= __extension__({ u_int32_t __swap32_x = ((u_int32_t)outer8 << 20); __builtin_constant_p((u_int32_t)outer8 << 20) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); });
}
 ...
 u_int32_t *inner;
{
 ...
 outer8 = (__extension__({ u_int32_t __swap32_x = (*outer); __builtin_constant_p(*outer) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); }) >> 20) & 0xff;
 inner8 = oinner8 = (__extension__({ u_int32_t __swap32_x = (*inner); __builtin_constant_p(*inner) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); }) >> 20) & 0xff;
 if (ip_ecn_egress(mode, &outer8, &inner8) == 0)
  return (0);
 if (inner8 != oinner8) {
  *inner &= ~__extension__({ u_int32_t __swap32_x = (0xff << 20); __builtin_constant_p(0xff << 20) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); });
  *inner |= __extension__({ u_int32_t __swap32_x = ((u_int32_t)inner8 << 20); __builtin_constant_p((u_int32_t)inner8 << 20) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); });
 }
 return (1);
}
