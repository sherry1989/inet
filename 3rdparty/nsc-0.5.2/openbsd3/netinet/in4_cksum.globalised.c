# 1 "openbsd3/netinet/in4_cksum.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/netinet/in4_cksum.c"
# 65 "openbsd3/netinet/in4_cksum.c"
...
# 66 "openbsd3/netinet/in4_cksum.c" 2
...
# 67 "openbsd3/netinet/in4_cksum.c" 2
...
# 68 "openbsd3/netinet/in4_cksum.c" 2
...
# 69 "openbsd3/netinet/in4_cksum.c" 2
...
# 70 "openbsd3/netinet/in4_cksum.c" 2
...
typedef  const struct sockaddr_in6    _GLOBAL_79_T; extern  _GLOBAL_79_T  global_sa6_any[NUM_STACKS];     

typedef  const struct in6_addr    _GLOBAL_80_T; extern  _GLOBAL_80_T  global_in6mask0[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_81_T; extern  _GLOBAL_81_T  global_in6mask32[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_82_T; extern  _GLOBAL_82_T  global_in6mask64[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_83_T; extern  _GLOBAL_83_T  global_in6mask96[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_84_T; extern  _GLOBAL_84_T  global_in6mask128[NUM_STACKS];     
...
typedef  const struct in6_addr    _GLOBAL_87_T; extern  _GLOBAL_87_T  global_in6addr_nodelocal_allnodes[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_88_T; extern  _GLOBAL_88_T  global_in6addr_linklocal_allnodes[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_89_T; extern  _GLOBAL_89_T  global_in6addr_linklocal_allrouters[NUM_STACKS];     
...
# 71 "openbsd3/netinet/in4_cksum.c" 2
...
n_time iptime(void);
# 72 "openbsd3/netinet/in4_cksum.c" 2
...
# 73 "openbsd3/netinet/in4_cksum.c" 2
...
typedef  struct ipstat   _GLOBAL_90_T; extern  _GLOBAL_90_T  global_ipstat[NUM_STACKS];    
typedef  struct ipqhead { struct ipq   * lh_first  ;  }   _GLOBAL_91_T; extern  _GLOBAL_91_T  global_ipq[NUM_STACKS];         
typedef  int  _GLOBAL_92_T; extern  _GLOBAL_92_T  global_ip_defttl[NUM_STACKS];   

typedef  int  _GLOBAL_93_T; extern  _GLOBAL_93_T  global_ip_mtudisc[NUM_STACKS];   
typedef  u_int  _GLOBAL_94_T; extern  _GLOBAL_94_T  global_ip_mtudisc_timeout[NUM_STACKS];   
typedef  struct rttimer_queue   _GLOBAL_95_T; extern  _GLOBAL_95_T  * global_ip_mtudisc_timeout_q[NUM_STACKS];    
typedef  struct pool   _GLOBAL_96_T; extern  _GLOBAL_96_T  global_ipqent_pool[NUM_STACKS];    
...
# 74 "openbsd3/netinet/in4_cksum.c" 2
# 89 "openbsd3/netinet/in4_cksum.c"
int
 ...
 int off, len;
{
 ...
 if (nxt != 0) {
  ...
  u.ipov.ih_len = __extension__({ u_int16_t __swap16_x = (len); __builtin_constant_p(len) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
  u.ipov.ih_pr = nxt;
  u.ipov.ih_src = ((struct ip *)((m)->m_hdr.mh_data))->ip_src;
  u.ipov.ih_dst = ((struct ip *)((m)->m_hdr.mh_data))->ip_dst;
  w = u.w;
 ...
 for (;m && len; m = m->m_hdr.mh_next) {
  if (m->m_hdr.mh_len == 0)
   continue;
  w = (u_int16_t *)(((caddr_t)((m)->m_hdr.mh_data)) + off);
  if (mlen == -1) {
# 150 "openbsd3/netinet/in4_cksum.c"
   s_util.c[1] = *(u_int8_t *)w;
   sum += s_util.s;
   w = (u_int16_t *)((u_int8_t *)w + 1);
   mlen = m->m_hdr.mh_len - off - 1;
   len--;
  } else
