# 1 "openbsd3/netinet/if_atm.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/netinet/if_atm.c"
# 41 "openbsd3/netinet/if_atm.c"
...
# 42 "openbsd3/netinet/if_atm.c" 2
...
# 43 "openbsd3/netinet/if_atm.c" 2
...
# 44 "openbsd3/netinet/if_atm.c" 2
...
# 45 "openbsd3/netinet/if_atm.c" 2
...
# 46 "openbsd3/netinet/if_atm.c" 2
...
# 48 "openbsd3/netinet/if_atm.c" 2
# 1 "openbsd3/sys/errno.h" 1
# 49 "openbsd3/netinet/if_atm.c" 2
...
# 50 "openbsd3/netinet/if_atm.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__printf__,1,2))) ;
void logwakeup(void);
# 51 "openbsd3/netinet/if_atm.c" 2
...
# 52 "openbsd3/netinet/if_atm.c" 2
...
# 54 "openbsd3/netinet/if_atm.c" 2
...
# 55 "openbsd3/netinet/if_atm.c" 2
...
# 56 "openbsd3/netinet/if_atm.c" 2
...
int atm_output(struct ifnet *, struct mbuf *, struct sockaddr *,
  struct rtentry *);
# 57 "openbsd3/netinet/if_atm.c" 2
...
# 59 "openbsd3/netinet/if_atm.c" 2
...
n_time iptime(void);
# 60 "openbsd3/netinet/if_atm.c" 2
...
# 61 "openbsd3/netinet/if_atm.c" 2
...
# 62 "openbsd3/netinet/if_atm.c" 2
# 1 "openbsd3/netinet/if_atm.h" 1
# 39 "openbsd3/netinet/if_atm.h"
void atm_rtrequest(int, struct rtentry *, struct rt_addrinfo *);
int atmresolve(struct rtentry *, struct mbuf *, struct sockaddr *,
  struct atm_pseudohdr *);
# 63 "openbsd3/netinet/if_atm.c" 2
# 78 "openbsd3/netinet/if_atm.c"
void
...
# 111 "openbsd3/netinet/if_atm.c"
  ...
  if (gate->sa_family != 18 ||
   ...
   log(7, "atm_rtrequest: bad gateway value\n");
   break;
  }


  if (rt->rt_ifp->if_ioctl == 0L) panic("atm null ioctl");
# 155 "openbsd3/netinet/if_atm.c"
  bcopy(((caddr_t)((((struct sockaddr_dl *)gate))->sdl_data + (((struct sockaddr_dl *)gate))->sdl_nlen)), &api.aph, sizeof(api.aph));
  api.rxhand = 0L;
  if (rt->rt_ifp->if_ioctl(rt->rt_ifp, (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct atm_pseudoioctl) & 0x1fff) << 16) | ((('a')) << 8) | ((123))),
       (caddr_t)&api) != 0) {
...
failed:
 ...
 case 0x2:
# 198 "openbsd3/netinet/if_atm.c"
  bcopy(((caddr_t)((((struct sockaddr_dl *)gate))->sdl_data + (((struct sockaddr_dl *)gate))->sdl_nlen)), &api.aph, sizeof(api.aph));
  api.rxhand = 0L;
  (void)rt->rt_ifp->if_ioctl(rt->rt_ifp, (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct atm_pseudoioctl) & 0x1fff) << 16) | ((('a')) << 8) | ((124))),
       (caddr_t)&api);

  break;
 }
}
# 223 "openbsd3/netinet/if_atm.c"
int
