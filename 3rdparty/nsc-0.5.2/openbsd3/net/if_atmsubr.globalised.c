# 1 "openbsd3/net/if_atmsubr.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/net/if_atmsubr.c"
# 79 "openbsd3/net/if_atmsubr.c"
...
# 80 "openbsd3/net/if_atmsubr.c" 2
...
# 81 "openbsd3/net/if_atmsubr.c" 2
...
# 82 "openbsd3/net/if_atmsubr.c" 2
...
# 83 "openbsd3/net/if_atmsubr.c" 2
...
# 84 "openbsd3/net/if_atmsubr.c" 2
...
# 85 "openbsd3/net/if_atmsubr.c" 2
...
void pfctlinput(int, struct sockaddr *);
# 86 "openbsd3/net/if_atmsubr.c" 2
...
# 87 "openbsd3/net/if_atmsubr.c" 2
# 1 "openbsd3/sys/errno.h" 1
# 88 "openbsd3/net/if_atmsubr.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__printf__,1,2))) ;
void logwakeup(void);
# 89 "openbsd3/net/if_atmsubr.c" 2
...
# 93 "openbsd3/net/if_atmsubr.c" 2
...
# 94 "openbsd3/net/if_atmsubr.c" 2
...
# 95 "openbsd3/net/if_atmsubr.c" 2
...
# 96 "openbsd3/net/if_atmsubr.c" 2
# 1 "openbsd3/net/if_types.h" 1
# 97 "openbsd3/net/if_atmsubr.c" 2
...
int atm_output(struct ifnet *, struct mbuf *, struct sockaddr *,
  struct rtentry *);
# 98 "openbsd3/net/if_atmsubr.c" 2
...
# 100 "openbsd3/net/if_atmsubr.c" 2
...
int atmresolve(struct rtentry *, struct mbuf *, struct sockaddr *,
  struct atm_pseudohdr *);
# 101 "openbsd3/net/if_atmsubr.c" 2
...
# 102 "openbsd3/net/if_atmsubr.c" 2
...
# 104 "openbsd3/net/if_atmsubr.c" 2
# 130 "openbsd3/net/if_atmsubr.c"
int
...
# 224 "openbsd3/net/if_atmsubr.c"
  ...
  if (atm_flags & 0x02) sz += 8;
  { if ((((((m))->m_hdr.mh_flags & 0x0001) != 0 && ((((m))->m_hdr.mh_flags & 0x0008) == 0 || (((m))->M_dat.MH.MH_dat.MH_ext.ext_nextref != ((m))))) ? 0 : (((m))->m_hdr.mh_flags & 0x0001 ? ((m))->m_hdr.mh_data - ((m))->M_dat.MH.MH_dat.MH_ext.ext_buf : ((m))->m_hdr.mh_flags & 0x0002 ? ((m))->m_hdr.mh_data - ((m))->M_dat.MH.MH_dat.MH_databuf : ((m))->m_hdr.mh_data - ((m))->M_dat.M_databuf)) >= (sz)) { (m)->m_hdr.mh_data -= (sz); (m)->m_hdr.mh_len += (sz); } else (m) = m_prepend((m), (sz), (0x0001)); if ((m) && (m)->m_hdr.mh_flags & 0x0002) (m)->M_dat.MH.MH_pkthdr.len += (sz); };
  if (m == 0)
   { error = (55); goto bad;};
  ...
  *ad = atmdst;
  if (atm_flags & 0x02) {
   ...
   { (atmllc)->type[0] = ((etype) >> 8) & 0xff; (atmllc)->type[1] = ((etype) & 0xff); };
  }
 }
