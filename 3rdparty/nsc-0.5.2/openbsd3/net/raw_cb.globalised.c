# 1 "openbsd3/net/raw_cb.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/net/raw_cb.c"
# 35 "openbsd3/net/raw_cb.c"
...
typedef  struct domain   _GLOBAL_78_T; extern  _GLOBAL_78_T  * global_domains[NUM_STACKS];    
void domaininit(void);
# 41 "openbsd3/net/raw_cb.c" 2
...
void pfctlinput(int, struct sockaddr *);
# 42 "openbsd3/net/raw_cb.c" 2
# 1 "openbsd3/sys/errno.h" 1
# 43 "openbsd3/net/raw_cb.c" 2
...
typedef  struct rawcbhead { struct rawcb   * lh_first  ;  }   _GLOBAL_89_T; extern  _GLOBAL_89_T  global_rawcb[NUM_STACKS];         
...
typedef  const struct sockaddr_in6    _GLOBAL_90_T; extern  _GLOBAL_90_T  global_sa6_any[NUM_STACKS];     

typedef  const struct in6_addr    _GLOBAL_91_T; extern  _GLOBAL_91_T  global_in6mask0[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_92_T; extern  _GLOBAL_92_T  global_in6mask32[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_93_T; extern  _GLOBAL_93_T  global_in6mask64[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_94_T; extern  _GLOBAL_94_T  global_in6mask96[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_95_T; extern  _GLOBAL_95_T  global_in6mask128[NUM_STACKS];     
# 217 "openbsd3/netinet6/in6.h"
typedef  const struct in6_addr    _GLOBAL_96_T; extern  _GLOBAL_96_T  global_in6addr_any[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_97_T; extern  _GLOBAL_97_T  global_in6addr_loopback[NUM_STACKS];     
typedef  const struct in6_addr    _GLOBAL_98_T; extern  _GLOBAL_98_T  global_in6addr_nodelocal_allnodes[NUM_STACKS];     
...
# 48 "openbsd3/net/raw_cb.c" 2
# 58 "openbsd3/net/raw_cb.c"
typedef  u_long _GLOBAL_101_T;  _GLOBAL_101_T  global_raw_sendspace[NUM_STACKS] = {  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  };    
typedef  u_long _GLOBAL_102_T;  _GLOBAL_102_T  global_raw_recvspace[NUM_STACKS] = {  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  };    
typedef  struct rawcbhead  _GLOBAL_103_T;  _GLOBAL_103_T  global_rawcb[NUM_STACKS];   
 ...
 int proto;
{
 ...
 if (rp == 0)
  return (55);
 if ((error = soreserve(so, global_raw_sendspace[get_stack_id()], global_raw_recvspace[get_stack_id()])) != 0)
  return (error);
 rp->rcb_socket = so;
 rp->rcb_proto.sp_family = so->so_proto->pr_domain->dom_family;
 rp->rcb_proto.sp_protocol = proto;
 do { if (((rp)->rcb_list.le_next = (&global_rawcb[get_stack_id()])->lh_first) != 0L) (&global_rawcb[get_stack_id()])->lh_first->rcb_list.le_prev = &(rp)->rcb_list.le_next; (&global_rawcb[get_stack_id()])->lh_first = (rp); (rp)->rcb_list.le_prev = &(&global_rawcb[get_stack_id()])->lh_first; } while (0);
 return (0);
}
 ...
 struct rawcb *rp;
{
 ...
 so->so_pcb = 0;
 sofree(so);
 do { if ((rp)->rcb_list.le_next != 0L) (rp)->rcb_list.le_next->rcb_list.le_prev = (rp)->rcb_list.le_prev; *(rp)->rcb_list.le_prev = (rp)->rcb_list.le_next; } while (0);
