# 1 "openbsd3/net/if_fddisubr.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/net/if_fddisubr.c"
# 77 "openbsd3/net/if_fddisubr.c"
...
# 78 "openbsd3/net/if_fddisubr.c" 2
...
# 79 "openbsd3/net/if_fddisubr.c" 2
...
# 80 "openbsd3/net/if_fddisubr.c" 2
...
# 81 "openbsd3/net/if_fddisubr.c" 2
...
# 82 "openbsd3/net/if_fddisubr.c" 2
...
# 83 "openbsd3/net/if_fddisubr.c" 2
...
void pfctlinput(int, struct sockaddr *);
# 84 "openbsd3/net/if_fddisubr.c" 2
...
# 85 "openbsd3/net/if_fddisubr.c" 2
# 1 "openbsd3/sys/errno.h" 1
# 86 "openbsd3/net/if_fddisubr.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__printf__,1,2))) ;
void logwakeup(void);
# 87 "openbsd3/net/if_fddisubr.c" 2
...
# 91 "openbsd3/net/if_fddisubr.c" 2
...
# 92 "openbsd3/net/if_fddisubr.c" 2
...
# 93 "openbsd3/net/if_fddisubr.c" 2
...
# 94 "openbsd3/net/if_fddisubr.c" 2
...
# 95 "openbsd3/net/if_fddisubr.c" 2
# 1 "openbsd3/net/if_types.h" 1
# 96 "openbsd3/net/if_fddisubr.c" 2
...
# 99 "openbsd3/net/if_fddisubr.c" 2
...
# 100 "openbsd3/net/if_fddisubr.c" 2
...
# 102 "openbsd3/net/if_fddisubr.c" 2
...
int fddi_output(struct ifnet *,
           struct mbuf *, struct sockaddr *, struct rtentry *);
# 103 "openbsd3/net/if_fddisubr.c" 2
# 114 "openbsd3/net/if_fddisubr.c"
...
typedef  int  _GLOBAL_131_T; extern  _GLOBAL_131_T  global_nd6_prune[NUM_STACKS];   
typedef  int  _GLOBAL_132_T; extern  _GLOBAL_132_T  global_nd6_delay[NUM_STACKS];   
typedef  int  _GLOBAL_133_T; extern  _GLOBAL_133_T  global_nd6_umaxtries[NUM_STACKS];   
typedef  int  _GLOBAL_134_T; extern  _GLOBAL_134_T  global_nd6_mmaxtries[NUM_STACKS];   
typedef  int  _GLOBAL_135_T; extern  _GLOBAL_135_T  global_nd6_useloopback[NUM_STACKS];   
typedef  int  _GLOBAL_136_T; extern  _GLOBAL_136_T  global_nd6_maxnudhint[NUM_STACKS];   
typedef  int  _GLOBAL_137_T; extern  _GLOBAL_137_T  global_nd6_gctimer[NUM_STACKS];   
typedef  struct llinfo_nd6   _GLOBAL_138_T; extern  _GLOBAL_138_T  global_llinfo_nd6[NUM_STACKS];    
typedef  struct nd_drhead   _GLOBAL_139_T; extern  _GLOBAL_139_T  global_nd_defrouter[NUM_STACKS];    
typedef  struct nd_prhead   _GLOBAL_140_T; extern  _GLOBAL_140_T  global_nd_prefix[NUM_STACKS];    
typedef  int  _GLOBAL_141_T; extern  _GLOBAL_141_T  global_nd6_debug[NUM_STACKS];   



typedef  struct timeout   _GLOBAL_142_T; extern  _GLOBAL_142_T  global_nd6_timer_ch[NUM_STACKS];    


typedef  int  _GLOBAL_143_T; extern  _GLOBAL_143_T  global_nd6_defifindex[NUM_STACKS];   
...
# 115 "openbsd3/net/if_fddisubr.c" 2
# 133 "openbsd3/net/if_fddisubr.c"
# 1 "openbsd3/openbsd/usr/src/sys/arch/i386/compile/SAMSKERNEL/bpfilter.h" 1
# 134 "openbsd3/net/if_fddisubr.c" 2
...
# 136 "openbsd3/net/if_fddisubr.c" 2
...
typedef  struct bitslice   _GLOBAL_144_T; extern  _GLOBAL_144_T  _GLOBAL_0_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_1_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_2_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_3_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_4_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_5_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_6_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_7_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_8_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_9_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_10_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_11_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_12_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_13_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_14_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_15_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_16_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_17_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_18_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_19_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_20_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_21_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_22_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_23_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_24_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_25_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_26_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_27_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_28_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_29_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_30_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_31_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_32_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_33_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_34_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_35_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_36_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_37_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_38_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_39_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_40_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_41_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_42_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_43_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_44_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_45_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_46_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_47_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_48_llc_bitslice_I [ ] ; extern  _GLOBAL_144_T  _GLOBAL_49_llc_bitslice_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_llc_bitslice_I) *_GLOBAL_llc_bitslice_27_A[NUM_STACKS];   
...
# 137 "openbsd3/net/if_fddisubr.c" 2
...
# 143 "openbsd3/net/if_fddisubr.c" 2
...
# 145 "openbsd3/net/if_fddisubr.c" 2
# 161 "openbsd3/net/if_fddisubr.c"
int
 ...
 struct rtentry *rt0;
{
 ...
 case 2:
  ...
  type = __extension__({ u_int16_t __swap16_x = (0x0800); __builtin_constant_p(0x0800) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
  break;
 ...
 case 24:
  if (!nd6_storelladdr(ifp, rt, m, dst, (u_char *)edst))
   return (0);
  type = __extension__({ u_int16_t __swap16_x = (0x86DD); __builtin_constant_p(0x86DD) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
  break;
# 346 "openbsd3/net/if_fddisubr.c"
 case 31:
 {
 ...
 if (type != 0) {
  struct llc *l;
  { if ((((((m))->m_hdr.mh_flags & 0x0001) != 0 && ((((m))->m_hdr.mh_flags & 0x0008) == 0 || (((m))->M_dat.MH.MH_dat.MH_ext.ext_nextref != ((m))))) ? 0 : (((m))->m_hdr.mh_flags & 0x0001 ? ((m))->m_hdr.mh_data - ((m))->M_dat.MH.MH_dat.MH_ext.ext_buf : ((m))->m_hdr.mh_flags & 0x0002 ? ((m))->m_hdr.mh_data - ((m))->M_dat.MH.MH_dat.MH_databuf : ((m))->m_hdr.mh_data - ((m))->M_dat.M_databuf)) >= (sizeof (struct llc))) { (m)->m_hdr.mh_data -= (sizeof (struct llc)); (m)->m_hdr.mh_len += (sizeof (struct llc)); } else (m) = m_prepend((m), (sizeof (struct llc)), (0x0001)); if ((m) && (m)->m_hdr.mh_flags & 0x0002) (m)->M_dat.MH.MH_pkthdr.len += (sizeof (struct llc)); };
  if (m == 0)
   { error = (55); goto bad;};
  l = ((struct llc *)((m)->m_hdr.mh_data));
  l->llc_un.type_u.control = 0x3;
  l->llc_dsap = l->llc_ssap = 0xaa;
  l->llc_un.type_snap.org_code[0] = l->llc_un.type_snap.org_code[1] = l->llc_un.type_snap.org_code[2] = 0;
  bcopy((caddr_t) &type, (caddr_t) &l->llc_un.type_snap.ether_type,
   sizeof(u_short));
 }
 ...
 { if ((((((m))->m_hdr.mh_flags & 0x0001) != 0 && ((((m))->m_hdr.mh_flags & 0x0008) == 0 || (((m))->M_dat.MH.MH_dat.MH_ext.ext_nextref != ((m))))) ? 0 : (((m))->m_hdr.mh_flags & 0x0001 ? ((m))->m_hdr.mh_data - ((m))->M_dat.MH.MH_dat.MH_ext.ext_buf : ((m))->m_hdr.mh_flags & 0x0002 ? ((m))->m_hdr.mh_data - ((m))->M_dat.MH.MH_dat.MH_databuf : ((m))->m_hdr.mh_data - ((m))->M_dat.M_databuf)) >= (sizeof (struct fddi_header))) { (m)->m_hdr.mh_data -= (sizeof (struct fddi_header)); (m)->m_hdr.mh_len += (sizeof (struct fddi_header)); } else (m) = m_prepend((m), (sizeof (struct fddi_header)), (0x0001)); if ((m) && (m)->m_hdr.mh_flags & 0x0002) (m)->M_dat.MH.MH_pkthdr.len += (sizeof (struct fddi_header)); };
 if (m == 0)
  { error = (55); goto bad;};
 fh = ((struct fddi_header *)((m)->m_hdr.mh_data));
 fh->fddi_fc = 0x50|4;
 ...
 struct mbuf *m;
{
 ...
 ifp->if_data.ifi_ibytes += m->M_dat.MH.MH_pkthdr.len + sizeof (*fh);
 if (bcmp((caddr_t)(*_GLOBAL_etherbroadcastaddr_24_A[get_stack_id()]), (caddr_t)fh->fddi_dhost,
     sizeof((*_GLOBAL_etherbroadcastaddr_24_A[get_stack_id()]))) == 0)
 ...
 case 0xaa:
 {
  ...
  if (l->llc_un.type_u.control != 0x3 || l->llc_ssap != 0xaa)
   goto dropanyway;
  if (l->llc_un.type_snap.org_code[0] != 0 || l->llc_un.type_snap.org_code[1] != 0|| l->llc_un.type_snap.org_code[2] != 0)
   goto dropanyway;
  ...
  case 0x86DD:
   ...
   break;
# 557 "openbsd3/net/if_fddisubr.c"
  default:
...
# 647 "openbsd3/net/if_fddisubr.c"
 default:
