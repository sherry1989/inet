...
# 115 "openbsd3/net/if_loop.c" 2
# 1 "openbsd3/sys/errno.h" 1
# 116 "openbsd3/net/if_loop.c" 2
...
# 122 "openbsd3/net/if_loop.c" 2
# 1 "openbsd3/net/if_types.h" 1
# 123 "openbsd3/net/if_loop.c" 2
...
# 139 "openbsd3/net/if_loop.c" 2
# 163 "openbsd3/net/if_loop.c"
...
# 164 "openbsd3/net/if_loop.c" 2
# 173 "openbsd3/net/if_loop.c"
...
typedef  struct if_clone  _GLOBAL_127_T;  _GLOBAL_127_T  global_loop_cloner[NUM_STACKS] = {  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  { { 0 }  , "lo"  , sizeof ( "lo" )   - 1   , loop_clone_create  , loop_clone_destroy  } ,  };    
...
loopattach(n)
 int n;
{
 (void) loop_clone_create(&global_loop_cloner[get_stack_id()], 0);
 if_clone_attach(&global_loop_cloner[get_stack_id()]);
}
 ...
 int unit;
{
 ...
 (ifp) = (struct ifnet *)malloc((u_long)(sizeof(*ifp)), 2, 0x0001);
 if (ifp == 0L)
  return (12);
 ...
 if (unit == 0) {
  global_lo0ifp[get_stack_id()] = ifp;
  if_attachhead(ifp);
 } else
  if_attach(ifp);
 if_alloc_sadl(ifp);
...
loop_clone_destroy(ifp)
 struct ifnet *ifp;
{
 if (ifp == global_lo0ifp[get_stack_id()])
  return (1);
 ...
 struct rtentry *rt;
{
 ...
 if (ifp->if_bpf && (ifp->if_flags&0x8)) {
 ...
 if ((((&ifp->if_snd)->altq_flags & 0x02) || ((&ifp->if_snd)->altq_tbr != 0L))
  ...
  { if ((((((m))->m_hdr.mh_flags & 0x0001) != 0 && ((((m))->m_hdr.mh_flags & 0x0008) == 0 || (((m))->M_dat.MH.MH_dat.MH_ext.ext_nextref != ((m))))) ? 0 : (((m))->m_hdr.mh_flags & 0x0001 ? ((m))->m_hdr.mh_data - ((m))->M_dat.MH.MH_dat.MH_ext.ext_buf : ((m))->m_hdr.mh_flags & 0x0002 ? ((m))->m_hdr.mh_data - ((m))->M_dat.MH.MH_dat.MH_databuf : ((m))->m_hdr.mh_data - ((m))->M_dat.M_databuf)) >= (sizeof(int32_t))) { (m)->m_hdr.mh_data -= (sizeof(int32_t)); (m)->m_hdr.mh_len += (sizeof(int32_t)); } else (m) = m_prepend((m), (sizeof(int32_t)), (0x0001)); if ((m) && (m)->m_hdr.mh_flags & 0x0002) (m)->M_dat.MH.MH_pkthdr.len += (sizeof(int32_t)); };
  if (m == 0)
   return (55);
  afp = ((int32_t *)((m)->m_hdr.mh_data));
