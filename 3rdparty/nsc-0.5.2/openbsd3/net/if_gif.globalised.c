# 1 "openbsd3/net/if_gif.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/net/if_gif.c"
# 33 "openbsd3/net/if_gif.c"
...
# 42 "openbsd3/net/if_gif.c" 2
# 1 "openbsd3/net/if_types.h" 1
# 43 "openbsd3/net/if_gif.c" 2
...
typedef  int  _GLOBAL_104_T; extern  _GLOBAL_104_T  global_ticks[NUM_STACKS];   
# 45 "openbsd3/net/if_gif.c" 2
...
typedef  struct gif_softc_head { struct gif_softc   * lh_first  ;  }   _GLOBAL_125_T; extern  _GLOBAL_125_T  global_gif_softc_list[NUM_STACKS];         
...
typedef  struct gif_softc_head  _GLOBAL_127_T;  _GLOBAL_127_T  global_gif_softc_list[NUM_STACKS];   
typedef  struct if_clone  _GLOBAL_128_T;  _GLOBAL_128_T  global_gif_cloner[NUM_STACKS] = {  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  { { 0 }  , "gif"  , sizeof ( "gif" )   - 1   , gif_clone_create  , gif_clone_destroy  } ,  };    
...
gifattach(count)
 int count;
{
 do { ((&global_gif_softc_list[get_stack_id()])->lh_first) = 0L; } while (0);
 ...
 int unit;
{
 ...
 sc->gif_if.if_snd.ifq_maxlen = global_ifqmaxlen[get_stack_id()];
 sc->gif_if.if_softc = sc;
 if_attach(&sc->gif_if);
 if_alloc_sadl(&sc->gif_if);


 bpfattach(&sc->gif_if.if_bpf, &sc->gif_if, 0,
    sizeof(u_int));

 s = splraise((0x20 + ((3) << 4)));
 do { if (((sc)->gif_list.le_next = (&global_gif_softc_list[get_stack_id()])->lh_first) != 0L) (&global_gif_softc_list[get_stack_id()])->lh_first->gif_list.le_prev = &(sc)->gif_list.le_next; (&global_gif_softc_list[get_stack_id()])->lh_first = (sc); (sc)->gif_list.le_prev = &(&global_gif_softc_list[get_stack_id()])->lh_first; } while (0);
 splx(s);
 ...
 struct ifnet *ifp;
{
 ...
 s = splraise((0x20 + ((3) << 4)));
 do { if ((sc)->gif_list.le_next != 0L) (sc)->gif_list.le_next->gif_list.le_prev = (sc)->gif_list.le_prev; *(sc)->gif_list.le_prev = (sc)->gif_list.le_next; } while (0);
 splx(s);
 ...
 if (sc->gif_psrc)
  free((caddr_t)sc->gif_psrc, 9);
 sc->gif_psrc = 0L;
 if (sc->gif_pdst)
  free((caddr_t)sc->gif_pdst, 9);
 sc->gif_pdst = 0L;
 free(sc, 2);
 return (0);
}
        ...
        struct ifnet *ifp;
{
 ...
 for (;;) {
  ...
  if (ifp->if_bridge == 0L) m_freem(m);
  else gif_output(ifp, m, &dst, 0L);
 ...
 struct rtentry *rt;
{
 ...
 for (mtag = m_tag_find(m, 8, 0L); mtag;
      mtag = m_tag_find(m, 8, mtag)) {
 ...
 mtag = m_tag_get(8, sizeof(struct ifnet *), 0x0001);
 if (mtag == 0L) {
  ((&ifp->if_snd)->ifq_drops++);
  m_freem(m);
  error = 12;
 ...
 caddr_t data;
{
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct if_laddrreq) & 0x1fff) << 16) | ((('i')) << 8) | ((74))):
  ...
  for((sc2) = ((&global_gif_softc_list[get_stack_id()])->lh_first); (sc2)!= 0L; (sc2) = ((sc2)->gif_list.le_next)) {
   if (sc2 == sc)
    continue;
...
# 429 "openbsd3/net/if_gif.c"
   if (dst->sa_family == 2 &&
       (((struct sockaddr_in *)(dst))->sin_addr.s_addr == ((u_int32_t) __extension__({ u_int32_t __swap32_x = ((u_int32_t)(0x00000000)); __builtin_constant_p((u_int32_t)(0x00000000)) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); }))) && (((struct sockaddr_in *)(sc2->gif_pdst))->sin_addr.s_addr == ((u_int32_t) __extension__({ u_int32_t __swap32_x = ((u_int32_t)(0x00000000)); __builtin_constant_p((u_int32_t)(0x00000000)) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); })))) {
    error = 49;
    goto bad;
   }

   if (dst->sa_family == 24 &&
       (((*(const u_int32_t *)(const void *)(&(&((struct sockaddr_in6 *)(dst))->sin6_addr)->__u6_addr.__u6_addr8[0]) == 0) && (*(const u_int32_t *)(const void *)(&(&((struct sockaddr_in6 *)(dst))->sin6_addr)->__u6_addr.__u6_addr8[4]) == 0) && (*(const u_int32_t *)(const void *)(&(&((struct sockaddr_in6 *)(dst))->sin6_addr)->__u6_addr.__u6_addr8[8]) == 0) && (*(const u_int32_t *)(const void *)(&(&((struct sockaddr_in6 *)(dst))->sin6_addr)->__u6_addr.__u6_addr8[12]) == 0))) && (((*(const u_int32_t *)(const void *)(&(&((struct sockaddr_in6 *)(sc2->gif_pdst))->sin6_addr)->__u6_addr.__u6_addr8[0]) == 0) && (*(const u_int32_t *)(const void *)(&(&((struct sockaddr_in6 *)(sc2->gif_pdst))->sin6_addr)->__u6_addr.__u6_addr8[4]) == 0) && (*(const u_int32_t *)(const void *)(&(&((struct sockaddr_in6 *)(sc2->gif_pdst))->sin6_addr)->__u6_addr.__u6_addr8[8]) == 0) && (*(const u_int32_t *)(const void *)(&(&((struct sockaddr_in6 *)(sc2->gif_pdst))->sin6_addr)->__u6_addr.__u6_addr8[12]) == 0)))) {
    error = 49;
    goto bad;
   }
  ...
  if (sc->gif_psrc)
   free((caddr_t)sc->gif_psrc, 9);
  sa = (struct sockaddr *)malloc(src->sa_len, 9, 0x0000);
  bcopy((caddr_t)src, (caddr_t)sa, src->sa_len);
  sc->gif_psrc = sa;

  if (sc->gif_pdst)
   free((caddr_t)sc->gif_pdst, 9);
  sa = (struct sockaddr *)malloc(dst->sa_len, 9, 0x0000);
