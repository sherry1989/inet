# 1 "openbsd3/netinet6/frag6.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/netinet6/frag6.c"
# 33 "openbsd3/netinet6/frag6.c"
...
# 34 "openbsd3/netinet6/frag6.c" 2
...
# 35 "openbsd3/netinet6/frag6.c" 2
...
# 36 "openbsd3/netinet6/frag6.c" 2
...
# 37 "openbsd3/netinet6/frag6.c" 2
...
# 38 "openbsd3/netinet6/frag6.c" 2
...
# 39 "openbsd3/netinet6/frag6.c" 2
...
void pfctlinput(int, struct sockaddr *);
# 40 "openbsd3/netinet6/frag6.c" 2
# 1 "openbsd3/sys/errno.h" 1
# 41 "openbsd3/netinet6/frag6.c" 2
...
# 43 "openbsd3/netinet6/frag6.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__printf__,1,2))) ;
void logwakeup(void);
# 44 "openbsd3/netinet6/frag6.c" 2
...
# 46 "openbsd3/netinet6/frag6.c" 2
...
# 47 "openbsd3/netinet6/frag6.c" 2
...
# 49 "openbsd3/netinet6/frag6.c" 2
...
# 50 "openbsd3/netinet6/frag6.c" 2
...
# 51 "openbsd3/netinet6/frag6.c" 2
...
typedef  struct ip6stat   _GLOBAL_125_T; extern  _GLOBAL_125_T  global_ip6stat[NUM_STACKS];    
typedef  int  _GLOBAL_126_T; extern  _GLOBAL_126_T  global_ip6_defhlim[NUM_STACKS];   
typedef  int  _GLOBAL_127_T; extern  _GLOBAL_127_T  global_ip6_defmcasthlim[NUM_STACKS];   
typedef  int  _GLOBAL_128_T; extern  _GLOBAL_128_T  global_ip6_forwarding[NUM_STACKS];   
typedef  int  _GLOBAL_129_T; extern  _GLOBAL_129_T  global_ip6_sendredirect[NUM_STACKS];   
typedef  int  _GLOBAL_130_T; extern  _GLOBAL_130_T  global_ip6_forward_srcrt[NUM_STACKS];   
typedef  int  _GLOBAL_131_T; extern  _GLOBAL_131_T  global_ip6_use_deprecated[NUM_STACKS];   
typedef  int  _GLOBAL_132_T; extern  _GLOBAL_132_T  global_ip6_rr_prune[NUM_STACKS];   

typedef  const int   _GLOBAL_133_T; extern  _GLOBAL_133_T  global_ip6_v6only[NUM_STACKS];    

typedef  struct socket   _GLOBAL_134_T; extern  _GLOBAL_134_T  * global_ip6_mrouter[NUM_STACKS];    
typedef  int  _GLOBAL_135_T; extern  _GLOBAL_135_T  global_ip6_sendredirects[NUM_STACKS];   
typedef  int  _GLOBAL_136_T; extern  _GLOBAL_136_T  global_ip6_maxfragpackets[NUM_STACKS];   
typedef  int  _GLOBAL_137_T; extern  _GLOBAL_137_T  global_ip6_maxfrags[NUM_STACKS];   
typedef  int  _GLOBAL_138_T; extern  _GLOBAL_138_T  global_ip6_sourcecheck[NUM_STACKS];   
typedef  int  _GLOBAL_139_T; extern  _GLOBAL_139_T  global_ip6_sourcecheck_interval[NUM_STACKS];   
typedef  int  _GLOBAL_140_T; extern  _GLOBAL_140_T  global_ip6_accept_rtadv[NUM_STACKS];   
typedef  int  _GLOBAL_141_T; extern  _GLOBAL_141_T  global_ip6_keepfaith[NUM_STACKS];   
typedef  int  _GLOBAL_142_T; extern  _GLOBAL_142_T  global_ip6_log_interval[NUM_STACKS];   
typedef  time_t  _GLOBAL_143_T; extern  _GLOBAL_143_T  global_ip6_log_time[NUM_STACKS];   
typedef  int  _GLOBAL_144_T; extern  _GLOBAL_144_T  global_ip6_hdrnestlimit[NUM_STACKS];   
typedef  int  _GLOBAL_145_T; extern  _GLOBAL_145_T  global_ip6_dad_count[NUM_STACKS];   

typedef  u_int32_t  _GLOBAL_146_T; extern  _GLOBAL_146_T  global_ip6_flow_seq[NUM_STACKS];   
typedef  int  _GLOBAL_147_T; extern  _GLOBAL_147_T  global_ip6_auto_flowlabel[NUM_STACKS];   
typedef  int  _GLOBAL_148_T; extern  _GLOBAL_148_T  global_ip6_auto_linklocal[NUM_STACKS];   
...
# 52 "openbsd3/netinet6/frag6.c" 2
...
typedef  int  _GLOBAL_149_T; extern  _GLOBAL_149_T  global_icmp6_rediraccept[NUM_STACKS];   
typedef  int  _GLOBAL_150_T; extern  _GLOBAL_150_T  global_icmp6_redirtimeout[NUM_STACKS];   
# 53 "openbsd3/netinet6/frag6.c" 2
...
n_time iptime(void);
# 54 "openbsd3/netinet6/frag6.c" 2
...
# 55 "openbsd3/netinet6/frag6.c" 2
...
typedef  struct rndstats   _GLOBAL_151_T; extern  _GLOBAL_151_T  global_rndstats[NUM_STACKS];    
# 86 "openbsd3/dev/rndvar.h"
void enqueue_randomness(int, int);
void get_random_bytes(void *, size_t);
void arc4random_bytes(void *, size_t);
u_int32_t arc4random(void);
# 57 "openbsd3/netinet6/frag6.c" 2
# 65 "openbsd3/netinet6/frag6.c"
...
typedef  int  _GLOBAL_152_T; static  _GLOBAL_152_T  global_ip6q_locked[NUM_STACKS];   
typedef  u_int _GLOBAL_153_T;  _GLOBAL_153_T  global_frag6_nfragpackets[NUM_STACKS];  
typedef  u_int _GLOBAL_154_T;  _GLOBAL_154_T  global_frag6_nfrags[NUM_STACKS];  
typedef  struct ip6q  _GLOBAL_155_T;  _GLOBAL_155_T  global_ip6q[NUM_STACKS];   
...
ip6q_lock_try()
{
 ...
 s = splraise((0x20 + ((6) << 4)));
 if (global_ip6q_locked[get_stack_id()]) {
  splx(s);
  return (0);
 }
 global_ip6q_locked[get_stack_id()] = 1;
 splx(s);
 return (1);
}
...
ip6q_unlock()
{
 ...
 s = splraise((0x20 + ((6) << 4)));
 global_ip6q_locked[get_stack_id()] = 0;
 splx(s);
}
# 133 "openbsd3/netinet6/frag6.c"
void
frag6_init()
{
 ...
 int *offp, proto;
{
 ...
 typedef  struct route_in6   _GLOBAL_156_T; static  _GLOBAL_156_T  global_ro[NUM_STACKS];    
 struct sockaddr_in6 *dst;

 u_int8_t ecn, ecn0;

 ip6 = ((struct ip6_hdr *)((m)->m_hdr.mh_data));
 do { struct mbuf *t; int tmp; if ((m)->m_hdr.mh_len >= (offset) + (sizeof(*ip6f))) (ip6f) = (struct ip6_frag *)(((caddr_t)(((m))->m_hdr.mh_data)) + (offset)); else { t = m_pulldown((m), (offset), (sizeof(*ip6f)), &tmp); if (t) { if (t->m_hdr.mh_len < tmp + (sizeof(*ip6f))) panic("m_pulldown malfunction"); (ip6f) = (struct ip6_frag *)(((caddr_t)((t)->m_hdr.mh_data)) + tmp); } else { (ip6f) = (struct ip6_frag *)0L; (m) = 0L; } } } while (0);
 if (ip6f == 0L)
  return 257;
 ...
 dst = (struct sockaddr_in6 *)&global_ro[get_stack_id()].ro_dst;
 if (global_ro[get_stack_id()].ro_rt
  && ((global_ro[get_stack_id()].ro_rt->rt_flags & 0x1) == 0
   || !(bcmp(&(&dst->sin6_addr)->__u6_addr.__u6_addr8[0], &(&ip6->ip6_dst)->__u6_addr.__u6_addr8[0], sizeof(struct in6_addr)) == 0))) {
  do { if ((global_ro[get_stack_id()].ro_rt)->rt_refcnt <= 1) rtfree(global_ro[get_stack_id()].ro_rt); else (global_ro[get_stack_id()].ro_rt)->rt_refcnt--; } while (0);
  global_ro[get_stack_id()].ro_rt = (struct rtentry *)0;
 }
 if (global_ro[get_stack_id()].ro_rt == 0L) {
 ...
 rtalloc((struct route *)&global_ro[get_stack_id()]);

 if (global_ro[get_stack_id()].ro_rt != 0L && global_ro[get_stack_id()].ro_rt->rt_ifa != 0L)
  dstifp = ((struct in6_ifaddr *)global_ro[get_stack_id()].ro_rt->rt_ifa)->ia_ifa.ifa_ifp;
 ...
 if (ip6->ip6_ctlun.ip6_un1.ip6_un1_plen == 0) {
  ...
  do { if (dstifp) ((struct in6_ifextra *)((dstifp)->if_afdata[24]))->in6_ifstat->ifs6_reass_fail++; } while (0);
  return 257;
 }
 ...
 if ((ip6f->ip6f_offlg & 0x0100) &&
     (((__extension__({ u_int16_t __swap16_x = (ip6->ip6_ctlun.ip6_un1.ip6_un1_plen); __builtin_constant_p(ip6->ip6_ctlun.ip6_un1.ip6_un1_plen) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }) - offset) & 0x7) != 0)) {
  icmp6_error(m, 4, 0,
 ...
 do { if (dstifp) ((struct in6_ifextra *)((dstifp)->if_afdata[24]))->in6_ifstat->ifs6_reass_reqd++; } while (0);


 offset += sizeof(struct ip6_frag);

 do { if (ip6q_lock_try() == 0) { printf("%s:%d: ip6q already locked\n", "openbsd3/netinet6/frag6.c", 251); panic("ip6q_lock"); } } while (0);
...
# 282 "openbsd3/netinet6/frag6.c"
  ...
  q6 = (struct ip6q *)malloc(sizeof(struct ip6q), 7,
      0x0001);
  if (q6 == 0L)
   goto dropfrag;
  bzero(q6, sizeof(*q6));
 ...
 fragoff = __extension__({ u_int16_t __swap16_x = (ip6f->ip6f_offlg & 0xf8ff); __builtin_constant_p(ip6f->ip6f_offlg & 0xf8ff) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
 if (fragoff == 0) {
 ...
 frgpartlen = sizeof(struct ip6_hdr) + __extension__({ u_int16_t __swap16_x = (ip6->ip6_ctlun.ip6_un1.ip6_un1_plen); __builtin_constant_p(ip6->ip6_ctlun.ip6_un1.ip6_un1_plen) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }) - offset;
 ...
 ip6af = (struct ip6asfrag *)malloc(sizeof(struct ip6asfrag), 7,
     0x0001);
 if (ip6af == 0L)
  goto dropfrag;
 ...
 ecn = (__extension__({ u_int32_t __swap32_x = (ip6->ip6_ctlun.ip6_un1.ip6_un1_flow); __builtin_constant_p(ip6->ip6_ctlun.ip6_un1.ip6_un1_flow) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); }) >> 20) & 0x03;
 ecn0 = (__extension__({ u_int32_t __swap32_x = (q6->ip6q_down->ip6af_head); __builtin_constant_p(q6->ip6q_down->ip6af_head) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); }) >> 20) & 0x03;
 if (ecn == 0x03) {
  if (ecn0 == 0x00) {
   free(ip6af, 7);
   goto dropfrag;
  ...
  if (ecn0 != 0x03)
   q6->ip6q_down->ip6af_head |= __extension__({ u_int32_t __swap32_x = (0x03 << 20); __builtin_constant_p(0x03 << 20) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); });
 }
...
insert:
 ...
 free(ip6af, 7);
 ip6 = ((struct ip6_hdr *)((m)->m_hdr.mh_data));
 ip6->ip6_ctlun.ip6_un1.ip6_un1_plen = __extension__({ u_int16_t __swap16_x = ((u_short)next + offset - sizeof(struct ip6_hdr)); __builtin_constant_p((u_short)next + offset - sizeof(struct ip6_hdr)) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
 ...
 if (offset < m->m_hdr.mh_len) {
  ...
  if ((t = m_split(m, offset, 0x0001)) == 0L) {
   frag6_remque(q6);
 ...
 do { if (dstifp) ((struct in6_ifextra *)((dstifp)->if_afdata[24]))->in6_ifstat->ifs6_reass_ok++; } while (0);
 ...
 struct ip6q *q6;
{
 ...
 do { if (global_ip6q_locked[get_stack_id()] == 0) { printf("%s:%d: ip6q lock not held\n", "openbsd3/netinet6/frag6.c", 631); panic("ip6q lock check"); } } while (0);
 ...
 struct ip6asfrag *af6, *up6;
{
 ...
 do { if (global_ip6q_locked[get_stack_id()] == 0) { printf("%s:%d: ip6q lock not held\n", "openbsd3/netinet6/frag6.c", 675); panic("ip6q lock check"); } } while (0);
 ...
 struct ip6asfrag *af6;
{
 ...
 do { if (global_ip6q_locked[get_stack_id()] == 0) { printf("%s:%d: ip6q lock not held\n", "openbsd3/netinet6/frag6.c", 691); panic("ip6q lock check"); } } while (0);
 ...
 struct ip6q *new, *old;
{
 ...
 do { if (global_ip6q_locked[get_stack_id()] == 0) { printf("%s:%d: ip6q lock not held\n", "openbsd3/netinet6/frag6.c", 702); panic("ip6q lock check"); } } while (0);
 ...
 struct ip6q *p6;
{
 ...
 do { if (global_ip6q_locked[get_stack_id()] == 0) { printf("%s:%d: ip6q lock not held\n", "openbsd3/netinet6/frag6.c", 715); panic("ip6q lock check"); } } while (0);
...
frag6_slowtimo()
{
 ...
 do { if (ip6q_lock_try() == 0) { printf("%s:%d: ip6q already locked\n", "openbsd3/netinet6/frag6.c", 732); panic("ip6q_lock"); } } while (0);
