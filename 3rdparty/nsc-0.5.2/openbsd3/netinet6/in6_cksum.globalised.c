# 1 "openbsd3/netinet6/in6_cksum.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/netinet6/in6_cksum.c"
# 64 "openbsd3/netinet6/in6_cksum.c"
...
# 65 "openbsd3/netinet6/in6_cksum.c" 2
...
# 66 "openbsd3/netinet6/in6_cksum.c" 2
...
# 67 "openbsd3/netinet6/in6_cksum.c" 2
...
# 68 "openbsd3/netinet6/in6_cksum.c" 2
...
# 69 "openbsd3/netinet6/in6_cksum.c" 2
# 87 "openbsd3/netinet6/in6_cksum.c"
int
 ...
 u_int32_t off, len;
{
 ...
 uph.ph.ph_len = __extension__({ u_int32_t __swap32_x = (len); __builtin_constant_p(len) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); });
 uph.ph.ph_nxt = nxt;
 ...
 for (;m && len; m = m->m_hdr.mh_next) {
  ...
  if (mlen == -1) {
# 228 "openbsd3/netinet6/in6_cksum.c"
   s_util.c[1] = *(char *)w;
   sum += s_util.s;
   w = (u_int16_t *)((char *)w + 1);
