# 1 "openbsd3/netinet6/dest6.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/netinet6/dest6.c"
# 33 "openbsd3/netinet6/dest6.c"
...
# 34 "openbsd3/netinet6/dest6.c" 2
...
# 35 "openbsd3/netinet6/dest6.c" 2
...
# 36 "openbsd3/netinet6/dest6.c" 2
...
# 37 "openbsd3/netinet6/dest6.c" 2
...
# 38 "openbsd3/netinet6/dest6.c" 2
...
# 39 "openbsd3/netinet6/dest6.c" 2
...
void pfctlinput(int, struct sockaddr *);
# 40 "openbsd3/netinet6/dest6.c" 2
# 1 "openbsd3/sys/errno.h" 1
# 41 "openbsd3/netinet6/dest6.c" 2
...
# 43 "openbsd3/netinet6/dest6.c" 2
...
# 45 "openbsd3/netinet6/dest6.c" 2
...
# 46 "openbsd3/netinet6/dest6.c" 2
...
# 48 "openbsd3/netinet6/dest6.c" 2
...
# 49 "openbsd3/netinet6/dest6.c" 2
...
# 50 "openbsd3/netinet6/dest6.c" 2
...
# 51 "openbsd3/netinet6/dest6.c" 2
...
# 52 "openbsd3/netinet6/dest6.c" 2
 ...
 int *offp, proto;
{
 ...
 do { struct mbuf *t; int tmp; if ((m)->m_hdr.mh_len >= (off) + (sizeof(*dstopts))) (dstopts) = (struct ip6_dest *)(((caddr_t)(((m))->m_hdr.mh_data)) + (off)); else { t = m_pulldown((m), (off), (sizeof(*dstopts)), &tmp); if (t) { if (t->m_hdr.mh_len < tmp + (sizeof(*dstopts))) panic("m_pulldown malfunction"); (dstopts) = (struct ip6_dest *)(((caddr_t)((t)->m_hdr.mh_data)) + tmp); } else { (dstopts) = (struct ip6_dest *)0L; (m) = 0L; } } } while (0);
 if (dstopts == 0L)
  return 257;
 dstoptlen = (dstopts->ip6d_len + 1) << 3;

 do { struct mbuf *t; int tmp; if ((m)->m_hdr.mh_len >= (off) + (dstoptlen)) (dstopts) = (struct ip6_dest *)(((caddr_t)(((m))->m_hdr.mh_data)) + (off)); else { t = m_pulldown((m), (off), (dstoptlen), &tmp); if (t) { if (t->m_hdr.mh_len < tmp + (dstoptlen)) panic("m_pulldown malfunction"); (dstopts) = (struct ip6_dest *)(((caddr_t)((t)->m_hdr.mh_data)) + tmp); } else { (dstopts) = (struct ip6_dest *)0L; (m) = 0L; } } } while (0);
 if (dstopts == 0L)
  return 257;
 off += dstoptlen;
