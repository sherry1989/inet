# 1 "openbsd3/netinet6/udp6_output.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/netinet6/udp6_output.c"
# 64 "openbsd3/netinet6/udp6_output.c"
...
# 65 "openbsd3/netinet6/udp6_output.c" 2
...
# 66 "openbsd3/netinet6/udp6_output.c" 2
...
# 67 "openbsd3/netinet6/udp6_output.c" 2
...
# 68 "openbsd3/netinet6/udp6_output.c" 2
...
void pfctlinput(int, struct sockaddr *);
# 69 "openbsd3/netinet6/udp6_output.c" 2
...
int recvit(struct proc *, int, struct msghdr *, caddr_t,
      register_t *);
# 70 "openbsd3/netinet6/udp6_output.c" 2
# 1 "openbsd3/sys/errno.h" 1
# 71 "openbsd3/netinet6/udp6_output.c" 2
...
# 72 "openbsd3/netinet6/udp6_output.c" 2
...
# 73 "openbsd3/netinet6/udp6_output.c" 2
...
# 74 "openbsd3/netinet6/udp6_output.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__printf__,1,2))) ;
void logwakeup(void);
# 75 "openbsd3/netinet6/udp6_output.c" 2
...
# 77 "openbsd3/netinet6/udp6_output.c" 2
...
# 78 "openbsd3/netinet6/udp6_output.c" 2
# 1 "openbsd3/net/if_types.h" 1
# 79 "openbsd3/netinet6/udp6_output.c" 2
...
# 81 "openbsd3/netinet6/udp6_output.c" 2
...
# 82 "openbsd3/netinet6/udp6_output.c" 2
...
n_time iptime(void);
# 83 "openbsd3/netinet6/udp6_output.c" 2
...
# 84 "openbsd3/netinet6/udp6_output.c" 2
...
typedef  struct ipstat   _GLOBAL_131_T; extern  _GLOBAL_131_T  global_ipstat[NUM_STACKS];    
typedef  struct ipqhead { struct ipq   * lh_first  ;  }   _GLOBAL_132_T; extern  _GLOBAL_132_T  global_ipq[NUM_STACKS];         
typedef  int  _GLOBAL_133_T; extern  _GLOBAL_133_T  global_ip_defttl[NUM_STACKS];   

typedef  int  _GLOBAL_134_T; extern  _GLOBAL_134_T  global_ip_mtudisc[NUM_STACKS];   
typedef  u_int  _GLOBAL_135_T; extern  _GLOBAL_135_T  global_ip_mtudisc_timeout[NUM_STACKS];   
typedef  struct rttimer_queue   _GLOBAL_136_T; extern  _GLOBAL_136_T  * global_ip_mtudisc_timeout_q[NUM_STACKS];    
typedef  struct pool   _GLOBAL_137_T; extern  _GLOBAL_137_T  global_ipqent_pool[NUM_STACKS];    
...
# 85 "openbsd3/netinet6/udp6_output.c" 2
...
typedef  struct ip6stat   _GLOBAL_138_T; extern  _GLOBAL_138_T  global_ip6stat[NUM_STACKS];    
typedef  int  _GLOBAL_139_T; extern  _GLOBAL_139_T  global_ip6_defhlim[NUM_STACKS];   
typedef  int  _GLOBAL_140_T; extern  _GLOBAL_140_T  global_ip6_defmcasthlim[NUM_STACKS];   
typedef  int  _GLOBAL_141_T; extern  _GLOBAL_141_T  global_ip6_forwarding[NUM_STACKS];   
typedef  int  _GLOBAL_142_T; extern  _GLOBAL_142_T  global_ip6_sendredirect[NUM_STACKS];   
typedef  int  _GLOBAL_143_T; extern  _GLOBAL_143_T  global_ip6_forward_srcrt[NUM_STACKS];   
typedef  int  _GLOBAL_144_T; extern  _GLOBAL_144_T  global_ip6_use_deprecated[NUM_STACKS];   
typedef  int  _GLOBAL_145_T; extern  _GLOBAL_145_T  global_ip6_rr_prune[NUM_STACKS];   

typedef  const int   _GLOBAL_146_T; extern  _GLOBAL_146_T  global_ip6_v6only[NUM_STACKS];    

typedef  struct socket   _GLOBAL_147_T; extern  _GLOBAL_147_T  * global_ip6_mrouter[NUM_STACKS];    
typedef  int  _GLOBAL_148_T; extern  _GLOBAL_148_T  global_ip6_sendredirects[NUM_STACKS];   
typedef  int  _GLOBAL_149_T; extern  _GLOBAL_149_T  global_ip6_maxfragpackets[NUM_STACKS];   
typedef  int  _GLOBAL_150_T; extern  _GLOBAL_150_T  global_ip6_maxfrags[NUM_STACKS];   
typedef  int  _GLOBAL_151_T; extern  _GLOBAL_151_T  global_ip6_sourcecheck[NUM_STACKS];   
typedef  int  _GLOBAL_152_T; extern  _GLOBAL_152_T  global_ip6_sourcecheck_interval[NUM_STACKS];   
typedef  int  _GLOBAL_153_T; extern  _GLOBAL_153_T  global_ip6_accept_rtadv[NUM_STACKS];   
typedef  int  _GLOBAL_154_T; extern  _GLOBAL_154_T  global_ip6_keepfaith[NUM_STACKS];   
typedef  int  _GLOBAL_155_T; extern  _GLOBAL_155_T  global_ip6_log_interval[NUM_STACKS];   
typedef  time_t  _GLOBAL_156_T; extern  _GLOBAL_156_T  global_ip6_log_time[NUM_STACKS];   
typedef  int  _GLOBAL_157_T; extern  _GLOBAL_157_T  global_ip6_hdrnestlimit[NUM_STACKS];   
typedef  int  _GLOBAL_158_T; extern  _GLOBAL_158_T  global_ip6_dad_count[NUM_STACKS];   

typedef  u_int32_t  _GLOBAL_159_T; extern  _GLOBAL_159_T  global_ip6_flow_seq[NUM_STACKS];   
...
# 86 "openbsd3/netinet6/udp6_output.c" 2
...
# 87 "openbsd3/netinet6/udp6_output.c" 2
...
typedef  struct inpcbtable   _GLOBAL_196_T; extern  _GLOBAL_196_T  global_udbtable[NUM_STACKS];    
typedef  struct udpstat   _GLOBAL_197_T; extern  _GLOBAL_197_T  global_udpstat[NUM_STACKS];    
...
int udp_usrreq(struct socket *,
     int, struct mbuf *, struct mbuf *, struct mbuf *);
# 88 "openbsd3/netinet6/udp6_output.c" 2
...
# 92 "openbsd3/netinet6/udp6_output.c" 2

# 1 "openbsd3/openbsd/usr/src/sys/arch/i386/compile/SAMSKERNEL/faith.h" 1
# 94 "openbsd3/netinet6/udp6_output.c" 2
# 114 "openbsd3/netinet6/udp6_output.c"
int
 ...
 struct mbuf *addr6, *control;
{
 ...
 if ((in6p->inp_socket->so_state & 0x080) != 0)
  priv = 1;
 stickyopt = in6p->inp_outputopts6;
 if (control) {
  if ((error = ip6_setpktoptions(control, &opt, priv)) != 0)
   goto release;
  in6p->inp_outputopts6 = &opt;
 }

 if (addr6) {
# 153 "openbsd3/netinet6/udp6_output.c"
  ...
  if (in6_embedscope(&sin6->sin6_addr, sin6, in6p, 0L) != 0) {
   error = 22;
   goto release;
  }
  ...
  if (1)
  {
   laddr = in6_selectsrc(sin6, in6p->inp_outputopts6,
           in6p->inp_mou.mou_mo6,
           &in6p->inp_ru.ru_route6,
 ...
 { if ((((((m))->m_hdr.mh_flags & 0x0001) != 0 && ((((m))->m_hdr.mh_flags & 0x0008) == 0 || (((m))->M_dat.MH.MH_dat.MH_ext.ext_nextref != ((m))))) ? 0 : (((m))->m_hdr.mh_flags & 0x0001 ? ((m))->m_hdr.mh_data - ((m))->M_dat.MH.MH_dat.MH_ext.ext_buf : ((m))->m_hdr.mh_flags & 0x0002 ? ((m))->m_hdr.mh_data - ((m))->M_dat.MH.MH_dat.MH_databuf : ((m))->m_hdr.mh_data - ((m))->M_dat.M_databuf)) >= (hlen + sizeof(struct udphdr))) { (m)->m_hdr.mh_data -= (hlen + sizeof(struct udphdr)); (m)->m_hdr.mh_len += (hlen + sizeof(struct udphdr)); } else (m) = m_prepend((m), (hlen + sizeof(struct udphdr)), (0x0001)); if ((m) && (m)->m_hdr.mh_flags & 0x0002) (m)->M_dat.MH.MH_pkthdr.len += (hlen + sizeof(struct udphdr)); };
 if (m == 0) {
  error = 55;
  goto release;
 }
 ...
 udp6->uh_dport = fport;
 if (plen <= 0xffff)
  udp6->uh_ulen = __extension__({ u_int16_t __swap16_x = ((u_short)plen); __builtin_constant_p((u_short)plen) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
 else
  udp6->uh_ulen = 0;
 udp6->uh_sum = 0;
 ...
 case 24:
  ...
  ip6->ip6_ctlun.ip6_un1.ip6_un1_hlim = in6_selecthlim(in6p,
       in6p->inp_ru.ru_route6.ro_rt ?
       in6p->inp_ru.ru_route6.ro_rt->rt_ifp : 0L);
  ip6->ip6_src = *laddr;
  ip6->ip6_dst = *faddr;
  ...
  error = ip6_output(m, in6p->inp_outputopts6, &in6p->inp_ru.ru_route6,
       flags, in6p->inp_mou.mou_mo6, 0L);
  break;
 case 2:
  error = 47;
  goto release;
...
releaseopt:
 if (control) {
  in6p->inp_outputopts6 = stickyopt;
  m_freem(control);
 }
 return (error);
}
