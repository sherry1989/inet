# 1 "openbsd3/netinet6/nd6_rtr.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/netinet6/nd6_rtr.c"
# 33 "openbsd3/netinet6/nd6_rtr.c"
...
# 34 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 35 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 36 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 37 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 41 "openbsd3/netinet6/nd6_rtr.c" 2
# 1 "openbsd3/sys/errno.h" 1
# 42 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 43 "openbsd3/netinet6/nd6_rtr.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__printf__,1,2))) ;
void logwakeup(void);
# 44 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 45 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 47 "openbsd3/netinet6/nd6_rtr.c" 2
# 1 "openbsd3/net/if_types.h" 1
# 48 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 49 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 50 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 53 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 54 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 55 "openbsd3/netinet6/nd6_rtr.c" 2
...
typedef  struct ip6stat   _GLOBAL_122_T; extern  _GLOBAL_122_T  global_ip6stat[NUM_STACKS];    
typedef  int  _GLOBAL_123_T; extern  _GLOBAL_123_T  global_ip6_defhlim[NUM_STACKS];   
typedef  int  _GLOBAL_124_T; extern  _GLOBAL_124_T  global_ip6_defmcasthlim[NUM_STACKS];   
typedef  int  _GLOBAL_125_T; extern  _GLOBAL_125_T  global_ip6_forwarding[NUM_STACKS];   
typedef  int  _GLOBAL_126_T; extern  _GLOBAL_126_T  global_ip6_sendredirect[NUM_STACKS];   
typedef  int  _GLOBAL_127_T; extern  _GLOBAL_127_T  global_ip6_forward_srcrt[NUM_STACKS];   
typedef  int  _GLOBAL_128_T; extern  _GLOBAL_128_T  global_ip6_use_deprecated[NUM_STACKS];   
typedef  int  _GLOBAL_129_T; extern  _GLOBAL_129_T  global_ip6_rr_prune[NUM_STACKS];   

typedef  const int   _GLOBAL_130_T; extern  _GLOBAL_130_T  global_ip6_v6only[NUM_STACKS];    

typedef  struct socket   _GLOBAL_131_T; extern  _GLOBAL_131_T  * global_ip6_mrouter[NUM_STACKS];    
typedef  int  _GLOBAL_132_T; extern  _GLOBAL_132_T  global_ip6_sendredirects[NUM_STACKS];   
typedef  int  _GLOBAL_133_T; extern  _GLOBAL_133_T  global_ip6_maxfragpackets[NUM_STACKS];   
typedef  int  _GLOBAL_134_T; extern  _GLOBAL_134_T  global_ip6_maxfrags[NUM_STACKS];   
typedef  int  _GLOBAL_135_T; extern  _GLOBAL_135_T  global_ip6_sourcecheck[NUM_STACKS];   
typedef  int  _GLOBAL_136_T; extern  _GLOBAL_136_T  global_ip6_sourcecheck_interval[NUM_STACKS];   
typedef  int  _GLOBAL_137_T; extern  _GLOBAL_137_T  global_ip6_accept_rtadv[NUM_STACKS];   
typedef  int  _GLOBAL_138_T; extern  _GLOBAL_138_T  global_ip6_keepfaith[NUM_STACKS];   
typedef  int  _GLOBAL_139_T; extern  _GLOBAL_139_T  global_ip6_log_interval[NUM_STACKS];   
typedef  time_t  _GLOBAL_140_T; extern  _GLOBAL_140_T  global_ip6_log_time[NUM_STACKS];   
typedef  int  _GLOBAL_141_T; extern  _GLOBAL_141_T  global_ip6_hdrnestlimit[NUM_STACKS];   
typedef  int  _GLOBAL_142_T; extern  _GLOBAL_142_T  global_ip6_dad_count[NUM_STACKS];   

typedef  u_int32_t  _GLOBAL_143_T; extern  _GLOBAL_143_T  global_ip6_flow_seq[NUM_STACKS];   
...
# 56 "openbsd3/netinet6/nd6_rtr.c" 2
...
typedef  struct nd_drhead   _GLOBAL_154_T; extern  _GLOBAL_154_T  global_nd_defrouter[NUM_STACKS];    
typedef  struct nd_prhead   _GLOBAL_155_T; extern  _GLOBAL_155_T  global_nd_prefix[NUM_STACKS];    
typedef  int  _GLOBAL_156_T; extern  _GLOBAL_156_T  global_nd6_debug[NUM_STACKS];   



typedef  struct timeout   _GLOBAL_157_T; extern  _GLOBAL_157_T  global_nd6_timer_ch[NUM_STACKS];    


typedef  int  _GLOBAL_158_T; extern  _GLOBAL_158_T  global_nd6_defifindex[NUM_STACKS];   
...
# 57 "openbsd3/netinet6/nd6_rtr.c" 2
...
# 58 "openbsd3/netinet6/nd6_rtr.c" 2
...
typedef  int  _GLOBAL_161_T; extern  _GLOBAL_161_T  global_nd6_recalc_reachtm_interval[NUM_STACKS];   

typedef  struct ifnet   _GLOBAL_162_T; static  _GLOBAL_162_T  * global_nd6_defifp[NUM_STACKS];    
typedef  int _GLOBAL_163_T;  _GLOBAL_163_T  global_nd6_defifindex[NUM_STACKS];  
typedef  struct ifaddr   _GLOBAL_164_T; static  _GLOBAL_164_T  * global_nd6_defif_installed[NUM_STACKS] = {  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  0L,  };      
# 92 "openbsd3/netinet6/nd6_rtr.c"
void
 ...
 int off, icmp6len;
{
 ...
 if (global_ip6_accept_rtadv[get_stack_id()] != 0 || !global_ip6_forwarding[get_stack_id()])
  goto freeit;


 if (ip6->ip6_ctlun.ip6_un1.ip6_un1_hlim != 255) {
  do { if (global_nd6_debug[get_stack_id()]) log (3, "nd6_rs_input: invalid hlim (%d) from %s to %s on %s\n", ip6->ip6_ctlun.ip6_un1.ip6_un1_hlim, ip6_sprintf(&ip6->ip6_src), ip6_sprintf(&ip6->ip6_dst), ifp->if_xname); } while (0)
 ...
 if (nd_rs == 0L) {
  (*_GLOBAL_icmp6stat_21_A[get_stack_id()]).icp6s_tooshort++;
  return;
 }
 ...
 if (nd6_options(&ndopts) < 0) {
  do { if (global_nd6_debug[get_stack_id()]) log (6, "nd6_rs_input: invalid ND option, ignored\n"); } while (0)
                                                    ;
 ...
 if (lladdr && ((ifp->if_data.ifi_addrlen + 2 + 7) & ~7) != lladdrlen) {
  do { if (global_nd6_debug[get_stack_id()]) log (6, "nd6_rs_input: lladdrlen mismatch for %s " "(if %d, RS packet %d)\n", ip6_sprintf(&saddr6), ifp->if_data.ifi_addrlen, lladdrlen - 2); } while (0)
 ...
 bad:
 (*_GLOBAL_icmp6stat_21_A[get_stack_id()]).icp6s_badrs++;
 m_freem(m);
}
# 180 "openbsd3/netinet6/nd6_rtr.c"
void
...
{
 struct ifnet *ifp = m->M_dat.MH.MH_pkthdr.rcvif;
 struct nd_ifinfo *ndi = (((struct in6_ifextra *)(ifp)->if_afdata[24])->nd_ifinfo);
 struct ip6_hdr *ip6 = ((struct ip6_hdr *)((m)->m_hdr.mh_data));
 ...
 if (ip6->ip6_ctlun.ip6_un1.ip6_un1_hlim != 255) {
  do { if (global_nd6_debug[get_stack_id()]) log (3, "nd6_ra_input: invalid hlim (%d) from %s to %s on %s\n", ip6->ip6_ctlun.ip6_un1.ip6_un1_hlim, ip6_sprintf(&ip6->ip6_src), ip6_sprintf(&ip6->ip6_dst), ifp->if_xname); } while (0)
 ...
 if (!(((&saddr6)->__u6_addr.__u6_addr8[0] == 0xfe) && (((&saddr6)->__u6_addr.__u6_addr8[1] & 0xc0) == 0x80))) {
  do { if (global_nd6_debug[get_stack_id()]) log (3, "nd6_ra_input: src %s is not link-local\n", ip6_sprintf(&saddr6)); } while (0)

                            ;
  goto bad;
 }

 do { struct mbuf *t; int tmp; if ((m)->m_hdr.mh_len >= (off) + (icmp6len)) (nd_ra) = (struct nd_router_advert *)(((caddr_t)(((m))->m_hdr.mh_data)) + (off)); else { t = m_pulldown((m), (off), (icmp6len), &tmp); if (t) { if (t->m_hdr.mh_len < tmp + (icmp6len)) panic("m_pulldown malfunction"); (nd_ra) = (struct nd_router_advert *)(((caddr_t)((t)->m_hdr.mh_data)) + tmp); } else { (nd_ra) = (struct nd_router_advert *)0L; (m) = 0L; } } } while (0);
 if (nd_ra == 0L) {
  (*_GLOBAL_icmp6stat_21_A[get_stack_id()]).icp6s_tooshort++;
  return;
 }
 ...
 if (nd6_options(&ndopts) < 0) {
  do { if (global_nd6_debug[get_stack_id()]) log (6, "nd6_ra_input: invalid ND option, ignored\n"); } while (0)
                                                    ;
 ...
 bzero((caddr_t)(&dr0), (unsigned)(sizeof(dr0)));;
 dr0.rtaddr = saddr6;
 dr0.flags = nd_ra->nd_ra_hdr.icmp6_dataun.icmp6_un_data8[1];
 dr0.rtlifetime = __extension__({ u_int16_t __swap16_x = (nd_ra->nd_ra_hdr.icmp6_dataun.icmp6_un_data16[1]); __builtin_constant_p(nd_ra->nd_ra_hdr.icmp6_dataun.icmp6_un_data16[1]) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
 dr0.expire = time.tv_sec + dr0.rtlifetime;
 dr0.ifp = ifp;

 if (advreachable) {
  (advreachable) = __extension__({ u_int32_t __swap32_x = ((u_int32_t)(advreachable)); __builtin_constant_p((u_int32_t)(advreachable)) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); });
 ...
 if (nd_ra->nd_ra_retransmit)
  ndi->retrans = __extension__({ u_int32_t __swap32_x = (nd_ra->nd_ra_retransmit); __builtin_constant_p(nd_ra->nd_ra_retransmit) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); });
 ...
 if (ndopts.nd_opt_each.pi_beg) {
  ...
  struct nd_opt_prefix_info *pi = 0L;
  struct nd_prefix pr;
  ...
  for (pt = (struct nd_opt_hdr *)ndopts.nd_opt_each.pi_beg;
   ...
   if (pi->nd_opt_pi_len != 4) {
    do { if (global_nd6_debug[get_stack_id()]) log (6, "nd6_ra_input: invalid option " "len %d for prefix information option, " "ignored\n", pi->nd_opt_pi_len); } while (0)
   ...
   if (128 < pi->nd_opt_pi_prefix_len) {
    do { if (global_nd6_debug[get_stack_id()]) log (6, "nd6_ra_input: invalid prefix " "len %d for prefix information option, " "ignored\n", pi->nd_opt_pi_prefix_len); } while (0)
   ...
   if (((&pi->nd_opt_pi_prefix)->__u6_addr.__u6_addr8[0] == 0xff)
    ...
    do { if (global_nd6_debug[get_stack_id()]) log (6, "nd6_ra_input: invalid prefix " "%s, ignored\n", ip6_sprintf(&pi->nd_opt_pi_prefix)); } while (0)
   ...
   if ((pi->nd_opt_pi_prefix.__u6_addr.__u6_addr8[0] & 0xe0) == 0x20
    ...
    do { if (global_nd6_debug[get_stack_id()]) log (6, "nd6_ra_input: invalid prefixlen " "%d for rfc2374 prefix %s, ignored\n", pi->nd_opt_pi_prefix_len, ip6_sprintf(&pi->nd_opt_pi_prefix)); } while (0)
   ...
   pr.ndpr_vltime = __extension__({ u_int32_t __swap32_x = (pi->nd_opt_pi_valid_time); __builtin_constant_p(pi->nd_opt_pi_valid_time) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); });
   pr.ndpr_pltime = __extension__({ u_int32_t __swap32_x = (pi->nd_opt_pi_preferred_time); __builtin_constant_p(pi->nd_opt_pi_preferred_time) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); });
 ...
 if (ndopts.nd_opt_each.mtu && ndopts.nd_opt_each.mtu->nd_opt_mtu_len == 1) {
  ...
  mtu = __extension__({ u_int32_t __swap32_x = (ndopts.nd_opt_each.mtu->nd_opt_mtu_mtu); __builtin_constant_p(ndopts.nd_opt_each.mtu->nd_opt_mtu_mtu) ? __extension__({ u_int32_t __swap32gen_x = (__swap32_x); (u_int32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : ({ u_int32_t __swap32md_x = (__swap32_x); __asm ("bswap %1" : "+r" (__swap32md_x)); __swap32md_x; }); });


  if (mtu < 1280) {
   do { if (global_nd6_debug[get_stack_id()]) log (6, "nd6_ra_input: bogus mtu option " "mtu=%lu sent from %s, ignoring\n", mtu, ip6_sprintf(&ip6->ip6_src)); } while (0)
  ...
  if (mtu <= maxmtu) {
   ...
   do { if (global_nd6_debug[get_stack_id()]) log (6, "nd6_ra_input: bogus mtu " "mtu=%lu sent from %s; " "exceeds maxmtu %lu, ignoring\n", mtu, ip6_sprintf(&ip6->ip6_src), maxmtu); } while (0)
 ...
 if (lladdr && ((ifp->if_data.ifi_addrlen + 2 + 7) & ~7) != lladdrlen) {
  do { if (global_nd6_debug[get_stack_id()]) log (6, "nd6_ra_input: lladdrlen mismatch for %s " "(if %d, RA packet %d)\n", ip6_sprintf(&saddr6), ifp->if_data.ifi_addrlen, lladdrlen - 2); } while (0)
 ...
 bad:
 (*_GLOBAL_icmp6stat_21_A[get_stack_id()]).icp6s_badra++;
 m_freem(m);
}
 ...
 struct nd_defrouter *new;
{
 ...
 bzero((caddr_t)(&def), (unsigned)(sizeof(def)));;
 bzero((caddr_t)(&mask), (unsigned)(sizeof(mask)));;
 bzero((caddr_t)(&gate), (unsigned)(sizeof(gate)));;

 def.sin6_len = mask.sin6_len = gate.sin6_len =
     sizeof(struct sockaddr_in6);
 def.sin6_family = mask.sin6_family = gate.sin6_family = 24;
 ...
 s = splraise((0x20 + ((1) << 4)));
 error = rtrequest(0x1, (struct sockaddr *)&def,
 ...
 struct ifnet *ifp;
{
 ...
 if (global_nd6_defif_installed[get_stack_id()])
  defrouter_delifreq();
 ...
 def.sin6_family = mask.sin6_family = 24;





 if ((ifa = ifaof_ifpforaddr((struct sockaddr *)&def, ifp)) == 0L) {
  do { if (global_nd6_debug[get_stack_id()]) log (3, "defrouter_addifreq: failed to find an ifaddr " "to install a route to interface %s\n", ifp->if_xname); } while (0)
 ...
 flags = ifa->ifa_flags | 0x100;
 bzero(&info, sizeof(info));
 info.rti_info[0] = (struct sockaddr *)&def;
 info.rti_info[1] = (struct sockaddr *)ifa->ifa_addr;
 info.rti_info[2] = (struct sockaddr *)&mask;
 info.rti_info[5] = (struct sockaddr *)ifa->ifa_addr;
 info.rti_flags = flags;
 error = rtrequest1(0x1, &info, &newrt);
 if (error != 0) {
  do { if (global_nd6_debug[get_stack_id()]) log (3, "defrouter_addifreq: failed to install a route to " "interface %s (errno = %d)\n", ifp->if_xname, error); } while (0)
 ...
 global_nd6_defif_installed[get_stack_id()] = ifa;
 ifa->ifa_refcnt++;
}
...
defrouter_delifreq()
{
 ...
 rtrequest(0x2, (struct sockaddr *)&def,
     (struct sockaddr *)global_nd6_defif_installed[get_stack_id()]->ifa_addr,
 ...
 do { if ((global_nd6_defif_installed[get_stack_id()])->ifa_refcnt <= 0) ifafree(global_nd6_defif_installed[get_stack_id()]); else (global_nd6_defif_installed[get_stack_id()])->ifa_refcnt--; } while (0);
 global_nd6_defif_installed[get_stack_id()] = 0L;
}
 ...
 struct nd_defrouter *dr;
{
 ...
 do { if (((dr)->dr_entry.tqe_next) != 0L) (dr)->dr_entry.tqe_next->dr_entry.tqe_prev = (dr)->dr_entry.tqe_prev; else (&global_nd_defrouter[get_stack_id()])->tqh_last = (dr)->dr_entry.tqe_prev; *(dr)->dr_entry.tqe_prev = (dr)->dr_entry.tqe_next; } while (0);
 ...
 for (pr = global_nd_prefix[get_stack_id()].lh_first; pr; pr = pr->ndpr_entry.le_next) {
  ...
  if ((pfxrtr = pfxrtr_lookup(pr, dr)) != 0L)
   pfxrtr_del(pfxrtr);
 }
 pfxlist_onlink_check();
 ...
 struct nd_defrouter *dr;
{
 ...
 bzero((caddr_t)(&def), (unsigned)(sizeof(def)));;
 bzero((caddr_t)(&mask), (unsigned)(sizeof(mask)));;
 bzero((caddr_t)(&gw), (unsigned)(sizeof(gw)));;

 def.sin6_len = mask.sin6_len = gw.sin6_len =
     sizeof(struct sockaddr_in6);
 def.sin6_family = mask.sin6_family = gw.sin6_family = 24;
...
# 716 "openbsd3/netinet6/nd6_rtr.c"
void
defrouter_select()
{
 int s = splraise((0x20 + ((1) << 4)));
 struct nd_defrouter *dr, *selected_dr = 0L, *installed_dr = 0L;
 ...
 if (global_ip6_forwarding[get_stack_id()] || !global_ip6_accept_rtadv[get_stack_id()]) {
  do { if (global_nd6_debug[get_stack_id()]) log (4, "defrouter_select: called unexpectedly (forwarding=%d, " "accept_rtadv=%d)\n", global_ip6_forwarding[get_stack_id()], global_ip6_accept_rtadv[get_stack_id()]); } while (0)
 ...
 if (!((&global_nd_defrouter[get_stack_id()])->tqh_first)) {
# 752 "openbsd3/netinet6/nd6_rtr.c"
  if (!global_ip6_forwarding[get_stack_id()]) {
   if (global_nd6_defifp[get_stack_id()]) {
    ...
    defrouter_delifreq();
    do { if (global_nd6_debug[get_stack_id()]) log (6, "defrouter_select: " "there's no default router and no default" " interface\n"); } while (0)
 ...
 for (dr = ((&global_nd_defrouter[get_stack_id()])->tqh_first); dr;
  ...
  if (dr->installed && !installed_dr)
   ...
   log(3, "defrouter_select: more than one router"
       " is installed\n");
  }
 }
# 811 "openbsd3/netinet6/nd6_rtr.c"
 if (!selected_dr) {
  if (!installed_dr || !((installed_dr)->dr_entry.tqe_next))
   selected_dr = ((&global_nd_defrouter[get_stack_id()])->tqh_first);
  else
   selected_dr = ((installed_dr)->dr_entry.tqe_next);
...
{
# 866 "openbsd3/netinet6/nd6_rtr.c"
 return 0;
 ...
 struct nd_defrouter *new;
{
 ...
 if ((dr = defrouter_lookup(&new->rtaddr, new->ifp)) != 0L) {
...
# 908 "openbsd3/netinet6/nd6_rtr.c"
   do { if (((dr)->dr_entry.tqe_next) != 0L) (dr)->dr_entry.tqe_next->dr_entry.tqe_prev = (dr)->dr_entry.tqe_prev; else (&global_nd_defrouter[get_stack_id()])->tqh_last = (dr)->dr_entry.tqe_prev; *(dr)->dr_entry.tqe_prev = (dr)->dr_entry.tqe_next; } while (0);
   n = dr;
   goto insert;
  }
 ...
 n = (struct nd_defrouter *)malloc(sizeof(*n), 124, 0x0001);
 if (n == 0L) {
  splx(s);
  return (0L);
 }
...
insert:
# 939 "openbsd3/netinet6/nd6_rtr.c"
 for (dr = ((&global_nd_defrouter[get_stack_id()])->tqh_first); dr;
      dr = ((dr)->dr_entry.tqe_next)) {
 ...
 if (dr)
  do { (n)->dr_entry.tqe_prev = (dr)->dr_entry.tqe_prev; (n)->dr_entry.tqe_next = (dr); *(dr)->dr_entry.tqe_prev = (n); (dr)->dr_entry.tqe_prev = &(n)->dr_entry.tqe_next; } while (0);
 else
  do { (n)->dr_entry.tqe_next = 0L; (n)->dr_entry.tqe_prev = (&global_nd_defrouter[get_stack_id()])->tqh_last; *(&global_nd_defrouter[get_stack_id()])->tqh_last = (n); (&global_nd_defrouter[get_stack_id()])->tqh_last = &(n)->dr_entry.tqe_next; } while (0);
 ...
 struct nd_defrouter *dr;
{
 ...
 new = (struct nd_pfxrouter *)malloc(sizeof(*new), 124, 0x0001);
 if (new == 0L)
  return;
 bzero(new, sizeof(*new));
 new->router = dr;

 do { if (((new)->pfr_entry.le_next = (&pr->ndpr_advrtrs)->lh_first) != 0L) (&pr->ndpr_advrtrs)->lh_first->pfr_entry.le_prev = &(new)->pfr_entry.le_next; (&pr->ndpr_advrtrs)->lh_first = (new); (new)->pfr_entry.le_prev = &(&pr->ndpr_advrtrs)->lh_first; } while (0);
...
{
 do { if ((pfr)->pfr_entry.le_next != 0L) (pfr)->pfr_entry.le_next->pfr_entry.le_prev = (pfr)->pfr_entry.le_prev; *(pfr)->pfr_entry.le_prev = (pfr)->pfr_entry.le_next; } while (0);
 free(pfr, 124);
}
...
nd6_prelist_add(pr, dr, newp)
 ...
 struct nd_defrouter *dr;
{
 struct nd_prefix *new = 0L;
 int i, s;

 new = (struct nd_prefix *)malloc(sizeof(*new), 124, 0x0001);
 if (new == 0L)
  return 12;
 bzero(new, sizeof(*new));
 *new = *pr;
 ...
 do { ((&new->ndpr_advrtrs)->lh_first) = 0L; } while (0);
 ...
 do { if (((new)->ndpr_entry.le_next = (&global_nd_prefix[get_stack_id()])->lh_first) != 0L) (&global_nd_prefix[get_stack_id()])->lh_first->ndpr_entry.le_prev = &(new)->ndpr_entry.le_next; (&global_nd_prefix[get_stack_id()])->lh_first = (new); (new)->ndpr_entry.le_prev = &(&global_nd_prefix[get_stack_id()])->lh_first; } while (0);
 splx(s);
 ...
 if (new->ndpr_flags.onlink) {
  ...
  if ((e = nd6_prefix_onlink(new)) != 0) {
   do { if (global_nd6_debug[get_stack_id()]) log (3, "nd6_prelist_add: failed to make " "the prefix %s/%d on-link on %s (errno=%d)\n", ip6_sprintf(&pr->ndpr_prefix.sin6_addr), pr->ndpr_plen, pr->ndpr_ifp->if_xname, e); } while (0)
 ...
 struct nd_prefix *pr;
{
 ...
 pr->ndpr_vltime = 0;
 pr->ndpr_pltime = 0;
# 1081 "openbsd3/netinet6/nd6_rtr.c"
 if ((pr->ndpr_stateflags & 0x1) != 0 &&
     (e = nd6_prefix_offlink(pr)) != 0) {
  do { if (global_nd6_debug[get_stack_id()]) log (3, "prelist_remove: failed to make %s/%d offlink " "on %s, errno=%d\n", ip6_sprintf(&pr->ndpr_prefix.sin6_addr), pr->ndpr_plen, pr->ndpr_ifp->if_xname, e); } while (0)
 ...
 do { if ((pr)->ndpr_entry.le_next != 0L) (pr)->ndpr_entry.le_next->ndpr_entry.le_prev = (pr)->ndpr_entry.le_prev; *(pr)->ndpr_entry.le_prev = (pr)->ndpr_entry.le_next; } while (0);
...
prelist_update(new, dr, m)
 ...
 struct mbuf *m;
{
 struct in6_ifaddr *ia6 = 0L, *ia6_match = 0L;
 struct ifaddr *ifa;
 ...
 if (m) {
  ...
  auth = ((m->m_hdr.mh_flags & 0x2000) && (m->m_hdr.mh_flags & 0x0800));
 }

 if ((pr = nd6_prefix_lookup(new)) != 0L) {
# 1147 "openbsd3/netinet6/nd6_rtr.c"
  ...
  if (new->ndpr_flags.onlink &&
   ...
   if ((e = nd6_prefix_onlink(pr)) != 0) {
    do { if (global_nd6_debug[get_stack_id()]) log (3, "prelist_update: failed to make " "the prefix %s/%d on-link on %s " "(errno=%d)\n", ip6_sprintf(&pr->ndpr_prefix.sin6_addr), pr->ndpr_plen, pr->ndpr_ifp->if_xname, e); } while (0)
  ...
  if (dr && pfxrtr_lookup(pr, dr) == 0L)
   pfxrtr_add(pr, dr);
 } else {
  struct nd_prefix *newpr = 0L;
  ...
  if (error != 0 || newpr == 0L) {
   do { if (global_nd6_debug[get_stack_id()]) log (5, "prelist_update: " "nd6_prelist_add failed for %s/%d on %s " "errno=%d, returnpr=%p\n", ip6_sprintf(&new->ndpr_prefix.sin6_addr), new->ndpr_plen, new->ndpr_ifp->if_xname, error, newpr); } while (0)
...
# 1204 "openbsd3/netinet6/nd6_rtr.c"
 ...
 if (!new->ndpr_flags.autonomous)
  goto end;
# 1238 "openbsd3/netinet6/nd6_rtr.c"
 for (ifa = ifp->if_addrlist.tqh_first; ifa; ifa = ifa->ifa_list.tqe_next)
 {
  ...
  ifa_plen = in6_mask2len(&ifa6->ia_prefixmask.sin6_addr, 0L);
  ...
  if ((ifa6->ia6_flags & 0x40) == 0)
   continue;
# 1292 "openbsd3/netinet6/nd6_rtr.c"
...
# 1317 "openbsd3/netinet6/nd6_rtr.c"
   ) {
   if (auth) {
    lt6_tmp.ia6t_vltime = new->ndpr_vltime;
   }
 ...
 if (ia6_match == 0L && new->ndpr_vltime) {




  if ((ia6 = in6_ifadd(new)) != 0L) {
...
# 1404 "openbsd3/netinet6/nd6_rtr.c"
void
pfxlist_onlink_check()
{
 struct nd_prefix *pr;
 ...
 if (pr != 0L || ((&global_nd_defrouter[get_stack_id()])->tqh_first) != 0L) {
# 1428 "openbsd3/netinet6/nd6_rtr.c"
  for (pr = global_nd_prefix[get_stack_id()].lh_first; pr; pr = pr->ndpr_entry.le_next) {
   ...
   if ((pr->ndpr_stateflags & 0x2) == 0 &&
       find_pfxlist_reachable_router(pr) == 0L)
...
# 1469 "openbsd3/netinet6/nd6_rtr.c"
 for (pr = global_nd_prefix[get_stack_id()].lh_first; pr; pr = pr->ndpr_entry.le_next) {
  int e;
  ...
  if ((pr->ndpr_stateflags & 0x2) != 0 &&
   ...
   if ((e = nd6_prefix_offlink(pr)) != 0) {
    do { if (global_nd6_debug[get_stack_id()]) log (3, "pfxlist_onlink_check: failed to " "make %s/%d offlink, errno=%d\n", ip6_sprintf(&pr->ndpr_prefix.sin6_addr), pr->ndpr_plen, e); } while (0)
...
# 1509 "openbsd3/netinet6/nd6_rtr.c"
 ...
 struct nd_prefix *pr;
{
 ...
 if ((pr->ndpr_stateflags & 0x1) != 0) {
  do { if (global_nd6_debug[get_stack_id()]) log (3, "nd6_prefix_onlink: %s/%d is already on-link\n", ip6_sprintf(&pr->ndpr_prefix.sin6_addr), pr->ndpr_plen); return (17); } while (0)


                  ;
 }
# 1576 "openbsd3/netinet6/nd6_rtr.c"
 ...
 if (ifa == 0L) {
  ...
  do { if (global_nd6_debug[get_stack_id()]) log (5, "nd6_prefix_onlink: failed to find any ifaddr" " to add route for a prefix(%s/%d) on %s\n", ip6_sprintf(&pr->ndpr_prefix.sin6_addr), pr->ndpr_plen, ifp->if_xname); } while (0)
 ...
 if (error == 0) {
  ...
  do { if (global_nd6_debug[get_stack_id()]) log (3, "nd6_prefix_onlink: failed to add route for a" " prefix (%s/%d) on %s, gw=%s, mask=%s, flags=%lx " "errno = %d\n", ip6_sprintf(&pr->ndpr_prefix.sin6_addr), pr->ndpr_plen, ifp->if_xname, ip6_sprintf(&((struct sockaddr_in6 *)ifa->ifa_addr)->sin6_addr), ip6_sprintf(&mask6.sin6_addr), rtflags, error); } while (0)
 ...
 struct nd_prefix *pr;
{
 ...
 if ((pr->ndpr_stateflags & 0x1) == 0) {
  do { if (global_nd6_debug[get_stack_id()]) log (3, "nd6_prefix_offlink: %s/%d is already off-link\n", ip6_sprintf(&pr->ndpr_prefix.sin6_addr), pr->ndpr_plen); } while (0)
 ...
 bzero(&mask6, sizeof(mask6));
 mask6.sin6_family = 24;
 mask6.sin6_len = sizeof(sa6);
 bcopy(&pr->ndpr_mask, &mask6.sin6_addr, sizeof(struct in6_addr));
 error = rtrequest(0x2, (struct sockaddr *)&sa6, 0L,
 ...
 if (error == 0) {
  ...
  if (rt != 0L)
   nd6_rtmsg(0x2, rt);
# 1704 "openbsd3/netinet6/nd6_rtr.c"
  for (opr = global_nd_prefix[get_stack_id()].lh_first; opr; opr = opr->ndpr_entry.le_next) {
   if (opr == pr)
    continue;
   ...
   if (opr->ndpr_plen == pr->ndpr_plen &&
    ...
    if ((e = nd6_prefix_onlink(opr)) != 0) {
     do { if (global_nd6_debug[get_stack_id()]) log (3, "nd6_prefix_offlink: failed to " "recover a prefix %s/%d from %s " "to %s (errno = %d)\n", ip6_sprintf(&opr->ndpr_prefix.sin6_addr), opr->ndpr_plen, ifp->if_xname, opr->ndpr_ifp->if_xname, e); } while (0)
  ...
  do { if (global_nd6_debug[get_stack_id()]) log (3, "nd6_prefix_offlink: failed to delete route: " "%s/%d on %s (errno = %d)\n", ip6_sprintf(&sa6.sin6_addr), pr->ndpr_plen, ifp->if_xname, error); } while (0)
...
# 1788 "openbsd3/netinet6/nd6_rtr.c"
 ifa = (struct ifaddr *)in6ifa_ifpforlinklocal(ifp, 0);
 if (ifa)
  ib = (struct in6_ifaddr *)ifa;
 else
  return 0L;
# 1803 "openbsd3/netinet6/nd6_rtr.c"
 plen0 = in6_mask2len(&ib->ia_prefixmask.sin6_addr, 0L);
 if (prefixlen != plen0) {
  do { if (global_nd6_debug[get_stack_id()]) log (6, "in6_ifadd: wrong prefixlen for %s " "(prefix=%d ifid=%d)\n", ifp->if_xname, prefixlen, 128 - plen0); } while (0)
 ...
 ifra.ifra_addr.sin6_addr.__u6_addr.__u6_addr32[0] |=
     (ib->ia_addr.sin6_addr.__u6_addr.__u6_addr32[0] & ~mask.__u6_addr.__u6_addr32[0]);
 ifra.ifra_addr.sin6_addr.__u6_addr.__u6_addr32[1] |=
     (ib->ia_addr.sin6_addr.__u6_addr.__u6_addr32[1] & ~mask.__u6_addr.__u6_addr32[1]);
 ifra.ifra_addr.sin6_addr.__u6_addr.__u6_addr32[2] |=
     (ib->ia_addr.sin6_addr.__u6_addr.__u6_addr32[2] & ~mask.__u6_addr.__u6_addr32[2]);
 ifra.ifra_addr.sin6_addr.__u6_addr.__u6_addr32[3] |=
     (ib->ia_addr.sin6_addr.__u6_addr.__u6_addr32[3] & ~mask.__u6_addr.__u6_addr32[3]);
 ...
 if ((error = in6_update_ifa(ifp, &ifra, 0L)) != 0) {
  do { if (global_nd6_debug[get_stack_id()]) log (3, "in6_ifadd: failed to make ifaddr %s on %s (errno=%d)\n", ip6_sprintf(&ifra.ifra_addr.sin6_addr), ifp->if_xname, error); } while (0)
...
in6_init_prefix_ltimes(struct nd_prefix *ndpr)
{
 ...
 if (ndpr->ndpr_pltime > ndpr->ndpr_vltime) {
  do { if (global_nd6_debug[get_stack_id()]) log (6, "in6_init_prefix_ltimes: preferred lifetime" "(%d) is greater than valid lifetime(%d)\n", (u_int)ndpr->ndpr_pltime, (u_int)ndpr->ndpr_vltime); } while (0)
...
rt6_flush(gateway, ifp)
    ...
    struct ifnet *ifp;
{
 struct radix_node_head *rnh = (*_GLOBAL_rt_tables_20_A[get_stack_id()])[24];
 int s = splraise((0x20 + ((1) << 4)));
 ...
 gateway->__u6_addr.__u6_addr16[1] = __extension__({ u_int16_t __swap16_x = (ifp->if_index); __builtin_constant_p(ifp->if_index) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
 ...
 void *arg;
{
 ...
 if (rt->rt_gateway == 0L || rt->rt_gateway->sa_family != 24)
  return (0);
 ...
 int ifindex;
{
 ...
 if (ifindex < 0 || global_if_indexlim[get_stack_id()] <= ifindex || !global_ifindex2ifnet[get_stack_id()][ifindex])
  return (22);
 ...
 if (global_nd6_defifindex[get_stack_id()] != ifindex) {
  ...
  if (global_nd6_defifindex[get_stack_id()] > 0) {
   global_nd6_defifp[get_stack_id()] = global_ifindex2ifnet[get_stack_id()][global_nd6_defifindex[get_stack_id()]];
  } else
   global_nd6_defifp[get_stack_id()] = 0L;
