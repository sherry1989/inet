# 1 "openbsd3/netinet6/in6_src.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/netinet6/in6_src.c"
# 64 "openbsd3/netinet6/in6_src.c"
...
# 65 "openbsd3/netinet6/in6_src.c" 2
...
# 66 "openbsd3/netinet6/in6_src.c" 2
...
# 67 "openbsd3/netinet6/in6_src.c" 2
...
# 68 "openbsd3/netinet6/in6_src.c" 2
...
# 69 "openbsd3/netinet6/in6_src.c" 2
...
void pfctlinput(int, struct sockaddr *);
# 70 "openbsd3/netinet6/in6_src.c" 2
...
int recvit(struct proc *, int, struct msghdr *, caddr_t,
      register_t *);
# 71 "openbsd3/netinet6/in6_src.c" 2
...
# 72 "openbsd3/netinet6/in6_src.c" 2
# 1 "openbsd3/sys/errno.h" 1
# 73 "openbsd3/netinet6/in6_src.c" 2
...
# 75 "openbsd3/netinet6/in6_src.c" 2
...
# 77 "openbsd3/netinet6/in6_src.c" 2
...
# 78 "openbsd3/netinet6/in6_src.c" 2
...
# 80 "openbsd3/netinet6/in6_src.c" 2
...
# 81 "openbsd3/netinet6/in6_src.c" 2
...
n_time iptime(void);
# 82 "openbsd3/netinet6/in6_src.c" 2
...
# 83 "openbsd3/netinet6/in6_src.c" 2
...
# 84 "openbsd3/netinet6/in6_src.c" 2
...
# 88 "openbsd3/netinet6/in6_src.c" 2
 ...
 *errorp = 0;
 ...
 if (pi && pi->ipi6_ifindex) {
  ...
  ia6 = in6_ifawithscope(global_ifindex2ifnet[get_stack_id()][pi->ipi6_ifindex],
           dst);
  if (ia6 == 0) {
   *errorp = 49;
   return (0);
  }
  return (&((struct sockaddr_in6 *)(&ia6->ia_addr))->sin6_addr);
 }
# 151 "openbsd3/netinet6/in6_src.c"
 if (((((dst)->__u6_addr.__u6_addr8[0] == 0xfe) && (((dst)->__u6_addr.__u6_addr8[1] & 0xc0) == 0x80)) || ((dst)->__u6_addr.__u6_addr8[0] == 0xff)) &&
  ...
  if (dstsock->sin6_scope_id < 0 ||
      global_if_indexlim[get_stack_id()] <= dstsock->sin6_scope_id ||
      !global_ifindex2ifnet[get_stack_id()][dstsock->sin6_scope_id]) {
   *errorp = 6;
   return (0);
  }
  ia6 = in6_ifawithscope(global_ifindex2ifnet[get_stack_id()][dstsock->sin6_scope_id],
           dst);
  if (ia6 == 0) {
   *errorp = 49;
   return (0);
...
# 181 "openbsd3/netinet6/in6_src.c"
 if (((dst)->__u6_addr.__u6_addr8[0] == 0xff)) {
  struct ifnet *ifp = mopts ? mopts->im6o_multicast_ifp : 0L;

  if (ifp == 0L && (((dst)->__u6_addr.__u6_addr8[0] == 0xff) && (((dst)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x01))) {
...

 {
  ...
  if (opts && opts->ip6po_nexthop) {
   sin6_next = ((struct sockaddr_in6 *)(opts->ip6po_nexthop));
   rt = nd6_lookup(&sin6_next->sin6_addr, 1, 0L);
   if (rt) {
    ia6 = in6_ifawithscope(rt->rt_ifp, dst);
    if (ia6 == 0)
     ia6 = ((struct in6_ifaddr *)(rt->rt_ifa));
   }
   if (ia6 == 0) {
    *errorp = 49;
    return (0);
...
# 259 "openbsd3/netinet6/in6_src.c"
  if (ro->ro_rt) {
   ia6 = in6_ifawithscope(ro->ro_rt->rt_ifa->ifa_ifp, dst);
   if (ia6 == 0)
    ia6 = ((struct in6_ifaddr *)(ro->ro_rt->rt_ifa));
  }
# 283 "openbsd3/netinet6/in6_src.c"
  if (ia6 == 0) {
   *errorp = 65;
   return (0);
  }
...
# 303 "openbsd3/netinet6/in6_src.c"
int
 ...
 struct ifnet *ifp;
{
 if (in6p && in6p->inp_hops >= 0)
  ...
  return ((((struct in6_ifextra *)(ifp)->if_afdata[24])->nd_ifinfo)->chlim);
 else
  return (global_ip6_defhlim[get_stack_id()]);
}
# 333 "openbsd3/netinet6/in6_src.c"
int
 ...
 *in6 = sin6->sin6_addr;
 ...
 if ((((((in6)->__u6_addr.__u6_addr8[0] == 0xfe) && (((in6)->__u6_addr.__u6_addr8[1] & 0xc0) == 0x80))) || ((((in6)->__u6_addr.__u6_addr8[0] == 0xff) && (((in6)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x02))))) {
  ...
  if (in6p && in6p->inp_outputopts6 &&
      ...
      pi->ipi6_ifindex) {
   ifp = global_ifindex2ifnet[get_stack_id()][pi->ipi6_ifindex];
   in6->__u6_addr.__u6_addr16[1] = __extension__({ u_int16_t __swap16_x = (pi->ipi6_ifindex); __builtin_constant_p(pi->ipi6_ifindex) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
  } else if (in6p && ((in6)->__u6_addr.__u6_addr8[0] == 0xff) &&
      in6p->inp_mou.mou_mo6 &&
      in6p->inp_mou.mou_mo6->im6o_multicast_ifp) {
   ifp = in6p->inp_mou.mou_mo6->im6o_multicast_ifp;
   in6->__u6_addr.__u6_addr16[1] = __extension__({ u_int16_t __swap16_x = (ifp->if_index); __builtin_constant_p(ifp->if_index) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
  } else if (scopeid) {

   if (scopeid < 0 || global_if_indexlim[get_stack_id()] <= scopeid ||
       !global_ifindex2ifnet[get_stack_id()][scopeid])
    return 6;
   ifp = global_ifindex2ifnet[get_stack_id()][scopeid];

   in6->__u6_addr.__u6_addr16[1] = __extension__({ u_int16_t __swap16_x = (scopeid & 0xffff); __builtin_constant_p(scopeid & 0xffff) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
  }
...
# 398 "openbsd3/netinet6/in6_src.c"
int
...
in6_clearscope(addr)
 struct in6_addr *addr;
{
 if ((((((addr)->__u6_addr.__u6_addr8[0] == 0xfe) && (((addr)->__u6_addr.__u6_addr8[1] & 0xc0) == 0x80))) || ((((addr)->__u6_addr.__u6_addr8[0] == 0xff) && (((addr)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x02)))))
