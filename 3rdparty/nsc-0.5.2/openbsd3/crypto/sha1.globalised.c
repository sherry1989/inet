# 1 "openbsd3/crypto/sha1.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/crypto/sha1.c"
# 22 "openbsd3/crypto/sha1.c"
...
# 26 "openbsd3/crypto/sha1.c" 2
# 47 "openbsd3/crypto/sha1.c"
typedef union {
    u_char c[64];
    u_int l[16];
} CHAR64LONG16;
# 107 "openbsd3/crypto/sha1.c"
void SHA1Transform(u_int32_t state[5], unsigned char buffer[64])
{
u_int32_t a, b, c, d, e;
CHAR64LONG16* block;

    typedef  CHAR64LONG16  _GLOBAL_58_T; static  _GLOBAL_58_T  global_workspace[NUM_STACKS];   

    block = &global_workspace[get_stack_id()];
