# 1 "openbsd3/netatalk/at_control.c"
# 1 "/home/cmcc/omnet_workspace/inet/3rdparty/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "openbsd3/netatalk/at_control.c"
# 54 "openbsd3/netatalk/at_control.c"
...
# 55 "openbsd3/netatalk/at_control.c" 2
...
# 56 "openbsd3/netatalk/at_control.c" 2
...
# 57 "openbsd3/netatalk/at_control.c" 2
...
# 58 "openbsd3/netatalk/at_control.c" 2
...
# 59 "openbsd3/netatalk/at_control.c" 2
...
# 60 "openbsd3/netatalk/at_control.c" 2
...
void pfctlinput(int, struct sockaddr *);
# 61 "openbsd3/netatalk/at_control.c" 2
...
# 62 "openbsd3/netatalk/at_control.c" 2
# 1 "openbsd3/sys/errno.h" 1
# 63 "openbsd3/netatalk/at_control.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__printf__,1,2))) ;
void logwakeup(void);
# 64 "openbsd3/netatalk/at_control.c" 2
...
# 65 "openbsd3/netatalk/at_control.c" 2
...
# 68 "openbsd3/netatalk/at_control.c" 2
...
# 69 "openbsd3/netatalk/at_control.c" 2
...
# 70 "openbsd3/netatalk/at_control.c" 2
...
# 72 "openbsd3/netatalk/at_control.c" 2
...
# 73 "openbsd3/netatalk/at_control.c" 2
...
# 75 "openbsd3/netatalk/at_control.c" 2
...
# 76 "openbsd3/netatalk/at_control.c" 2
...
# 77 "openbsd3/netatalk/at_control.c" 2
# 1 "openbsd3/netatalk/phase2.h" 1
# 78 "openbsd3/netatalk/at_control.c" 2
...
# 79 "openbsd3/netatalk/at_control.c" 2
...
typedef  struct rndstats   _GLOBAL_147_T; extern  _GLOBAL_147_T  global_rndstats[NUM_STACKS];    
# 86 "openbsd3/dev/rndvar.h"
void enqueue_randomness(int, int);
void get_random_bytes(void *, size_t);
void arc4random_bytes(void *, size_t);
u_int32_t arc4random(void);
# 81 "openbsd3/netatalk/at_control.c" 2
...
typedef  struct timeout   _GLOBAL_148_T; extern  _GLOBAL_148_T  global_aarpprobe_timeout[NUM_STACKS];    
    ...
    struct proc *p;
{
 ...
 for ( aa = global_at_ifaddr[get_stack_id()]; aa; aa = aa->aa_next ) {
     if ( aa->aa_ifa.ifa_ifp == ifp ) break;
 }
    }
 ...
 if ( ifra->ifra_addr.sat_family == 16 ) {
     for ( ; aa; aa = aa->aa_next ) {
  if ( aa->aa_ifa.ifa_ifp == ifp &&
   ((&aa->aa_addr)->sat_len == (&ifra->ifra_addr)->sat_len && (&aa->aa_addr)->sat_family == (&ifra->ifra_addr)->sat_family && (&aa->aa_addr)->sat_addr.s_net == (&ifra->ifra_addr)->sat_addr.s_net && (&aa->aa_addr)->sat_addr.s_node == (&ifra->ifra_addr)->sat_addr.s_node )) {
      break;
  }
     }
 }
 if ( cmd == ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((25))) && aa == 0 ) {
     return( 49 );
 }
 ...
 sat = ((struct sockaddr_at *)(&ifr->ifr_ifru.ifru_addr));
 nr = (struct netrange *)sat->sat_range.r_zero;
 if ( nr->nr_phase == 1 ) {
     for ( ; aa; aa = aa->aa_next ) {
  if ( aa->aa_ifa.ifa_ifp == ifp &&
 ...
 if ( aa == (struct at_ifaddr *) 0 ) {
     aa0 = malloc(sizeof(struct at_ifaddr), 9, 0x0000);
     bzero(aa0, sizeof(struct at_ifaddr));

     if (( aa = global_at_ifaddr[get_stack_id()] ) != 0L ) {





  if ( global_at_ifaddr[get_stack_id()]->aa_ifa.ifa_ifp->if_flags & 0x8 ) {
      aa = aa0;
      aa->aa_next = global_at_ifaddr[get_stack_id()];
      global_at_ifaddr[get_stack_id()] = aa;
  } else {
      ...
      aa->aa_next = aa0;
         ...
         global_at_ifaddr[get_stack_id()] = aa0;
     }

     aa = aa0;

     if (( ifa = ifp->if_addrlist.tqh_first ) != 0L ) {
 ...
 break;
    ...
    switch ( cmd ) {
    case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((33))):
 *(struct sockaddr_at *)&ifr->ifr_ifru.ifru_addr = aa->aa_addr;


 ((struct netrange *)&sat->sat_range.r_zero)->nr_phase
  = (aa->aa_flags & 0x0004) ? 2 : 1;
 ((struct netrange *)&sat->sat_range.r_zero)->nr_firstnet = aa->aa_firstnet;
 ((struct netrange *)&sat->sat_range.r_zero)->nr_lastnet = aa->aa_lastnet;
 break;

    case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((12))):
 return( at_ifinit( ifp, aa, (struct sockaddr_at *)&ifr->ifr_ifru.ifru_addr ));

    case ((unsigned long)0x80000000 | ((sizeof(struct ifaliasreq) & 0x1fff) << 16) | ((('i')) << 8) | ((26))):
 if ( ((&ifra->ifra_addr)->sat_len == (&aa->aa_addr)->sat_len && (&ifra->ifra_addr)->sat_family == (&aa->aa_addr)->sat_family && (&ifra->ifra_addr)->sat_addr.s_net == (&aa->aa_addr)->sat_addr.s_net && (&ifra->ifra_addr)->sat_addr.s_node == (&aa->aa_addr)->sat_addr.s_node )) {
     return( 0 );
 }
 return( at_ifinit( ifp, aa, (struct sockaddr_at *)&ifr->ifr_ifru.ifru_addr ));
 ...
 do { if ((ifa0)->ifa_refcnt <= 0) ifafree(ifa0); else (ifa0)->ifa_refcnt--; } while (0);

 aa0 = aa;
 if ( aa0 == ( aa = global_at_ifaddr[get_stack_id()] )) {
     global_at_ifaddr[get_stack_id()] = aa->aa_next;
 } else {
    ...
    struct at_ifaddr *aa;
{
 ...
 if (ifp->if_flags & 0x8) {
  ...
  if ((error = rtinit( &aa->aa_ifa, 0x2, 0x4)) != 0)
   return( error );
 } else if (ifp->if_flags & 0x2) {
    ...
    struct sockaddr_at *sat;
{
    ...
    int s = splraise((0x20 + ((6) << 4))), error = 0, i, j, netinc, nodeinc, nnets;
    u_int16_t net;

    oldaddr = aa->aa_addr;
    bzero( ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr), sizeof( struct sockaddr_at ));
    bcopy( sat->sat_range.r_zero, &nr, sizeof( struct netrange ));
    bcopy( sat->sat_range.r_zero, ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_range.r_zero, sizeof( struct netrange ));
    nnets = __extension__({ u_int16_t __swap16_x = (nr.nr_lastnet); __builtin_constant_p(nr.nr_lastnet) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }) - __extension__({ u_int16_t __swap16_x = (nr.nr_firstnet); __builtin_constant_p(nr.nr_firstnet) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }) + 1;
    ...
    if ( ifp->if_flags & 0x8 ) {
 ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_len = sat->sat_len;
 ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_family = 16;
 ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_addr.s_net = sat->sat_addr.s_net;
 ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_addr.s_node = sat->sat_addr.s_node;
    } else {
 aa->aa_flags |= 0x0002;
 ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_len = sizeof(struct sockaddr_at);
 ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_family = 16;
 if ( aa->aa_flags & 0x0004 ) {
     if ( sat->sat_addr.s_net == (u_int16_t)0x0000 ) {
  if ( nnets != 1 ) {
      net = __extension__({ u_int16_t __swap16_x = (nr.nr_firstnet); __builtin_constant_p(nr.nr_firstnet) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }) +
       arc4random() % ( nnets - 1 );
  } else {
      net = __extension__({ u_int16_t __swap16_x = (nr.nr_firstnet); __builtin_constant_p(nr.nr_firstnet) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
  }
     } else {
  if ( __extension__({ u_int16_t __swap16_x = (sat->sat_addr.s_net); __builtin_constant_p(sat->sat_addr.s_net) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }) < __extension__({ u_int16_t __swap16_x = (nr.nr_firstnet); __builtin_constant_p(nr.nr_firstnet) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }) ||
   __extension__({ u_int16_t __swap16_x = (sat->sat_addr.s_net); __builtin_constant_p(sat->sat_addr.s_net) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }) > __extension__({ u_int16_t __swap16_x = (nr.nr_lastnet); __builtin_constant_p(nr.nr_lastnet) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); })) {
      aa->aa_addr = oldaddr;
  ...
  net = __extension__({ u_int16_t __swap16_x = (sat->sat_addr.s_net); __builtin_constant_p(sat->sat_addr.s_net) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
     }
 } else {
     net = __extension__({ u_int16_t __swap16_x = (sat->sat_addr.s_net); __builtin_constant_p(sat->sat_addr.s_net) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
 }
 ...
 if ( sat->sat_addr.s_node == (u_int8_t)0x00 ) {
     ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_addr.s_node = arc4random();
 } else {
     ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_addr.s_node = sat->sat_addr.s_node;
 }

 for ( i = nnets, netinc = 1; i > 0; net = __extension__({ u_int16_t __swap16_x = (nr.nr_firstnet); __builtin_constant_p(nr.nr_firstnet) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }) +
  (( net - __extension__({ u_int16_t __swap16_x = (nr.nr_firstnet); __builtin_constant_p(nr.nr_firstnet) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }) + netinc ) % nnets ), i-- ) {
     ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_addr.s_net = __extension__({ u_int16_t __swap16_x = (net); __builtin_constant_p(net) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });

     for ( j = 0, nodeinc = arc4random() | 1; j < 256;
      j++, ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_addr.s_node += nodeinc ) {
  if ( ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_addr.s_node > 253 ||
   ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_addr.s_node < 1 ) {
      continue;
  }
  aa->aa_probcnt = 10;
  timeout_set(&global_aarpprobe_timeout[get_stack_id()], aarpprobe, ifp);

  timeout_add(&global_aarpprobe_timeout[get_stack_id()], global_hz[get_stack_id()] / 5);
  if ( ltsleep(aa, 40|0x100, "at_ifinit", 0, 0L)) {
  ...
  break;
     ...
     ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_addr.s_node = time.tv_sec;
 }
 ...
 if ( aa->aa_flags & 0x0002 ) {
    ...
    if ( ifp->if_ioctl &&
     ( error = (*ifp->if_ioctl)( ifp, ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((12))), (caddr_t) aa ))) {
 aa->aa_addr = oldaddr;
 aa->aa_firstnet = onr.nr_firstnet;
 aa->aa_lastnet = onr.nr_lastnet;
 splx( s );
 return( error );
    ...
    aa->aa_broadaddr.sat_family = 16;

    aa->aa_ifa.ifa_metric = ifp->if_data.ifi_metric;
    if (ifp->if_flags & 0x2) {
 aa->aa_broadaddr.sat_addr.s_net = __extension__({ u_int16_t __swap16_x = (0); __builtin_constant_p(0) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
 aa->aa_broadaddr.sat_addr.s_node = 0xff;
 aa->aa_ifa.ifa_dstaddr = (struct sockaddr *) &aa->aa_broadaddr;

 error = aa_dorangeroute(&aa->aa_ifa,
  __extension__({ u_int16_t __swap16_x = (aa->aa_firstnet); __builtin_constant_p(aa->aa_firstnet) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }), __extension__({ u_int16_t __swap16_x = (aa->aa_lastnet); __builtin_constant_p(aa->aa_lastnet) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); }), 0x1 );
    }
    else if (ifp->if_flags & 0x10) {
 ...
 bzero(&rtaddr, sizeof(rtaddr));
 bzero(&rtmask, sizeof(rtmask));
 rtaddr.s_net = ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_addr.s_net;
 rtaddr.s_node = ((struct sockaddr_at *)&((struct at_ifaddr *)(aa))->aa_addr)->sat_addr.s_node;
 rtmask.s_net = 0xffff;
 rtmask.s_node = 0x0;
 error = aa_addsingleroute(&aa->aa_ifa, &rtaddr, &rtmask);
    }
    ...
    struct sockaddr_at *sat;
{
    ...
    if ( sat->sat_addr.s_node != (u_int8_t)0xff ) {
 return( 0 );
    }
    if ( sat->sat_addr.s_net == (u_int16_t)0x0000 ) {
 return( 1 );
 ...
 for ( aa = global_at_ifaddr[get_stack_id()]; aa; aa = aa->aa_next ) {
     if (( aa->aa_ifa.ifa_ifp->if_flags & 0x2 ) &&
...
# 559 "openbsd3/netatalk/at_control.c"
static int
aa_dorangeroute(struct ifaddr *ifa, u_int bot, u_int top, int cmd)
{
 ...
 mask.s_node = 0;
  ...
  mask1 >>= 1;
  mask.s_net = __extension__({ u_int16_t __swap16_x = (~mask1); __builtin_constant_p(~mask1) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
  addr.s_net = __extension__({ u_int16_t __swap16_x = (bot); __builtin_constant_p(bot) ? __extension__({ u_int16_t __swap16gen_x = (__swap16_x); (u_int16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : ({ u_int16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w1" : "+r" (__swap16md_x)); __swap16md_x; }); });
  if(cmd == 0x1) {
 ...
 struct at_addr *addr, struct at_addr *mask)
{
  ...
  error = aa_dosingleroute(ifa, addr, mask, 0x1, 0x1);
  if (error)
 ...
 struct at_addr *addr, struct at_addr *mask)
{
  ...
  error = aa_dosingleroute(ifa, addr, mask, 0x2, 0);
  if (error)
 ...
 struct at_addr *at_addr, struct at_addr *at_mask, int cmd, int flags)
{
 ...
 (flags & 0x4)?(ifa->ifa_dstaddr):(ifa->ifa_addr),
 (struct sockaddr *) &mask, flags, 0L));
}
